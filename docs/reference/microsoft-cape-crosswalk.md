...
- **Model risk (OCC 2011-12 / SR 26-2):** [2.6](../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md). Every decisioning model in the flow needs a documented model risk tier, validation report, and ongoing monitoring plan. The CAPE phrase "agents make routine decisions autonomously and escalate exceptions to humans" lands directly on §V (ongoing monitoring, outcomes analysis, change control) of OCC 2011-12.
...
- **Model risk (high-risk tier):** [2.6](../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md). Pattern 6 systems are presumed *high-risk* under OCC 2011-12 unless the firm documents otherwise. Independent validation, ongoing monitoring, outcomes analysis, and change control are required by §V.
