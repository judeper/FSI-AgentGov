...
| Set Up Alerts in PPAC | [https://learn.microsoft.com/en-us/power-platform/admin/set-up-alerts](https://learn.microsoft.com/en-us/power-platform/admin/set-up-alerts) | Configure pre-built and custom alert rules |
