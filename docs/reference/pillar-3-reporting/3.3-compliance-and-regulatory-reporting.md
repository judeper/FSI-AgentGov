...
|------|--------------|----------------|--------------|
| **Zone 1 (Personal)** | Summary metrics only | Team Lead | IT Operations |
| **Zone 2 (Team)** | Department-level detail | Department Head | Business Unit |
| **Zone 3 (Enterprise)** | Full compliance detail | CCO/CAO | Executive + Regulators |
...
1. **Report Generation**
   ...
   - Verify all 43 controls appear with accurate status
