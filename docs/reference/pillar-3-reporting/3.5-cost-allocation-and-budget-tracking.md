...
| Copilot Studio (25k messages) | $200 | Messages | Usage reports |
...
function New-CostAllocationReport {
    ...
    $costData = @{
        ...
        TopAgentsByCost = @(
            @{ Name = "Account Inquiry Bot"; Cost = 5500; Zone = "Zone 3" },
            @{ Name = "HR Benefits Assistant"; Cost = 4200; Zone = "Zone 2" },
            @{ Name = "IT Helpdesk Bot"; Cost = 3800; Zone = "Zone 2" },
            @{ Name = "Expense Report Helper"; Cost = 2900; Zone = "Zone 1" },
            @{ Name = "Compliance Q&A Bot"; Cost = 2500; Zone = "Zone 3" }
        )
    }
...
<body>
    <div class="container">
        ...
        <table>
            <tr><th>Agent Name</th><th>Zone</th><th>Monthly Cost</th></tr>
...
|------|--------------------------|----------------|----------|
| **Zone 1 (Personal)** | Aggregate by department | Soft limits | Team Lead |
| **Zone 2 (Team)** | By agent | Hard limits | Manager |
| **Zone 3 (Enterprise)** | Detailed breakout | Real-time enforcement | Director/VP |

### FSI Example: Enterprise Agent Cost Structure

```plaintext
Agent: Customer Account Inquiry Bot (Zone 3)
