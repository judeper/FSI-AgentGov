...
|------|-------------------|-----------------|-----------|
| **Zone 1 (Personal)** | Standard (24h) | Optional for low severity | 3 years |
| **Zone 2 (Team)** | Accelerated (4h) | Required for all | 5 years |
| **Zone 3 (Enterprise)** | Immediate (15min) | Full RCA required | 7 years |
...
| [2.5 Business Continuity](../pillar-2-management/2.5-business-continuity-and-disaster-recovery.md) | Recovery procedures for major incidents |
