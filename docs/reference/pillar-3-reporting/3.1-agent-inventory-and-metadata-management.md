...
|------|-------|------------------|
| **Power Platform Administrator** | Tenant-wide | Full access to PPAC Maker inventory across all environments |
...
| **Discovery Sources** | Platforms that enumerate what exists | PPAC Maker inventory, Copilot Studio agent list, M365 Integrated Apps | Finding agents, validating metadata, detecting drift |
...
|----------|-------------|
| [View agent inventory](https://learn.microsoft.com/en-us/power-platform/admin/tenant-wide-agent-inventory) | PPAC Maker inventory documentation |
| [Manage Copilot agents in Integrated Apps](https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-copilot-agents-integrated-apps) | M365 Admin Center agent management |
