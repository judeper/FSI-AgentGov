...
|------|---------------------|--------------|--------------|
| **Zone 1 (Personal)** | Weekly | No | 30 days |
| **Zone 2 (Team)** | Daily | After 7 days | 7 days |
| **Zone 3 (Enterprise)** | Real-time | Immediate | 24 hours |
...
2. **Automated Workflows**
   ...
   - Confirm auto-suspend (Zone 3) works
...
| Auto-suspend for Zone 3 agents | GLBA 501(b) | ☐ |
...
| [2.3 ALM and Lifecycle](../pillar-2-management/2.3-application-lifecycle-management-alm.md) | Lifecycle state management |
...
- [SharePoint List Management](https://learn.microsoft.com/sharepoint/dev/business-apps/get-started/lists)
