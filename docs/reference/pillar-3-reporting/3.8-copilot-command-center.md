...
See [Manage Copilot agents in Integrated Apps](https://learn.microsoft.com/en-us/copilot/microsoft-365/microsoft-365-copilot-overview-agents-integrated-apps) for details.
...
See [Copilot usage reports](https://learn.microsoft.com/en-us/copilot/microsoft-365/microsoft-365-copilot-usage-report) for available metrics.
...
| **Copilot Usage Reports** | Understanding Copilot adoption metrics | [learn.microsoft.com](https://learn.microsoft.com/en-us/copilot/microsoft-365/microsoft-365-copilot-usage-report) |
| **Manage Copilot Agents in Integrated Apps** | Agent lifecycle and governance | [learn.microsoft.com](https://learn.microsoft.com/en-us/copilot/microsoft-365/microsoft-365-copilot-overview-agents-integrated-apps) |
