...
| Microsoft 365 Administrator | Tenant | Copilot configuration and user access |
...
- [ ] Document current Copilot settings baseline before making changes
- [ ] Identify stakeholders for Copilot governance decisions
- [ ] Review organizational AI usage policies
- [ ] Establish change management process for Copilot configuration
...
|----------|-------------|-----|
| **Manage Microsoft 365 Copilot** | Official Copilot management documentation | [learn.microsoft.com](https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-copilot) |
| **Copilot Usage Reports** | Understanding Copilot adoption metrics | [learn.microsoft.com](https://learn.microsoft.com/en-us/microsoft-365/admin/activity-reports/copilot-dashboard) |
| **Manage Copilot Agents in Integrated Apps** | Agent lifecycle and governance | [learn.microsoft.com](https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-copilot-agents-integrated-apps) |
...
| **Copilot Studio Governance** | Power Platform Copilot Studio controls | [learn.microsoft.com](https://learn.microsoft.com/en-us/microsoft-copilot-studio/admin-overview) |
