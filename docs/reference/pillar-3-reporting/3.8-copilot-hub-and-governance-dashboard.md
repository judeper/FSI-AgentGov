...
**Control ID:** 3.8  
**Control Name:** Copilot Hub and Governance Dashboard  
...
!!! note "Terminology"
    Microsoft officially refers to this feature as the "**Copilot**" area or "**Copilot hub**" in the Power Platform Admin Center ([Source](https://learn.microsoft.com/en-us/power-platform/admin/copilot/copilot-hub)). The term "Copilot Command Center" is not used in official Microsoft documentation.
...
!!! info "Microsoft Agent 365 - Future Governance Control Plane"
    **Microsoft Agent 365** (currently in Frontier preview) will provide enhanced governance capabilities beyond the current Copilot Hub:

    - **Centralized observability** - Dashboards and alerts for all agents across the organization
    - **Unified policy management** - Apply governance policies across agent platforms
    - **Lifecycle orchestration** - Manage agent publishing, versioning, and retirement
    - **Compliance integration** - Enhanced audit and reporting for regulatory requirements

    As Agent 365 matures, it will complement and potentially extend the Copilot Hub capabilities documented here. FSI organizations should monitor for GA announcements and plan for integration with existing governance processes.
...
!!! info "FSI Consideration"
    Review all external connections for data governance compliance. Connections to external systems
    may expose sensitive data to Microsoft 365 Copilot.
...
!!! danger "FSI Critical"
    Monitor "Pending requests" and "Ownerless agents" regularly. Unowned agents and stale requests
...
!!! info "FSI Consideration"
    MCP Servers control what data and actions agents can access. Review and block servers that
    shouldn't be available in your compliance environment.
...
!!! tip "FSI Recommendation"
    Configure all four settings to establish baseline agent governance. Start with "Allowed agent
    types" to control which agent sources are permitted.
...
These operational templates extend Control 3.8's Command Center capabilities with advanced governance metrics and evidence:

- **[Real-time Compliance Dashboard](../../operational-templates/specs/real-time-compliance-dashboard.md)** - Technical specification for governance posture dashboard with key compliance metrics
- **[Evidence Pack Assembly](../../operational-templates/specs/evidence-pack-assembly.md)** - Structure for collecting and presenting Command Center evidence for regulatory exams
