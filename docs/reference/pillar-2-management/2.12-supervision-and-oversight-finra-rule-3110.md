...
(including Microsoft Copilot Studio agents) in firm operations, consistent 
...
4.1 All Zone 3 agents require CCO approval before production
...
6.1 Zone 3 agents: Review [X]% of interactions weekly
6.2 Zone 2 agents: Review [X]% of interactions monthly
...
|---------|---------|---------|
| **Agent Overview** | Total agents by zone, status, owner | Daily |
...
All agents must be classified into governance zones:
- Zone 1: Personal/Low risk - Team lead approval
- Zone 2: Team/Medium risk - AI Governance Lead + Designated Supervisor
- Zone 3: Enterprise/High risk - Full approval chain including CCO
...
[ ] Approval workflow completed per zone
...
- Minimum review rates:
  Zone 3: [X]% of interactions
  Zone 2: [Y]% of interactions
  Zone 1: [Z]% random sample
...
--------------------
| Zone   | Active Agents | Reviews Completed | Review Rate | Target |
|--------|---------------|-------------------|-------------|--------|
| Zone 3 | [X]           | [Y]               | [Z]%        | [T]%   |
| Zone 2 | [X]           | [Y]               | [Z]%        | [T]%   |
| Zone 1 | [X]           | [Y]               | [Z]%        | [T]%   |
...
[ ] WSP defines approval requirements by agent zone/risk
...
[ ] All Zone 3 agents require CCO approval before production
[ ] All Zone 2 agents require AI Governance Lead approval
...
3. **Approval Workflow Enforced**
   ...
   - Verify approval chain per zone
...
- [ ] Approval workflow enforced per zone
...
| [3.3 - Compliance Reporting](../pillar-3-reporting/3.3-compliance-reporting-dashboards.md) | Supervision metrics in reports |
