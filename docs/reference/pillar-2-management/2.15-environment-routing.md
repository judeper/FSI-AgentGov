...
> **Note:** Environment routing rules are primarily configured through the Power Platform Admin Center portal. PowerShell can be used to prepare and verify the configuration.
