...
| Deployment Settings | [learn.microsoft.com](https://learn.microsoft.com/en-us/power-platform/admin/deployment-settings) | Admin center deployment configuration |
