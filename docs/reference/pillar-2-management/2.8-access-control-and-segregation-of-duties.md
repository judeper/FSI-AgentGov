...
### Dependencies
- [1.1 - Restrict Agent Publishing](../pillar-1-security/1.1-restrict-agent-publishing-by-authorization.md)
- [1.18 - Application-Level RBAC](../pillar-1-security/1.18-application-level-authorization-and-role-based-access-control-rbac.md)
- [2.3 - Change Management](./2.3-change-management-and-release-planning.md)
