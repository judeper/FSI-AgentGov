...
For Zone 3 Enterprise agents, require just-in-time access.
...
6. Require approval from 2 different approvers (for Zone 3)
...
$Groups = @(
    @{
        ...
        Description = "Agent creators and editors - Zone 2/3 development access"
...
- [ ] PIM configured for admin roles (Zone 3)
