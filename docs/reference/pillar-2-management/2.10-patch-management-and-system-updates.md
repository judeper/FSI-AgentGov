...
| Severity | Description | Timeline (Zone 1/2) | Timeline (Zone 3) |
|----------|-------------|---------------------|-------------------|
...
| [3.1 - Agent Inventory](../pillar-3-reporting/3.1-agent-inventory-and-lifecycle-tracking.md) | Track agent versions |
