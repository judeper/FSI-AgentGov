...
!!! info "RCD vs RSS: Understanding the Difference"
    **Restricted Content Discovery (RCD)** is a **block-list** approach: specify sites to *exclude* from Copilot.
    **Restricted SharePoint Search (RSS)** is an **allow-list** approach: specify sites to *include* for Copilot (max 100 sites).
...
!!! warning "FSI Critical: Information Barriers"
...
| [Microsoft 365 E5](https://learn.microsoft.com/en-us/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance) | Advanced compliance, audit capabilities | Level 3-4 governance |
...
- [Manage site access based on sensitivity label](https://learn.microsoft.com/en-us/sharepoint/restricted-access-control)
...
- [Prepare for Microsoft 365 Copilot with SharePoint](https://learn.microsoft.com/en-us/sharepoint/get-ready-copilot-sharepoint-advanced-management)
