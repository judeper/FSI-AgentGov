...
|-------|---------------|----------|
| Data access governance reports not available | SharePoint Advanced Management not licensed | Verify SharePoint Advanced Management (PRO) license is assigned; navigate to M365 Admin Center > Billing to confirm |
...
|---------|--------------|----------|
| [1.6 Sensitivity Labels](../pillar-1-security/1.5-data-loss-prevention-dlp-and-sensitivity-labels.md) | Labels determine review scope and frequency | High |
| [1.18 RBAC](../pillar-1-security/1.18-application-level-authorization-and-role-based-access-control-rbac.md) | Access reviews validate RBAC implementation | High |
| [2.1 Managed Environments](../pillar-2-management/2.1-managed-environments.md) | Provides governance framework for review processes | Medium |
| [4.1 IAG / RCD](4.1-sharepoint-information-access-governance-iag-restricted-content-discovery.md) | Reviews identify sites needing restrictions | High |
| [4.3 Site Classification](4.3-site-and-document-retention-management.md) | Classification determines review requirements | High |
| [4.4 Guest Access](4.4-guest-and-external-user-access-controls.md) | Reviews verify guest access appropriateness | High |
| [4.5 Monitoring](4.5-sharepoint-security-and-compliance-monitoring.md) | Continuous monitoring complements periodic reviews | Medium |
| [3.1 Agent Inventory](../pillar-3-reporting/3.1-agent-inventory-and-metadata-management.md) | Identifies agents using SharePoint as knowledge source | Medium |
