...
|--------|----------------------------------------------|
| **US federal financial regulation** | FFIEC IT Examination Handbook, GLBA (Gramm-Leach-Bliley Act), Sarbanes-Oxley (SOX), Federal Reserve Supervisory Letter SR 11-7 (Model Risk), OCC Bulletin 2011-12 / 2026-13 (Technology Risk Management), Dodd-Frank elements |
...
| Government cloud (GCC, GCC High, DoD) | Equivalent **G5 Compliance** SKU; verify per-template parity at [Microsoft Learn — Compliance Manager regional availability](https://learn.microsoft.com/en-us/purview/compliance-manager-templates) |
...
| **Federal Reserve SR 11-7 (Model Risk)** | [2.6 Model Risk Management](../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md), [2.11 Bias / Fairness Testing](../controls/pillar-2-management/2.11-bias-testing-and-fairness-assessment.md), [2.7 Vendor Risk](../controls/pillar-2-management/2.7-vendor-and-third-party-risk-management.md) | [3.1 Agent Inventory](../controls/pillar-3-reporting/3.1-agent-inventory-and-metadata-management.md) |
| **OCC Bulletin 2011-12 / 2026-13** | [2.6 Model Risk Management](../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md), [2.7 Vendor Risk](../controls/pillar-2-management/2.7-vendor-and-third-party-risk-management.md) | [3.1 Agent Inventory](../controls/pillar-3-reporting/3.1-agent-inventory-and-metadata-management.md) |
...
- **Pre-built improvement actions.** Each Compliance Manager template ships with Microsoft-recommended improvement actions (technical and operational) pre-mapped to its control framework. Customers should treat these as a starting point, not a finished assessment — many recommended actions require organisation-specific evidence and approval workflows that the framework's [Implementation Playbooks](../playbooks/control-implementations/) supply.
...
- **Sovereign cloud parity.** Compliance Manager and template availability differ across commercial, GCC, GCC High, DoD, and 21Vianet. Re-verify per [Microsoft Learn — Compliance Manager regional availability](https://learn.microsoft.com/en-us/purview/compliance-manager-templates) before relying on a template in a sovereign tenant.
