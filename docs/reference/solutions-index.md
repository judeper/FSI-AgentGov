...
| [Message Center Monitor](#message-center-monitor) | [`message-center-monitor`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/message-center-monitor) | v2.5.0 | 2.3, 2.10 | M365 Message Center monitoring for platform changes. |
