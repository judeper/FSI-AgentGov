...
This file is intentionally pinned to `assessment/data/solutions-lock.json`, the framework's committed snapshot of the companion repository's canonical `solutions.json` contract. Version, preview/live status, and primary-control coverage on this page are synchronized to that lock file and drift-checked in CI; pattern, driver, and CoE annotations remain framework-authored browsing metadata.

*Canonical inventory fields listed below reflect the current `solutions-lock.json` snapshot.*
...
|----------|-------------------|---------|------------------|----------|---------|-----|---------|
| [Action Confirmation Auditor](#action-confirmation-auditor) | [`action-confirmation-auditor`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/action-confirmation-auditor) | v1.2.0 | 2.12, 1.10 | P4, P5, P6 | AI Governance, Technology & Data | Govern | Step-up confirmation validation for agent actions. |
...
| [Agent Observability Foundation](#agent-observability-foundation) | [`agent-observability-foundation`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-observability-foundation) | v1.2.1 | 1.7, 2.8, 2.9, 3.2 | P4, P5, P6 | Technology & Data, AI Governance | Optimize | Foundational observability infrastructure for agent monitoring. |
...
| [Compliance Dashboard](#compliance-dashboard) | [`compliance-dashboard`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/compliance-dashboard) | v1.0.4 | 3.3, 3.1, 3.2, 3.4 | P4, P5, P6 | AI Governance, Technology & Data | Optimize | Aggregated compliance reporting across the framework control catalog with Exchange coverage. |
...
| [Content Moderation Monitor](#content-moderation-monitor) | [`content-moderation-monitor`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/content-moderation-monitor) | v1.1.1 | 1.27, 1.8 | P1, P5 | AI Governance, Technology & Data | Optimize | Per-agent content moderation validation against zone requirements. |
| [Copilot Studio Analytics](#copilot-studio-analytics) | [`copilot-studio-analytics`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/copilot-studio-analytics) | v2.0.1 | 3.2 | P1, P4 | AI Governance, Technology & Data | Optimize | Business impact analytics for Microsoft Copilot Studio agents. |
...
| [Cross-Solution Integration](#cross-solution-integration) | [`cross-solution-integration`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/cross-solution-integration) | v2.0.2 | 1.7, 1.23, 1.11, 3.8, 1.8, 1.14, 1.18 | P4, P5, P6 | AI Governance, Technology & Data | Scale | Wires Tier 2 companion solutions into Compliance Dashboard. |
| [Cross-Tenant External Sharing Governance](#cross-tenant-external-sharing-governance) | [`cross-tenant-external-sharing-governance`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/cross-tenant-external-sharing-governance) | v1.0.3 | 1.1, 1.18, 2.1, 2.8, 1.7, 1.11 | P1, P5 | AI Governance, Technology & Data | Govern | Three-layer cross-tenant access governance covering tenant isolation, Entra cross-tenant access, and agent sharing. |
...
| [Message Center Monitor](#message-center-monitor) | [`message-center-monitor`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/message-center-monitor) | v2.5.1 | 2.3 | P4, P5, P6 | AI Governance, Technology & Data | Scale | M365 Message Center monitoring for platform changes. |
| [MIME Type Restrictions](#mime-type-restrictions) | [`mime-type-restrictions`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/mime-type-restrictions) | v1.2.1 | 1.5, 1.13, 1.25, 3.3, 3.7 | P1, P2, P3 | AI Governance, Technology & Data | Govern | Zone-based MIME type configuration with server-side validation. |
| [Model Risk Management Automation](#model-risk-management-automation) | [`model-risk-management-automation`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/model-risk-management-automation) | v1.0.3 | 2.6, 2.5, 2.9, 2.11, 2.13, 3.1, 1.2 | P4, P5, P6 | AI Governance, AI Strategy | Govern | OCC Bulletin 2026-13 (formerly OCC 2011-12) / SR 26-2 (formerly SR 11-7) model risk management with inventory, risk scoring, validation workflows, and Agent Card generation. |
...
- **Version:** v1.2.1
- **Primary controls:** 1.7, 2.8, 2.9, 3.2
- **Patterns:** P4, P5, P6
...
- **Version:** v1.0.4
- **Primary controls:** 3.3, 3.1, 3.2, 3.4
- **Patterns:** P4, P5, P6
- **Drivers:** AI Governance, Technology & Data
- **CoE function:** Optimize
...
- **Version:** v2.0.2
- **Primary controls:** 1.7, 1.23, 1.11, 3.8, 1.8, 1.14, 1.18
- **Patterns:** P4, P5, P6
- **Drivers:** AI Governance, Technology & Data
- **CoE function:** Scale
...
- **Version:** v1.0.3
- **Primary controls:** 1.1, 1.18, 2.1, 2.8, 1.7, 1.11
- **Patterns:** P1, P5
- **Drivers:** AI Governance, Technology & Data
- **CoE function:** Govern
...
- **Version:** v1.2.1
- **Primary controls:** 2.1, 2.2, 2.8, 1.7
- **Patterns:** P1, P2, P4
- **Drivers:** AI Governance, Technology & Data
- **CoE function:** Enable
...
- **CoE function:** Govern
- **Summary:** OCC Bulletin 2026-13 (formerly OCC 2011-12) / SR 26-2 (formerly SR 11-7) model risk management with inventory, risk scoring, validation workflows, and Agent Card generation.
