...
| [2.6 Model Risk Management](../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md) — DSPM for AI, Foundry evaluation harness, Agent 365 console, Entra Agent ID, Anthropic Claude — all require per-cloud verification | Verify per surface | Lagging across surfaces | Lagging across surfaces | Verify with MS | Maintain manual model inventory (SharePoint list backed by Purview retention); MRM validation by firm's existing MRM function under firm policy; retain evidence under 17a-4(f) |
...
- [Microsoft Cloud for US Government overview](https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-government-overview)
