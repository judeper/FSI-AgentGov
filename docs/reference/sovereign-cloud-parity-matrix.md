...
| [1.5 DLP & Sensitivity Labels](../controls/pillar-1-security/1.5-data-loss-prevention-dlp-and-sensitivity-labels.md) — **Microsoft Purview DLP for M365 Copilot reached GA in April 2026** (available wherever M365 Copilot is GA: Commercial, GCC post-Dec 2024, GCC High post-Dec 2025; not yet announced for DoD or 21Vianet); IRM-driven Adaptive Protection **not available in any US Government cloud** | GA / verify | Lagging | Lagging | Verify with MS | Static role-based DLP without risk tiering; document Adaptive Protection gap as compensating-control note |
...
| [1.12 Insider Risk Management](../controls/pillar-1-security/1.12-insider-risk-detection-and-response.md) — IRM core verify per cloud; **Adaptive Protection availability in US Government cloud is feature-gated** per message-center notice MC803011 (the IRM signal source is available, but the Adaptive Protection conditional-access integration depends on additional licensing and tenant configuration — re-verify before relying on the integration); **IRM Triage Agent is GA but consumption requires Microsoft Security Copilot SCUs**, making it effectively Commercial-only as of May 2026 (Security Copilot is not available in any US Government cloud — licensing gate, not a Preview state) | Limited (Adaptive Protection feature-gated) | Limited (Adaptive Protection feature-gated) | Limited (Adaptive Protection feature-gated) | Verify with MS | Compensating: Communication Compliance, Audit (Premium), DLP, Defender for Cloud Apps, Sentinel UEBA, manual supervisory review, exception register; for Triage Agent, substitute manual analyst triage until Security Copilot reaches sovereign cloud |
...
| [1.19 eDiscovery for Agent Interactions](../controls/pillar-1-security/1.19-ediscovery-for-agent-interactions.md) — Unified eDiscovery (Microsoft Purview portal) is the supported experience in Commercial, GCC, GCC High, and DoD; **classic eDiscovery (Standard and Premium) was retired August 31, 2025** in those clouds and is retained only for Microsoft 365 operated by 21Vianet pending the new experience reaching parity there | GA | GA | GA | Classic-only (per Microsoft) | Re-verify Copilot interactions location parity; treat any GCC High/DoD gap on Copilot interactions location as a compensating-control conversation |
...
| **Microsoft Security Copilot (cross-cutting)** — **Not available in any US Government cloud as of May 2026** per [Microsoft Security Copilot availability](https://learn.microsoft.com/en-us/copilot/security/microsoft-security-copilot); dependent capabilities (IRM Triage Agent under 1.12, Defender Risky Agents template under 1.8, Sentinel SCU-driven workflows under 3.9) inherit the Commercial-only posture as a licensing gate | Not announced | Not announced | Not announced | Verify with MS | Document dependent-control posture as Commercial-only; substitute manual analyst review for SCU-driven automations until parity is announced; re-check quarterly against the Security Copilot availability page |
...
| [3.9 Microsoft Sentinel Integration](../controls/pillar-3-reporting/3.9-microsoft-sentinel-integration.md) — Sentinel exists across commercial and government clouds; **connector and preview-feature parity varies**: Microsoft Copilot connector, certain Defender data types, Sentinel MCP Server lag in GCC High / DoD; **Microsoft Sentinel in the Azure portal is being retired 2027-03-31** — the Microsoft Defender portal (security.microsoft.com) becomes the supported Sentinel surface (update any breadcrumbs that hardcode the Azure portal path); **Defender for Cloud Apps SIEM agents were retired in November 2025** — replace with the Microsoft Sentinel connector or Defender XDR streaming API in any control that previously depended on SIEM agents | GA / verify connectors | Lagging (Copilot connector, MCP) | Lagging (Copilot connector, MCP) | Verify with MS | Document unavailable capabilities as **product unavailability**, not as policy exceptions; use parallel patterns from 2.25 / 3.6 for sovereign-cloud evidence discipline |
| [3.11 Centralized Agent Inventory Enforcement](../controls/pillar-3-reporting/3.11-centralized-agent-inventory-enforcement.md) — **Power Platform Inventory** in PPAC reached **GA on 2026-02-09 in Commercial** (MC1223778); sovereign-cloud (GCC / GCC High / DoD) parity is not yet enumerated in the US Government service description | GA / verify rollout | Verify with MS | Verify with MS | Verify with MS | Use Power Platform admin center exports and Microsoft Graph activity reports as compensating inventory source until sovereign GA is published; re-check quarterly against [Power Platform admin — What's new](https://learn.microsoft.com/en-us/power-platform/admin/whats-new) |
...
|--------|-------------------:|-------------------:|---------------------------|
| Pillar 1 — Security | 29 | 14 | 13 of 29 controls have sovereign-cloud caveats authored, plus 1 cross-cutting row (Microsoft Security Copilot) that gates multiple Pillar 1 controls; remaining 16 controls have not yet been called out and should be reviewed in v1.8. |
...
| Pillar 3 — Reporting | 14 | 6 | 6 of 14; reporting controls 3.2/3.3/3.7/3.8/3.10/3.12/3.13/3.14 have not yet been examined for sovereign-cloud caveats. |
| Pillar 4 — SharePoint | 9 | 2 | 2 of 9; the 7 remaining SharePoint controls warrant a focused sovereign-cloud pass in v1.8. |
| **Total** | **78** | **30** | **~38% of the 78-control catalog has a documented sovereign-cloud caveat in v1.7** (28 control rows + 2 cross-cutting / inventory rows). |
...
- Pillar 3: 3.2, 3.3, 3.7, 3.8, 3.10, 3.12, 3.13, 3.14
