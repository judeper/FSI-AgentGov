...
### Q: Why are there 79 controls?

A: The framework covers:

- **Pillar 1:** 29 security controls
- **Pillar 2:** 27 management/lifecycle controls
- **Pillar 3:** 14 reporting/monitoring controls
- **Pillar 4:** 9 SharePoint-specific controls

Total = 79 controls covering all governance areas.

### Q: Do I need to implement all 79 controls?
...
A: The framework includes 79 controls across four pillars:

- **Pillar 1 - Security:** 29 controls (1.1-1.29) covering DLP, encryption, audit logging, eDiscovery
- **Pillar 2 - Management:** 27 controls (2.1-2.27) covering lifecycle, change control, environment routing
- **Pillar 3 - Reporting:** 14 controls (3.1-3.14) covering inventory, monitoring, incidents, Sentinel
- **Pillar 4 - SharePoint:** 9 controls (4.1-4.9) covering SharePoint-specific governance
...
A: Some controls reference Microsoft features that are currently in preview or recently reached GA:
...
- **GLBA:** 5-7 years
- **OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7):** Per model (typically 3+ years)
