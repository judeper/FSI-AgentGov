...
| Microsoft Copilot | AI interactions to monitor | Monitoring scope |
...
| Microsoft Copilot deployment | AI users to monitor | Verify license assignment |
...
- [ ] Microsoft Copilot deployed to users
...
#### Steps 2–4 (Recommended): Extend visibility beyond Microsoft Copilot
...
2. Identify the DLP policies that apply to the data sources Copilot and agents can reach (commonly SharePoint, OneDrive, Teams).
...
2. Check that users have Microsoft Copilot licenses assigned
