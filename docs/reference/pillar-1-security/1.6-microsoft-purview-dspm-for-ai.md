...
!!! tip "FSI Recommendation"
    Complete all four setup steps to enable comprehensive AI monitoring across Microsoft and
...
### Microsoft Information Protection (MIP) Labels for Agents

!!! warning "Preview Feature"
    MIP Label integration for Copilot Studio agents is currently in **Preview** (July 2025). Features and configuration may change before general availability. Monitor Microsoft documentation for updates.

#### What is MIP Labels for Agents?

MIP Labels for Agents enables sensitivity labels to be applied to agent responses and prevent oversharing of classified content. When an agent accesses labeled content, the label and its protections can follow the information into the agent's response, maintaining data governance throughout the AI interaction.

#### Key Capabilities

| Capability | Description | FSI Relevance |
|------------|-------------|---------------|
| **Label inheritance** | Responses inherit labels from source documents | Maintains classification through AI |
| **Oversharing prevention** | Block responses containing highly sensitive labeled content | GLBA, SEC data protection |
| **Label-based restrictions** | Restrict agent actions based on content sensitivity | Regulatory content governance |
| **Audit trail** | Log label interactions in DSPM Activity Explorer | FINRA 4511 recordkeeping |

#### Configuration Path

**Portal Path:** Microsoft Purview → Information protection → Auto-labeling → AI interactions
...
#### Zone-Specific MIP Labels Configuration
...
- **GLBA 501(b)** - Maintain NPI classification through AI interactions
- **SEC 17a-4** - Ensure labeled records maintain integrity
- **FINRA 4511** - Audit trail for sensitive content in AI
