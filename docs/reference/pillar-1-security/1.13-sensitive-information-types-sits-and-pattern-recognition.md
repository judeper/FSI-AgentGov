...
| **SWIFT Code** | International bank codes | International transfers |
...
| **International Banking Account Number (IBAN)** | International account format | Global banking |
...
| **ISIN** | 12-character international securities | Cross-border trading |
| **SEDOL** | UK/Irish securities identifiers | European markets |
...
$FinancialSITs = $AllSITs | Where-Object { 
    $_.Name -match "credit card|bank account|SSN|social security|SWIFT|IBAN|ABA|tax" 
}
