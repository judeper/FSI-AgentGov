...
!!! warning "Important"
    **Microsoft does not provide a native toggle to disable agent creation.** Per Microsoft Learn documentation: *"You can't disable agent creation. Our guidance is to use data policies to disable anyone from chatting with that agent."* ([Source](https://learn.microsoft.com/en-us/microsoft-copilot-studio/security-faq))
...
Route all makers to governed environments (see [Control 2.15: Environment Routing](../pillar-2-management/2.15-environment-routing.md)).
...
| "Cannot restrict Copilot Studio" | Feature not available | Enable Managed Environments first ([Control 2.1](../pillar-2-management/2.1-managed-environments.md)) |
