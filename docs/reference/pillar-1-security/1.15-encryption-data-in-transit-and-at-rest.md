...
> **Note:** Customer Key requires Microsoft 365 E5 or E5 Compliance license and involves Azure Key Vault setup.
...
5. **Create Data Encryption Policy (DEP):**
   ...
   - Apply to Zone 2/3 agent data locations
...
6. **Configure for Each Environment:**
   - Repeat for all Zone 2/3 production environments
...
1. **Establish Rotation Schedule:**
   - Zone 1: Annual key rotation
   - Zone 2: Semi-annual key rotation
   - Zone 3: Quarterly key rotation
...
- [ ] Customer-managed keys configured for Zone 2/3
- [ ] Key rotation schedule documented
- [ ] HSM backing for Zone 3 keys
...
**Control Owner:** Security Architecture Lead  
