...
For Zone 3 production environments, use PIM for just-in-time (JIT) access:
...
| Job Function | Zone 1 Role | Zone 2 Role | Zone 3 Role |
|--------------|-------------|-------------|-------------|
...
**Solutions:**
1. Verify unified audit log is enabled (Control 1.7)
...
| [Control 2.8](../pillar-2-management/2.8-access-control-and-segregation-of-duties-sod.md) | SoD policies implemented through RBAC |
