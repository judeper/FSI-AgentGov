...
7. **Configure Rights:**
   | Permission | Zone 1 | Zone 2 | Zone 3 |
   |------------|--------|--------|--------|
   | View | ✓ | ✓ | ✓ |
   | Copy | ✓ | ✗ | ✗ |
   | Print | ✓ | ✗ | ✗ |
...
8. **Set Content Expiration:**
   - For Zone 3: Set **Content access expires** to 90 days
   - Configure **Allow offline access** for limited days (7-14)

9. Click **Next** → **Content marking:**
   - Enable watermark for Zone 3 documents
...
6. **Configure IRM Settings:**
   - **Allow viewers to print:** Uncheck for Zone 3
...
4. **Policy Settings:**
   ...
   - **Require users to apply a label:** Enable for Zone 3
...
- [ ] IRM enabled on all Zone 2+ document libraries
...
**Control Owner:** Information Protection Lead  
