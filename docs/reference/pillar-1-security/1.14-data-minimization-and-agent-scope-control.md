...
**Regulatory Reference:** GLBA 501(b), SEC Reg S-P, FINRA 4511, CCPA §1798.100, GDPR Art. 5(1)(c)  
...
- **Regulatory Minimization**: GDPR/CCPA require collecting only necessary data
...
2. **Approval Workflow:**
   - Zone 1 agents: Self-service with documentation
   - Zone 2 agents: Manager + Data Owner approval
   - Zone 3 agents: CISO + Compliance + Data Owner approval
...
3. Configure scope creep alerts:
   ...
   - **Severity:** Medium for Zone 2, High for Zone 3
...
| **GDPR Art. 5(1)(c)** | Data minimization principle | Purpose limitation for each data source |

### Zone-Specific Configuration

| Configuration | Zone 1 (Personal) | Zone 2 (Team) | Zone 3 (Enterprise) |
|---------------|-------------------|---------------|---------------------|
...
**Resolution:**
1. Prioritize Zone 3 agents
2. Automate report generation
3. Delegate Zone 1 reviews to owners
...
- [Data minimization in Microsoft 365](https://learn.microsoft.com/en-us/microsoft-365/solutions/data-minimization)
