...
2. Set sharing level:
   - Zone 3 agents: **Only people in your organization**
   - Zone 2 agents: **New and existing guests** (with approval)
   - Zone 1 agents: Site owner discretion
...
For Zone 3 agent knowledge sources:
...
3. Configure:
   ...
   - **Frequency**: Quarterly (for Zone 3) or Semi-annually (Zone 2)
   - **Duration**: 14 days
4. Under **Upon completion settings**:
   - Auto-apply results: Consider for Zone 1-2
   - If reviewers don't respond: Remove access (for Zone 3)
...
# Configure a site for agent knowledge source (Zone 3)
...
**Scenario:** A wealth management firm uses Copilot agents to answer client questions using portfolio documentation stored in SharePoint.
...
2. **Internal Research Agent** (Zone 2):
...
5. **Confirm External Sharing Blocked:**
   - Attempt to share a document externally from Zone 3 site
...
| [Control 4.1](../pillar-4-sharepoint/4.1-information-access-governance-iag-and-restricted-content-discoverability.md) | IAG for advanced content restrictions |
| [Control 4.2](../pillar-4-sharepoint/4.2-site-access-reviews-and-permission-management.md) | Access reviews for SharePoint sites |
| [Control 4.4](../pillar-4-sharepoint/4.4-guest-access-controls-and-external-sharing-policies.md) | Guest access management |
