...
!!! tip "Automation Available"
    ...
    - [Cross-Tenant External Sharing Governance](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/cross-tenant-external-sharing-governance) — detection, validation, and remediation of cross-tenant access for Power Platform AI agents
