...
!!! danger "Non-substitution — technical guardrails are not governance"
    ...
    - **Model-risk governance committee oversight** required by OCC Bulletin 2011-12 / Federal Reserve SR 11-7 — see [Control 2.6](2.6-model-risk-management-sr-26-2.md). A Managed Environment toggle is not an independent model validation.
