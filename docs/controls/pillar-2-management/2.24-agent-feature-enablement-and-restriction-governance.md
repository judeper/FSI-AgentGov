---
description: "Agent Feature Enablement and Restriction Governance: Define and enforce zone-based policies for enabling or restricting Microsoft Copilot Studio, Microsoft…"
---
# Control 2.24: Agent Feature Enablement and Restriction Governance

**Control ID:** 2.24<br>
**Pillar:** Management<br>
**Regulatory Reference:** SOX 302/404, FINRA 3110, FINRA 4511, FINRA RN 24-09, Fed SR 26-2 (formerly SR 11-7), OCC Bulletin 2026-13 (formerly OCC 2011-12), FFIEC IT Risk Management, GLBA 501(b), SEC Reg SCI (SCI entities)<br>
...
|---|---|
| Federal Reserve SR 26-2 (formerly SR 11-7) / OCC Bulletin 2026-13 (formerly OCC 2011-12) (Model Risk Management) | Enabling or disabling a generative AI capability on a production agent is treated as a material change to the model under Fed SR... |
| SOX 302/404 | Internal controls over financial reporting — restricting unapproved generative features and AI capabilities supports control... |
| FINRA Rule 3110 (Supervision) | Supervisory procedures should be updated whenever a new capability (e.g., web search, code interpreter, external actions, MCP... |
| FINRA RN 25-07 (workplace modernization RFC) | Cited here as contextual industry consultation only — it is an RFC, not binding guidance, and does not of itself create... |
| FFIEC IT Risk Management Handbook | Supports documenting the business justification, risk rating, rollback plan, and compensating controls for each capability... |
| GLBA 501(b) | Administrative, technical, and physical safeguards — feature restriction policies contribute to safeguarding customer information... |
| FINRA Rule 4511 / SEC 17a-4 | Records retention and supervision — restricting features that lack adequate audit trails or records retention supports regulatory... |
| SEC Regulation SCI (SCI entities only) | Firms that qualify as SCI entities should treat enablement of capabilities that affect order-handling or market-facing agents as... |

??? note "Regulatory mapping — click to expand"
    - **Federal Reserve SR 26-2 (formerly SR 11-7) / OCC Bulletin 2026-13 (formerly OCC 2011-12) (Model Risk Management):** Enabling or disabling a generative AI capability on a production agent is treated as a material change to the model under Fed SR 26-2 (formerly SR 11-7) §V ("Model Change Management") and OCC Bulletin 2026-13 (formerly OCC 2011-12). Feature-enablement decisions should cascade a re-validation trigger into Control 2.6 (MRM) and a supervisory-procedures review under Control 2.12 before the capability is made available to users. Feature toggles alone do not substitute for MRM validation.
    ...
    - **FINRA RN 25-07 (workplace modernization RFC):** Cited here as contextual industry consultation only — it is an RFC, not binding guidance, and does not of itself create feature-governance obligations. Primary supervisory authority remains FINRA Rule 3110.
...
!!! tip "Automation Available"
    See [Generative AI Config Auditor](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/generative-ai-config-auditor) in FSI-AgentGov-Solutions for validation of generative AI feature configurations — including generative orchestration, generative answers nodes, knowledge sources, and ungrounded-response settings — against zone-specific governance policies.
...
!!! warning "Governance exception: Researcher and Analyst agents"
    ...
    **Researcher with Computer Use:**
    Researcher's core capabilities are governed at the Copilot platform level, but the **Researcher with Computer Use** extension is configurable through the Agent 365 admin experience. Computer Use has been generally available since October 2025 for tenants with Microsoft 365 Copilot licensing (no longer Frontier-gated):
...
| [2.6 - Model Risk Management Alignment with OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7)](2.6-model-risk-management-sr-26-2.md) | A capability change is a model change under Fed SR 26-2 (formerly SR 11-7); feature enablement should cascade a re-validation trigger into the MRM workflow |
...
- [OCC Bulletin 2026-13: Supervisory Guidance on Model Risk Management (formerly OCC Bulletin 2011-12)](https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html)
