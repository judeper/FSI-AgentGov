---
description: "Microsoft Agent 365 — Admin Center Governance Console: Establish administrative governance over Microsoft 365 AI agents through the Microsoft Agent 365 Admin…"
search:
  boost: 2
---
...
|---|---|
| FINRA Rule 3110 (Supervision) | FINRA requires broker-dealers to establish and maintain a supervisory system reasonably designed to achieve compliance with... |
| SEC Rules 17a-3/17a-4 (Recordkeeping) | Broker-dealers must retain records of business activities conducted through technology systems. |
| SOX 302/404 (Internal Controls) | SOX requires management attestation and auditor assessment of internal controls over financial reporting. |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) (Technology Risk Management) | The OCC expects supervised institutions to manage risks arising from technology, including tools developed by or integrated with... |
...
*Updated: June 2026 | Version: v1.6.2 | UI Verification Status: Current (May 2026, post-GA prerequisite refresh; re-verify quarterly)*
