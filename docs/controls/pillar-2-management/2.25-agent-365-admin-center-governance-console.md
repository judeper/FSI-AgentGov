...
**Control ID:** 2.25
**Pillar:** Management
**Regulatory Reference:** FINRA Rule 3110 (Supervision), SEC Rules 17a-3/17a-4 (Recordkeeping), SOX 302/404 (Internal Controls), OCC Bulletin 2011-12 (Technology Risk Management)
...
!!! note "Agent Management Essentials prerequisites"
    Microsoft documents **AI Admin**, **Global Admin**, and **Global Reader** (view only) as the primary roles for managing agents in Microsoft 365 admin center. Use least-privilege role assignment for day-to-day operations and apply Entra Privileged Identity Management to sensitive admin roles.

## Objective

Establish comprehensive administrative governance over all Microsoft 365 AI agents through the Agent 365 Admin Center Governance Console — the unified control plane for agent lifecycle management, publication approval workflows, governance template enforcement, and operational monitoring. Financial services institutions must configure and actively operate this console to satisfy supervisory obligations under FINRA Rule 3110, maintain auditable agent inventories for SEC examination readiness, enforce internal controls required by SOX 302/404, and demonstrate technology risk management practices consistent with OCC 2011-12. This control ensures that no AI agent operates within the Microsoft 365 environment without explicit administrative approval, documented ownership, enforced data governance policies, and continuous exception monitoring.
...
|---|---|
| Agent 365 Overview Dashboard | Hero metrics panel showing Agent Registry count, Active Users, Total Sessions, Exception Rate, and Agent Runtime over the last 30 days. Provides instant operational awareness and anomaly detection for governance staff. |
...
- **Assign AI Admin for day-to-day operations:** Reserve Global Admin for Frontier enrollment, licensing, and emergency actions. Use AI Admin for routine approval, registry, deployment, and blocking tasks; use Global Reader for evidence-only access.
...
| Role | Responsibility |
|---|---|
| M365 Global Administrator | Enroll tenant in Copilot Frontier; assign preview licenses; configure top-level admin approval settings; grant admin consent when broader tenant permissions are required. |
| AI Admin | Perform day-to-day agent administration in Microsoft 365 admin center, including approval, deployment, blocking, and registry review, using the least-privilege admin role documented by Microsoft. |
...
| 3.11 — Agent 365 Analytics and Reporting | Control 3.13 provides detailed guidance on interpreting and operationalizing the analytics surfaces (by publisher, by platform, Active Users Over Time) available within the Agent 365 console documented here. |
