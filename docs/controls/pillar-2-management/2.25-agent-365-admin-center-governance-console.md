...
!!! info "Frontier Preview — General Availability May 1, 2026"
    Microsoft Agent 365 is currently available as a **Frontier preview** feature and requires explicit tenant enrollment. Official Microsoft Learn guidance states that tenants need at least one Microsoft 365 Copilot license to enable Frontier, and **Billing > Licenses** should show **25 Microsoft Agent 365 Frontier** entitlements during preview.

    Microsoft documents a **May 1, 2026** general availability target. At GA, Agent 365 transitions from preview per-agent-instance entitlements to **per-user** licensing, with agents acting on behalf of a licensed user covered under that user's **Agent 365** or **Microsoft 365 E7** license.

    All configuration steps in this control reflect the Frontier preview experience as verified in March 2026. Expect UI and feature changes before or at GA, and review Microsoft Learn before treating preview workflows as steady-state governance procedures.
...
- **Frontier Enrollment (prerequisite):** Navigate to M365 Admin Center > Copilot > Settings > User Access > Copilot Frontier and enroll the tenant. At least one Microsoft 365 Copilot license must be assigned before Frontier becomes available. Verify enrollment by confirming 25 Agent 365 Frontier licenses appear under Billing > Licenses.
...
1. **Frontier enrollment confirmed:** Billing > Licenses shows 25 Agent 365 Frontier licenses with at least one assigned; Agents section is visible in the M365 admin center left navigation.
...
!!! note "Preview Resources"
    Agent 365 feature areas such as governance templates, Researcher with Computer Use, and licensing details are still evolving within the documentation hub. Start with the Agent 365 overview page and Microsoft 365 admin center agents documentation before depending on deep-linked preview articles.

*Updated: March 2026 | Version: v1.3 | UI Verification Status: Current (Frontier Preview)*
