---
description: "Bias Testing and Fairness Assessment: Implement systematic bias testing and fairness assessment for AI agents to identify and remediate discriminatory…"
---
...
|---|---|
| FINRA Rule 3110 (Supervision) | Written supervisory procedures should cover AI systems used in investor communications and recommendations, including evidence of... |
...
| Fed SR 26-2 (formerly SR 11-7) / OCC Bulletin 2026-13 (formerly OCC 2011-12) (Model Risk Management) | Model validation should assess outcomes for potential disparate impact across protected classes; effective challenge by an... |
| ECOA / Regulation B (12 CFR § 1002.4) | Prohibits discrimination on a prohibited basis in any aspect of a credit transaction. |
| CFPB Circular 2023-03 | Reaffirms that creditors using AI / complex models must still provide specific and accurate adverse action reasons under ECOA —... |
