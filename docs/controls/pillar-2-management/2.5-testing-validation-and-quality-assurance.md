...
| **Performance Testing** | Ensure agents meet response time requirements | Customer experience |
...
4. Automated regression tests integrated in deployment pipeline
5. UAT sign-off obtained from business owners
6. Test evidence retained per regulatory retention policy
