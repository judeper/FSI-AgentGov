---
description: "Testing, Validation, and Quality Assurance: Help validate that Microsoft Copilot Studio agents, Microsoft 365 Copilot extensibility scenarios, and any related…"
---
...
|---|---|
| SOX Sections 302/404 | If an AI assistant or agent influences finance, controllership, disclosure drafting, or reconciliations, management should treat... |
| FINRA Rule 4511 + SEC 17a-4(b)(4) | Test plans, evaluator outputs, promotion approvals, and supervisory review records can become books-and-records evidence for... |
| FINRA RN 24-09 / Rule 3110 (June 2024) | Reaffirms that existing supervisory and recordkeeping obligations apply to generative AI; firms should be able to explain how AI... |
| FINRA Rule 3110 | Supervisory testing should cover not only bias but also accuracy, suitability, escalation paths, and review of AI-generated... |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) / Fed SR 26-2 (formerly SR 11-7) | Higher-risk or finance-touching AI use cases should be subject to functionally independent validation and ongoing monitoring, not... |
...
!!! tip "Automation Available"
    ...
    - [Conflict of Interest Testing](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/coi-testing) — conflict of interest testing for agent recommendations
    - [Model Risk Management Automation](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/model-risk-management-automation) — model inventory submission, risk scoring, and independent validation workflows
...
!!! info "Copilot Studio Analytics Retention Windows (May 2026)"
    Per Microsoft Learn, analytics data is available for up to **360 days**; session details and transcript information is available for the last **28 days**. Validation evidence, transcript records, and testing artifacts required beyond these windows must be exported and stored in a retention-bound location (Purview retention, Log Analytics, or a zone-appropriate WORM store) before expiry. For Zone 3 evidence packs, schedule automated export before the 28-day session-data window closes.
...
| [4.7 - Microsoft 365 Copilot Data Governance](../pillar-4-sharepoint/4.7-microsoft-365-copilot-data-governance.md) | Data-governance and third-party-model considerations for Microsoft 365 Copilot scenarios |
...
Microsoft Copilot Studio's agent evaluations feature reached general availability in **March 2026** ([Copilot Studio What's new](https://learn.microsoft.com/en-us/microsoft-copilot-studio/whats-new)) and provides test-set-based evaluation with set-level grading, multi-dimensional graders, and importable/exportable test sets.

Two automation surfaces are available:

- **Copilot Studio connector for Power Automate** (April 2026 GA) — trigger evaluations from flows; see [Automate agent evaluations](https://learn.microsoft.com/en-us/microsoft-copilot-studio/analytics-agent-evaluation-automate-tools).
- **REST API** (Preview as of April 2026) — integrate evaluation into CI/CD pipelines via the Power Platform API; see [Run automated agent evaluations from a REST API](https://learn.microsoft.com/en-us/microsoft-copilot-studio/analytics-agent-evaluation-rest-api). **Treat as Preview**: do not depend on it for production change-gate enforcement until GA is announced.

**Agent 365 SDK testing scope clarification:**
Agent 365 SDK agents (Teams/Word/Outlook-hosted) are tested locally with **Microsoft 365 Agents Playground** (`winget install agentsplayground` or `npm install -g @microsoft/m365agentsplayground`). The Agent 365 CLI (`a365`, installed via `dotnet tool install --global Microsoft.Agents.A365.DevTools.Cli`) covers **deployment and management** of Agent 365 apps to Azure — not test-suite execution. See [Test agents using the Microsoft Agent 365 SDK](https://learn.microsoft.com/microsoft-agent-365/developer/testing) and [Agent 365 CLI reference](https://learn.microsoft.com/microsoft-agent-365/developer/agent-365-cli). Copilot Studio agents are out of scope of `a365`.
...
- [Microsoft Learn: Agent 365 SDK Overview](https://learn.microsoft.com/en-us/microsoft-agent-365/developer/) - SDK overview including testing capabilities
