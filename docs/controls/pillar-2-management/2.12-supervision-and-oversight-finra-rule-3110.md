...
!!! info "Preview Feature - Frontier Program"
    ...
    **February 2026 Status:** Entra Agent ID and Conditional Access for agents are GA. The Agent 365 Unified Control Plane and Observability remain in preview. Observability integration for supervision evidence collection (linking agent behavior logs to sponsorship attestation) is expected to mature as the control plane reaches GA.
...
- See [Agent 365 Architecture](../../framework/agent-identity-architecture.md) for unified governance context and sponsorship integration with Agent 365 control plane
