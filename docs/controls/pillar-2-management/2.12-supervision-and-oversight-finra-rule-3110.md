...
**Regulatory Reference:** FINRA Rule 3110, FINRA Rule 4511, FINRA Rule 2210, FINRA Rule 3120, SEC Rule 17a-4, SOX Sections 302/404<br>
...
This pattern is relevant when building custom supervision workflows outside Copilot Studio. It complements Copilot Studio review queues and human handoff; it doesn't replace written supervisory procedures, reviewer qualifications, or principal approval requirements.
...
6. If custom Agent Framework workflows are used, request IDs, checkpoint state, and reviewer responses are retained as supervisory evidence
