...
**Regulatory Reference:** FINRA Rule 3110(a)(7), FINRA Regulatory Notice 25-07, SOX Section 404, GLBA Section 501(b), OCC Bulletin 2011-12<br>
...
!!! info "No Automation Solution"
    No companion automation solution is currently available for this control. Implementation depends on a learning platform (Microsoft Viva Learning or a third-party LMS) plus an organization-specific curriculum. See the [Solutions Index](../../reference/solutions-index.md) for the catalog of automated solutions covering other controls.
