---
description: "Training and Awareness Program: Establish comprehensive training and awareness programs for AI agent governance so that personnel involved in agent creation…"
---
...
|---|---|
| FINRA Rule 3110(a)(7) | Supervisory systems require annual compliance meetings and substantive training for personnel involved in oversight functions,... |
| FINRA RN 24-09 / Rule 3110 / 2026 Annual Regulatory Oversight Report (GenAI section) | Firms are expected to deliver substantive, recurring AI-specific training that addresses model capabilities, limitations, bias,... |
