---
description: "Customer AI Disclosure and Transparency: Establish formal processes to disclose to customers that they are interacting with AI agents, explain agent…"
---
...
|---|---|
| SEC Reg BI | Transparency obligations require disclosure of how recommendations are made; undisclosed AI involvement in recommendations may... |
| CFPB UDAAP (12 U.S.C. 5531/5536) | Failure to clearly disclose that a customer is interacting with AI — or failing to provide a workable path to a human when one is... |
| FINRA Rule 2210 + Regulatory Notice 24-09 | All customer-facing communications, including those generated or shaped by AI/LLMs, must be fair, balanced, and not misleading. |
| SEC Rule 17a-4 / FINRA Rule 4511 | Disclosure language, disclosure-version history, and the AI-side of the customer transcript must be retained as books-and-records... |
| State AI Laws | — |
