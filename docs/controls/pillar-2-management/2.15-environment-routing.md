...
**Regulatory Reference:** OCC 2011-12, FINRA Rule 3110, GLBA Section 501(b), SOX Sections 302/404<br>
...
- **OCC 2011-12:** Routing makers to governed environments for operational risk management
- **FINRA Rule 3110:** Routing rules based on role/group membership support supervisory oversight obligations
- **GLBA Section 501(b):** Directs makers to environments with proper data policies for customer protection
- **SOX Sections 302/404:** Routing decision records support audit trail requirements of routing decisions for internal controls
...
| **Zone 3** (Enterprise) | Route to production environments; full governance; strict monitoring and documented exception handling for unauthorized agent creation | Customer-facing requires strictest routing |
