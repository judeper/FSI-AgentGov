---
description: "Change Management and Release Planning: Establish structured governance over all modifications to AI agents through controlled, documented, and approved…"
---
...
|---|---|
| SOX Section 302 (CEO/CFO certification) | Officers certify the effectiveness of internal controls over financial reporting; AI agents touching financial data, disclosure... |
| SOX Section 404 (Internal Control Assessment) | Change management is a foundational IT general control (ITGC); auditors expect evidence that agent modifications follow a... |
| FINRA Rule 4511 / RN 24-09 (Rule 3110 supervision) | Books-and-records obligations require preservation of records evidencing how AI systems used in supervision or customer... |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) (Supervisory Guidance on Model Risk Management) and Fed SR 26-2 (formerly SR 11-7) | Prompt, knowledge-source, and connector changes that influence a model's output are model changes; OCC and the Federal Reserve... |
| FFIEC IT Handbook — Development & Acquisition Booklet | Examiners look for a defined SDLC with separation between development, test, and production environments; pipeline-based... |
| SEC Rule 17a-3 / 17a-4 | Change records, approvals, and rollback evidence must be retained in WORM-compliant or equivalent immutable storage for the... |
| GLBA 501(b) Safeguards Rule | Administrative safeguards include controlled changes to systems handling customer information; uncontrolled agent edits create... |
...
!!! tip "Automation Available"
    ...
    - [Agent 365 Lifecycle Governance](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-365-lifecycle-governance) — sponsor assignment, access reviews, inactivity handling, deactivation, and deletion holds for registered agents
...
!!! note "Copilot Agent Kit review surfaces are complementary"
    The **Agent Review Tool** in Copilot Agent Kit (formerly Copilot Studio Kit) supports interactive, on-demand assessment of Copilot Studio and Microsoft 365 declarative agents. The **Agent Review Pipeline** runs the same evaluation engine as a pre-deployment CI/CD gate for solution-packaged Copilot Studio agents promoted through Power Platform Pipelines. The Pipeline is not a renamed replacement for the Tool, does not intercept runtime conversations, and does not replace delegated deployment, CAB/compliance approval, or post-deployment monitoring.

    The Pipeline requires a Power Platform Pipeline with a **custom host**, a GitHub repository and workflow, a Microsoft Entra service principal for Dataverse access, and Copilot Studio capacity. Its managed solution is self-contained and can be installed independently; the full Copilot Agent Kit and Agent Insights Hub prerequisites do not apply to this component.
...
- [Copilot Agent Kit — Agent Review Tool](https://learn.microsoft.com/en-us/microsoft-copilot-studio/guidance/kit-agent-review-tool) — interactive, on-demand quality and compliance-pattern assessment; review results and reports are stored in Dataverse. Treat the output as supporting review evidence, not as the deployment approval itself.
- [Copilot Agent Kit — Agent Review Pipeline](https://learn.microsoft.com/en-us/microsoft-copilot-studio/guidance/kit-agent-review-pipeline) — deployment-time quality gate for Power Platform Pipelines; requires a custom pipeline host and its independently deployable solution.
- [Microsoft Copilot Agent Kit — GitHub source (historical repository slug preserved)](https://github.com/microsoft/Power-CAT-Copilot-Studio-Kit)
