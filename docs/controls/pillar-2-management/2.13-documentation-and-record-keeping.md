...
- **SEC 17a-3/4:** Requires non-rewritable, non-erasable (WORM) storage for specified records
...
3. **WORM Compliance** - Configure non-rewritable storage for SEC 17a-4 compliance
...
- Enable WORM storage via Azure Blob immutability or third-party archive
...
| **Zone 3** (Enterprise) | Full WORM compliance; automated retention; examination-ready documentation; quarterly audit | Customer-facing requires maximum recordkeeping rigor |
...
3. WORM storage configured for SEC 17a-4 compliance (Zone 3)
