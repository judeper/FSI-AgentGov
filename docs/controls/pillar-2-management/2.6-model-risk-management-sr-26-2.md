...
**Regulatory Reference:** OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) (Sound Practices for Model Risk Management), Federal Reserve SR 26-2 (formerly SR 11-7) (Supervisory Guidance on Model Risk Management), FDIC FIL-15-2026 (FDIC adoption of revised interagency Model Risk Management guidance, April 17, 2026), FFIEC IT Examination Handbook (Management; Information Security), FINRA Rule 3110 (Supervision), FINRA Rule 4511 (Books and Records), FINRA RN 24-09, SEC Rules 17a-3 / 17a-4 (Recordkeeping for model artifacts and validation evidence), SOX Sections 302 / 404 (Internal Controls over Financial Reporting), GLBA 501(b) (Safeguards Rule), NYDFS 23 NYCRR 500 (where AI agents touch covered customer information)<br>
...
!!! tip "Automation Available"
    See [Model Risk Management Automation](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/model-risk-management-automation) in FSI-AgentGov-Solutions for automated model inventory submission, risk scoring, independent validation workflows, ongoing monitoring, and examiner-facing Agent Card generation.
...
!!! info "Copilot Studio model lifecycle operating practice"
    Microsoft documents model selection as an ongoing lifecycle rather than a one-time configuration choice. For each production agent, operate a repeatable **Discover → Inventory → Evaluate → Approve → Deploy → Monitor → Repeat** process. Treat a new default, retirement notice, provider change, or selected-model migration as a governed change; evaluate the candidate against the agent's established baseline, deploy through the organization's ALM process, and retain the approval and post-deployment monitoring evidence.

    Do not copy a current model list into policy or control evidence. Model names, release classifications, regional availability, administrator settings, and retirement status change over time. Use [Manage the AI model lifecycle for Copilot Studio agents](https://learn.microsoft.com/en-us/microsoft-copilot-studio/guidance/plan-agent-model-lifecycle), the current model-selection documentation, the model list visible for the specific agent and environment, and tenant-targeted notifications as the authoritative sources at decision time.
...
- [FDIC FIL-15-2026 — FDIC adoption of revised interagency Model Risk Management guidance](https://www.fdic.gov/news/financial-institution-letters/2026/agencies-revise-interagency-model-risk-management-guidance) — current FDIC adoption letter for SR 26-2 / OCC Bulletin 2026-13 (April 17, 2026); rescinds FIL-22-2017
...
- OCC Bulletin 2011-12 — Sound Practices for Model Risk Management — *historical rescinded bulletin retained for audit-trail context; superseded by OCC Bulletin 2026-13 as of April 17, 2026*
- Federal Reserve SR letter 11-7 (April 4, 2011) — Guidance on Model Risk Management — *historical superseded letter retained for audit-trail context; the predecessor URL `sr1107.htm` no longer resolves on the Federal Reserve site; superseded by SR 26-2 as of April 17, 2026*

**Microsoft Learn — surfaces this control depends on (source links refreshed September 2026; UI procedures not reverified)**
...
- [Copilot Studio — manage the AI model lifecycle](https://learn.microsoft.com/en-us/microsoft-copilot-studio/guidance/plan-agent-model-lifecycle)
