...
!!! note "Anthropic Native Integration"
    ...
    With ChatGPT-5 and Claude models now generally available as native Copilot Studio model options, organizations should update their vendor risk inventories to classify these as production-tier third-party model providers requiring quarterly risk assessment. Note that ChatGPT-5 availability in GCC and sovereign cloud environments may differ; verify current availability in your deployment environment before implementing dependent controls.
