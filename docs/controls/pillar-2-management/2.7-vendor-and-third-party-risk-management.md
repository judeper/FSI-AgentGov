---
description: "Vendor and Third-Party Risk Management: Establish a comprehensive framework for identifying, assessing, and managing risks associated with third-party vendors…"
---
...
|---|---|
| Interagency Guidance on Third-Party Relationships (FRB/FDIC/OCC, June 2023) | Establishes lifecycle expectations (planning, due diligence, contract negotiation, ongoing monitoring, termination) that... |
...
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) / Fed SR 26-2 (formerly SR 11-7) | Treat third-party AI/LLM providers as part of the model supply chain; vendor change can constitute a model change requiring... |
...
| SOX Section 404 | Internal controls over financial reporting extend to vendor-provided services that influence reportable processes; SOC 1/SOC 2... |
...
| FINRA Rule 4511 / SEC Rule 17a-4(f) | Books-and-records vendors (archiving, WORM) supporting AI-generated content must meet electronic recordkeeping requirements;... |
| FINRA Regulatory Notice 24-09 / Rule 3110 | Reinforces that AI-generated communications are subject to existing recordkeeping and supervision rules — vendor capability gaps... |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA Regulatory Notice 24-09 / Rule 3110:** Reinforces that AI-generated communications are subject to existing recordkeeping and supervision rules — vendor capability gaps become firm-level deficiencies
    - **OWASP LLM Top 10 (LLM03 Supply Chain, LLM05 Improper Output Handling, LLM07 Insecure Plugin Design):** Identify supply-chain, plugin, and tool-loading risks unique to LLM-backed agents
...
| **Communication Compliance** | Theta Lake, NICE Actimize, Behavox | AI interaction capture, FINRA Rule 4511 / RN 24-09 recordkeeping support, review workflow |
...
1. Does the vendor support AI-generated content archiving per FINRA Rule 4511 / RN 24-09 recordkeeping requirements?
...
- Apply the **Interagency Guidance on Third-Party Relationships: Risk Management (FRB/FDIC/OCC, June 2023)** lifecycle stages to every Zone 2/3 AI / connector vendor: planning → due diligence and third-party selection → contract negotiation → ongoing monitoring → termination
- Apply **OCC Bulletin 2013-29** risk-tiered due-diligence depth (and the **OCC Bulletin 2020-10** FAQs) to scope vendor assessment effort to the criticality of the connector or AI service; document the tiering decision per vendor
...
- Establish review cadence (monthly usage, quarterly performance, annual security) consistent with the Interagency 2023 Guidance ongoing-monitoring expectations
- Document exit plans for critical vendor relationships, aligned to the Interagency 2023 Guidance termination-stage expectations
...
| [2.6 - Model Risk Management](2.6-model-risk-management-sr-26-2.md) | Vendor model changes are a model-risk trigger requiring re-validation |
...
- [Microsoft Learn: Manage plugins and connectors in Copilot Studio](https://learn.microsoft.com/en-us/microsoft-copilot-studio/advanced-generative-actions)
...
- [Microsoft Service Trust Portal (SOC reports, attestations)](https://servicetrust.microsoft.com/) — see the [Service Trust Portal Attestation Evidence Guide](../../reference/service-trust-portal-attestation-guide.md) for cadence, examiner-acceptance mapping, and download workflow
- [Microsoft Purview Compliance Manager templates (FFIEC, GLBA, SOX, NIST, ISO, SOC 2, EU AI Act)](../../reference/compliance-manager-templates.md) — customer-authored control mapping surface (distinct from STP)
