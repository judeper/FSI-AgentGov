...
- [Sardine Agentic Oversight Framework](https://www.sardine.ai/blog/agentic-ai-oversight) - 5-component oversight model applicable to MCP governance
...
- [Microsoft Learn: MCP Server Support (Preview)](https://learn.microsoft.com/en-us/microsoft-copilot-studio/mcp-servers)
