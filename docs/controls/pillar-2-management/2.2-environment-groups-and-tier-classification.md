...
- Configure sharing rules: disabled for Zone 1, enabled with controls for Zone 2/3
- Set authentication requirements for agents (required for Zone 2/3)
- Configure solution checker: None (Zone 1), Warn (Zone 2), Block (Zone 3)
- Disable external AI models and Computer-Using Agents (CUA) for all regulated zones
