...
**Regulatory Reference:** FINRA Rule 4511, GLBA Section 501(b), SOX Sections 302/404, OCC 2011-12<br>
...
- **FINRA Rule 4511:** Consistent recordkeeping controls across environments through transcript access and usage insights rules
- **GLBA Section 501(b):** Uniform data protection via sharing restrictions, authentication requirements, and IP binding
- **SOX Sections 302/404:** Segregation of duties enforced through zone classification and solution checker blocking
...
Environment groups work in conjunction with Managed Environments (Control 2.1) and Environment Routing (Control 2.15) to help ensure makers are placed into correctly governed environments that inherit appropriate rules automatically.
...
| **Power Apps Code Apps** | Enabled | Enabled (with review) | Disabled (unless approved) | Controls code-first app development per environment group |
| **Content Security Policy** | Default | Configured | Strict (custom policy required) | Helps mitigate cross-site scripting and injection risks |
