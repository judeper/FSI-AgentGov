...
|----------|----------------|---------------|
| Proof-of-concept (≤30 days, ≤5 users, no production data) | Tier 1 Auto-Approve | Limited scope, no regulatory exposure |
| Training/demo environment (no customer data) | Tier 1 Auto-Approve | Educational purpose only |
| Migration of existing approved agent to new environment | Retain original tier | No change in risk profile |
