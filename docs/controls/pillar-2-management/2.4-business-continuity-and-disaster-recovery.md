---
description: "Business Continuity and Disaster Recovery: Define how the organization keeps critical Microsoft Copilot Studio agents available — or restores them within…"
search:
  boost: 2
---
...
|---|---|
| FFIEC BCM Handbook (Nov 2019) | Examiners expect a documented Business Impact Analysis (BIA), explicit RTO/RPO per critical system, tested recovery procedures,... |
| FINRA Rule 4370 (Business Continuity Plans) | Member firms must maintain a written BCP addressing mission-critical systems, alternate communications, data backup and recovery,... |
| FINRA Rule 4511 / FINRA RN 24-09 / Rule 3110 | Required books and records — including supervisory artifacts created by or supporting AI agents — must remain recoverable for the... |
| SEC Rule 17a-3 / 17a-4 | Records must be preservable and reconstructable for the full retention term, in non-erasable / non-rewritable form (or equivalent... |
| SOX 404 | Internal control over financial reporting includes IT general controls (ITGCs) for backup and recovery; documented and tested DR... |
| GLBA 501(b) / Safeguards Rule | Administrative, technical, and physical safeguards must protect the availability of customer information; this requires a tested... |
| OCC Heightened Standards – 12 CFR 30 Appendix D | Covered banks must maintain a Risk Governance Framework that explicitly addresses operational resilience, including independent... |
| Interagency Paper on Sound Practices to Strengthen Operational Resilience (Oct 2020) | Joint OCC / Federal Reserve / FDIC guidance — large firms should set tolerances for disruption, map dependencies (including cloud... |
...
??? note "Full regulatory context"
    ...
    - **FINRA Rule 4511 / FINRA RN 24-09 / Rule 3110:** Required books and records — including supervisory artifacts created by or supporting AI agents — must remain recoverable for the prescribed retention period; AI-related supervisory records receive heightened scrutiny under RN 24-09's Gen AI guidance.
