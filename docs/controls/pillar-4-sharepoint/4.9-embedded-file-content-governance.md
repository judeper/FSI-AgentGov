---
description: "Embedded File Content Governance: Establish governance requirements for the use of embedded file content as agent knowledge sources in Microsoft 365 Copilot…"
---
...
|---|---|
| FINRA Rule 4511 and SEC 17a-3/4 | require that firms retain and produce records of communications and data used in the conduct of their business. |
| GLBA § 501(b) | requires firms to implement administrative, technical, and physical safeguards to protect customer information. |
| SOX §§ 302/404 | require management to maintain and attest to effective internal controls over financial reporting. |
| Information Barrier rules | enforced by FINRA and the SEC require firms to maintain information walls between certain business lines. |
...
| 4.3 | Site and Document Retention Management | Retention requirements apply to embedded files as business records subject to FINRA 4511 / RN 24-09 / SEC 17a-4 |
...
- [Microsoft Purview: Information Protection label policies](https://purview.microsoft.com/informationprotection)
