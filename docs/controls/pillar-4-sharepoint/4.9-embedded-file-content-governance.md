...
Establish governance requirements for the use of embedded file content as agent knowledge sources in Microsoft 365 Copilot, so that all files uploaded to agents via Agent Builder are properly classified, their sensitivity labels are correctly applied and enforced, the critical Information Barriers gap is assessed and mitigated before deployment, container integrity is maintained, and all agents using embedded files are tracked in the enterprise agent inventory.
...
| **Availability Status** | Generally Available — IB support: **NOT available** (as of March 2026) |
...
| 4.3 | Site and Document Retention Management | Provides the broader SharePoint governance framework within which Declarative Agent containers operate |
| 4.4 | Guest and External User Access Controls | Retention requirements apply to embedded files as business records subject to FINRA 4511 / SEC 17a-4 |
...
- [Microsoft Learn: Add files as knowledge sources in Agent Builder](https://learn.microsoft.com/en-us/microsoft-365-copilot/extensibility/agent-builder-knowledge-files)
- [Microsoft Learn: SharePoint Embedded containers overview](https://learn.microsoft.com/en-us/sharepoint/dev/embedded/overview)
- [Microsoft Learn: Sensitivity labels — Microsoft 365 Copilot](https://learn.microsoft.com/en-us/purview/sensitivity-labels-copilot)
