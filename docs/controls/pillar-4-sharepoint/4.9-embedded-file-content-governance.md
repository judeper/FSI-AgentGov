...
| **SharePoint / M365 Administrator** | Maintain default sensitivity label policy. Configure container creation alerts. Execute quarterly container audits via SharePoint Admin Center and PowerShell. Never delete containers outside of proper agent deletion workflow. |
...
| 4.3 | SharePoint Site Access Controls | Provides the broader SharePoint governance framework within which Declarative Agent containers operate |
| 4.4 | SharePoint Retention and Records Management | Retention requirements apply to embedded files as business records subject to FINRA 4511, FINRA 25-07 / SEC 17a-4 |
