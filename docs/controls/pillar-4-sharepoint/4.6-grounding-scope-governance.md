...
**Regulatory Reference:** SEC 17a-3/4, GLBA Section 501(b), FINRA Rule 4511, SOX Sections 302/404, OCC Bulletin 2011-12<br>
...
- **GLBA Section 501(b):** Controls agent data access scope to protect customer information
- **FINRA Rule 4511:** Helps prevent agents from citing draft or unverified documents in responses
- **SOX Sections 302/404:** Documents data governance decisions as part of internal controls
- **OCC Bulletin 2011-12:** Supports agent grounding on accurate, quality-controlled data
...
!!! warning "Copilot License Required for RCD"
    As of March 2026, Restricted Content Discovery (RCD) requires **at least one user assigned a Microsoft 365 Copilot license** in the tenant as a prerequisite. Organizations planning to use RCD for site exclusion should verify Copilot license assignment before enablement. See [RCD documentation](https://learn.microsoft.com/en-us/sharepoint/restricted-content-discovery) for current prerequisites.
...
**Regulatory Mapping:** SharePoint Restricted Search helps support SEC 17a-3/4 (controlling which records AI agents can access), GLBA 501(b) (limiting AI agent data surface area to approved content), FINRA Rule 4511 (helping support citation of only approved, finalized documents), and OCC 2011-12 (controlling data quality for AI-grounded responses).

---

## Key Configuration Points

- **RCD Copilot license prerequisite:** Confirm at least one tenant user has an assigned Microsoft 365 Copilot license before enabling RCD (hard dependency as of March 2026)
