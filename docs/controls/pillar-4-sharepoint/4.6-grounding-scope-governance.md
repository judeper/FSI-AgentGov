...
For FSI organizations, Restricted Search is preferred for Zone 3 regulated environments because it implements a "deny by default, allow by exception" model aligned with security best practices. This approach ensures AI agents can ONLY access explicitly approved content, regardless of user permissions.
