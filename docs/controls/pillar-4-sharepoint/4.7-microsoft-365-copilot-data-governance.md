...
- Anthropic is **enabled by default for most commercial tenants**, but **disabled by default for tenants in the EU Data Boundary (EU member states and EEA) and the UK**, and **not available in government clouds** (GCC, GCC High, DoD) or sovereign clouds. **Tenants in Switzerland or other EFTA jurisdictions outside the EU Data Boundary** must verify the Anthropic default state in tenant admin settings before relying on a protective default. See [Anthropic as a subprocessor for Microsoft Online Services](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor).
