---
description: "Microsoft 365 Copilot Data Governance: Establish governance controls for Microsoft 365 Copilot data access, oversharing reduction, label/DLP enforcement…"
---
# Control 4.7: Microsoft 365 Copilot Data Governance

**Control ID:** 4.7<br>
**Pillar:** SharePoint<br>
**Regulatory Reference:** SEC 17a-3/4, SEC Regulation S-P (May 2024 amendments), GLBA 501(b) and FTC Safeguards Rule 16 CFR §314.4(c)(5), FINRA 3110, FINRA 4511, FINRA RN 24-09, SOX 302/404, NYDFS 23 NYCRR 500 §500.12, OCC Bulletin 2026-13 (formerly OCC 2011-12), Fed SR 26-2 (formerly SR 11-7)<br>
...
|---|---|
| SEC 17a-3 / 17a-4 | If Microsoft 365 Copilot prompts, responses, Pages, Notebooks, or grounded outputs constitute business communications or records,... |
| FINRA Rules 4511 and 3110 + Regulatory Notice 24-09 | Firms must supervise AI-enabled workflows and retain books-and-records in a way that supports examiner reconstruction of what... |
| SEC Regulation S-P (May 2024 amendments) | Oversharing or unauthorized disclosure of customer information through Copilot can trigger incident-response and... |
| GLBA 501(b) / FTC Safeguards Rule 16 CFR §314.4(c)(5) | Least-privilege access, data classification, and leakage-prevention controls are required to safeguard customer information... |
...
| SOX 302 / 404 | Copilot-generated drafts or summaries used in finance, legal, or executive workflows must stay within documented control... |
| OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7) | M365 Copilot amplifies data-quality and access-governance weaknesses. |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA Rules 4511 and 3110 + Regulatory Notice 24-09:** Firms must supervise AI-enabled workflows and retain books-and-records in a way that supports examiner reconstruction of what happened, who had access, and what data was surfaced. FINRA Regulatory Notice 24-09 provides current generative-AI supervisory guidance; FINRA RN 25-07 is a monitored RFC on workplace modernization that touches AI-generated communications recordkeeping (Section E.3) but is not yet adopted — see [framework/regulatory-framework.md](../../framework/regulatory-framework.md).
    ...
    - **OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7):** M365 Copilot amplifies data-quality and access-governance weaknesses. Administrators should manage oversharing, provenance, and retention as part of the model-risk operating environment.
...
| **Purview DLP for Microsoft 365 Copilot** | Three distinct capabilities with separate GA/Preview status — verify each in your tenant before treating as primary control: (1) **Block labeled files/emails from being processed in responses** — **GA** (excludes files/emails with selected sensitivity labels from being surfaced in Copilot response summaries; response-side, not prompt-side); (2) **Block SIT-containing prompts** — **Preview** (DLP policy with `Content contains > Sensitive information types` at the Microsoft 365 Copilot and Copilot Chat location; blocks Copilot response generation when the prompt contains specified SITs); (3) **Restrict external web search for SIT-containing prompts** — **Preview** (suppresses external web grounding when prompt contains SITs). Label-based blocking does **not** operate at the prompt level. |
...
- Configure **Purview DLP** for **Microsoft 365 Copilot** — use **sensitivity labels as conditions** for the GA response-side blocking of labeled files/emails; if SIT-based prompt blocking is Preview-available in your tenant, configure as an additional Preview control and document its Preview status in tenant evidence.
...
- Review **AI subprocessors** and **flex routing** during change-control or quarterly governance cadence.
...
- Anthropic is **enabled by default for most commercial tenants**, but **disabled by default for tenants in the EU Data Boundary (EU member states and EEA) and the UK**. **Tenants in Switzerland or other EFTA jurisdictions outside the EU Data Boundary** must verify the Anthropic default state in tenant admin settings before relying on a protective default. See [Anthropic as a subprocessor for Microsoft Online Services](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor).
...
| **Vendor / Third-Party Risk Manager** | Anthropic subprocessor monitoring and ongoing review per OCC Bulletin 2026-13 (formerly OCC 2011-12) / interagency third-party guidance |
...
| **CISO** | Risk acceptance for Anthropic subprocessor and Zone 3 enforcement posture |
...
12. **Bing web-grounding toggle posture** is documented per zone (enabled / disabled / restricted).
13. **Connected Apps / declarative agents** inventoried via Agent Registry (Control 1.2) and approved per governance workflow.
14. **Zone 3 exception handling** exists for any use case involving regulated data, high-risk departments, or unresolved platform limitations.
15. **Cross-control evidence package** includes screenshots / exports from SharePoint Admin, Purview, Audit, and eDiscovery sufficient for Internal Audit or regulatory response.
