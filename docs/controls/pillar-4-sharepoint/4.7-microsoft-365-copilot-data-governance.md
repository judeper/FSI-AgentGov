...
**Regulatory Reference:** SEC Rules 17a-3/17a-4, GLBA Section 501(b), FINRA Rule 3110, FINRA Rule 4511, SOX Sections 302/404, OCC 2011-12<br>
...
- **SEC Rules 17a-3/17a-4:** Record keeping for AI-assisted communications requires usage logging and retention
- **GLBA Section 501(b):** Content exclusions and access controls protect customer information
- **FINRA Rule 4511:** Audit trail of Copilot usage supports books and records requirements
- **SOX Sections 302/404:** Output review processes support internal controls over financial reporting
- **OCC 2011-12:** Over-reliance prevention addresses model risk management concerns
- **FINRA Rule 3110:** Review requirements for Copilot-generated outputs support supervisory obligations
...
!!! warning "Copilot License Required for RCD"
    As of March 2026, Restricted Content Discovery (RCD) requires **at least one user assigned a Microsoft 365 Copilot license** in the tenant. This is a hard prerequisite — tenants without any Copilot license assignments cannot enable RCD. Verify license assignment before configuring content exclusions. See [RCD documentation](https://learn.microsoft.com/en-us/sharepoint/restricted-content-discovery) for current prerequisites.
...
- Configure Restricted Content Discovery for sensitive repositories (executive, legal, HR, M&A) — **prerequisite:** at least one user must have an assigned Microsoft 365 Copilot license in the tenant (hard dependency as of March 2026)
...
- **Monitoring:** Track subprocessor changes at [Microsoft Copilot AI Subprocessor](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor).
...
| Role | Responsibility |
|------|----------------|
| AI Administrator | Copilot settings and license management |
...
| [4.8 - Item-Level Permission Scanning](4.8-item-level-permission-scanning-agent-knowledge-sources.md) | Item-level scanning of agent knowledge sources for targeted permission validation |
...
- [Microsoft Copilot AI Subprocessor List](https://learn.microsoft.com/en-us/microsoft-365/copilot/connect-to-ai-subprocessor)
