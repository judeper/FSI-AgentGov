...
| [SharePoint Agent Insights (GA)](https://learn.microsoft.com/en-us/sharepoint/manage-agents) | Monitor agent proliferation and per-site agent access tracking via SharePoint Admin Center |
