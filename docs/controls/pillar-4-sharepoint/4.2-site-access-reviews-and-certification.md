...
**Regulatory Reference:** GLBA Section 501(b), SOX Section 404, FINRA Rule 4511, NYDFS 500.07<br>
...
Establish periodic reviews of SharePoint site access to help ensure only authorized users and agents can access sensitive content, with site attestation policies requiring site owners to certify that access permissions remain appropriate.

---

## Why This Matters for FSI

- **GLBA Section 501(b):** Access reviews demonstrate appropriate access control management for customer information
- **SOX Section 404:** Attestation provides evidence of control operating effectiveness for internal control assessment
- **FINRA Rule 4511:** Reviews help ensure only authorized personnel access records, with attestation providing supervision evidence
