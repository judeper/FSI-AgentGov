...
!!! note "Scope"
    This control addresses SharePoint-scoped access reviews and site certification, including Data Access Governance (DAG) reports, site attestation policies, and Entra ID access reviews for SharePoint sites. For Power Platform configuration governance, including Dataverse environment access reviews, see Pillar 2 (Management) controls.
