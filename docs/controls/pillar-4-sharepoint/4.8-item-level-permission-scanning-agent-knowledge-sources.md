...
**Regulatory Reference:** GLBA §314.4(c)(3), SEC 17a-4, FFIEC AI/ML Risk Management, NIST AI RMF, SR 11-7<br>
...
- **SEC 17a-4:** Electronic records access must be documented and controlled — agent access to broker-dealer records through SharePoint knowledge sources requires audit trail and permission validation
...
| Agent Business Owner | Informed of scan results affecting their agents; provide business context for remediation prioritization |
...
*Updated: March 2026 | Version: v1.2 | UI Verification Status: Current*
