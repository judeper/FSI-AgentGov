---
description: "SharePoint Information Access Governance (IAG) / Restricted Content Discovery: Control which SharePoint sites and content Microsoft 365 Copilot and AI agents…"
---
# Control 4.1: SharePoint Information Access Governance (IAG) / Restricted Content Discovery

**Control ID:** 4.1<br>
**Pillar:** SharePoint<br>
**Regulatory Reference:** GLBA 501(b), GLBA §§521-523, SEC Reg S-P, SEC 17a-4, FINRA 4511, FINRA 3110, FINRA RN 24-09, SOX 302/404<br>
...
|---|---|
| GLBA 501(b) (16 CFR Part 314 — Safeguards Rule) | Requires administrative, technical, and physical safeguards for customer nonpublic personal information (NPI); IAG aids in... |
| SEC Reg S-P (17 CFR §248.30) | Mandates written policies to protect customer records and information; RCD/RAC help meet the access-control element by scoping... |
| SEC Rule 17a-4(f) | Books-and-records preservation requires that recordkeeping systems remain controlled; IAG audit events (RCD enable/disable with... |
| FINRA Rule 4511(a) / RN 24-09 / Rule 3110 | Books-and-records integrity (Rule 4511) plus generative-AI supervision under FINRA Regulatory Notice 24-09 and Rule 3110;... |
| SOX 302/404 | Internal controls over financial reporting; restricting agent reach into SOX-scoped sites supports segregation of duties and ICFR... |
| Information Barriers | Supports the "ethical wall" expectations under FINRA 3110 supervision and MNPI handling rules to separate M&A, trading, research,... |
| GLBA §§521-523 (15 USC 6821-6823) | [^1] Prohibits obtaining customer information through false pretenses (pretexting); IAG controls help demonstrate that AI agents... |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA Rule 4511(a) / RN 24-09 / Rule 3110:** Books-and-records integrity (Rule 4511) plus generative-AI supervision under FINRA Regulatory Notice 24-09 and Rule 3110; maintains a documented governance posture over what AI tools can read across the firm. (FINRA RN 25-07 is a monitored RFC on workplace modernization that touches AI-generated communications recordkeeping; not yet adopted — see [framework/regulatory-framework.md](../../framework/regulatory-framework.md).)
...
!!! warning "Licensing Prerequisites"
    This control requires **SharePoint Advanced Management (SAM)** capabilities. SAM features (including RCD, RSS, RAC, and Data Access Governance reports) are now **included with Microsoft 365 Copilot licenses** — no separate add-on purchase is required for Copilot-licensed organizations for these features. Microsoft currently calls out **Restricted Site Creation (by apps)** as a key example of a feature requiring the **SharePoint Advanced Management Plan 1** add-on; verify the current feature-license mapping at [SAM features in Copilot environments](https://learn.microsoft.com/en-us/sharepoint/sharepoint-advanced-management-features-copilot-license) before finalizing licensing. Organizations without Copilot licenses still require the standalone SAM add-on.
...
- **RCD audit events:** All RCD state changes (enable, disable, justification records) are captured as SharePoint audit events, supporting FINRA 4511 recordkeeping and FINRA RN 24-09 / Rule 3110 supervisory requirements and providing evidence trails for compliance audits
...
When RCD is enabled on a site, the site-level setting must propagate to the search index, and SharePoint reindexes content to update the Semantic Index. Index update latency is highly dependent on the number of items in the site and how many sites are updated at the same time; per Microsoft, sites with more than 500,000 items can take more than a week to fully process and reflect in search and Microsoft 365 Copilot. Plan RCD enablement during maintenance windows and verify restriction effectiveness after propagation completes. Verify the current figure against the [Restricted Content Discovery documentation](https://learn.microsoft.com/en-us/sharepoint/restricted-content-discovery).
