...
- **GLBA 504(b):**[^1] Prohibits obtaining customer information through false pretenses; IAG controls help demonstrate that AI agents access only legitimately authorized content

[^1]: GLBA 504(b) specifically addresses "pretexting" - obtaining customer information under false pretenses. While primarily a prohibition rather than a safeguard requirement, IAG controls help demonstrate that AI agents are not circumventing access controls to obtain customer information inappropriately.
