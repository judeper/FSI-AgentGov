...
**Regulatory Reference:** GLBA Section 501(b), GLBA §§521-523, SEC Reg S-P, FINRA Rule 4511, SOX Section 302<br>
...
- **GLBA Section 501(b):** Requires safeguards for customer nonpublic personal information (NPI); IAG restricts AI from surfacing NPI from restricted sites
- **SEC Reg S-P:** Mandates protection of customer information; controls AI access to customer data repositories
- **FINRA Rule 4511:** Books and records integrity requirements; maintains governance over AI content access
- **SOX Section 302:** Internal controls over financial reporting; restricts agent access to financial reporting sites
...
The control is designed to help prevent AI agents from surfacing sensitive content inappropriately, even when users have legitimate access to it.
