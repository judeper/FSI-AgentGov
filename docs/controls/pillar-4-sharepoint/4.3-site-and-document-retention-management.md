...
!!! info "Retention Periods by Record Type"
    Agent conversation logs typically qualify as **communications** (3-year retention under SEC 17a-4(b)(4)), while financial transaction records require 6-year retention. Configure separate labels for each record type.
