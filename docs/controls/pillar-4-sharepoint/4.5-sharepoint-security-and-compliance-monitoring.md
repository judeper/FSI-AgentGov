...
### SharePoint Admin Agent (November-December 2025)

The SharePoint Admin Agent is an AI-assisted governance tool that allows administrators to query SharePoint configuration in natural language:

- Query site permissions, sharing settings, and policy compliance
