---
description: "SharePoint Security and Compliance Monitoring: Monitor SharePoint security posture, agent activity, and compliance status so that AI agents accessing…"
---
...
|---|---|
| FINRA 4511 / RN 24-09 / Rule 3110 | Agent insights provide audit trail of AI access to records (Rule 4511); continuous monitoring enables supervisory oversight under... |
...
See [What is the SharePoint Admin Agent?](https://learn.microsoft.com/en-us/sharepoint/content-governance-agent) for the current capability set and access prerequisites.
...
For broader coverage across Zone 3 enterprise estates, schedule repeated assessments rotating across site sets, or use the companion [`agent-knowledge-source-scanner`](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-knowledge-source-scanner). See [Prevent oversharing with data risk assessments from DSPM](https://learn.microsoft.com/en-us/purview/data-security-posture-management-oversharing).
