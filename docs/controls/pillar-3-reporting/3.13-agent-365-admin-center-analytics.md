...
2. After May 1, 2026 GA (or for Frontier-enrolled tenants pre-GA): hero metrics (Active Users, Total Sessions, Exception Rate, Agent Runtime) are visible and displaying non-zero values for tenants with deployed agents that fall within supported agent types.
