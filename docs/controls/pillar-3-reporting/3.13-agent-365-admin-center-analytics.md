...
| **Agents by Platform** | Distribution of agents across supported creation platforms such as Microsoft 365 Copilot Agent Builder, Copilot Studio, Agents Toolkit, SharePoint, Microsoft Foundry, and connected non-Microsoft platforms. Informs licensing and platform governance scope. |
...
| **Zone 1 — Baseline** | Provision Microsoft Agent 365 or Microsoft 365 E7 licensing within 90 days where full hero-metric visibility is required for supervisory cadence. | Forward-looking preparation; helps make the analytics surface available before downstream supervisory dependencies are written into the firm's policy. |
...
2. Hero metrics (Agent Registry, Active Users, Agent Run-time, Registry Sync) are visible for tenants with Agent 365 or Microsoft 365 E7 licensing and deployed agents that fall within supported agent types.
