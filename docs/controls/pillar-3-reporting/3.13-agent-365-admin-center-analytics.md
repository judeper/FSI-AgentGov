---
description: "Agent 365 Admin Center Analytics and Reporting: Establish a formal process for leveraging the Microsoft 365 Agent 365 Admin Center Analytics dashboard to…"
---
...
|---|---|
| FINRA RN 24-09 / Rule 3110 | The pending requests queue and ownerless agent governance cards provide real-time supervisory signals that unauthorized or... |
| FINRA 4511 / SEC 17a-3/4 | The inventory export function generates the primary examination artifact demonstrating the firm's complete agent roster at any... |
| SOX 302/404 | Agents-with-exceptions signals, any internally derived exception-rate trend, and active user trends support management's... |
| Examination Readiness | FINRA examination staff increasingly request evidence of AI governance programs. |
...
| **Researcher with Computer Use Reporting** | Configuration and usage reporting for the Researcher agent's Computer Use capability. Accessible at Agents > Researcher > Computer Use. Researcher with Computer Use is available via the Microsoft Frontier program (preview) as of February 2026 for tenants with Microsoft 365 Copilot licensing — verify current status against the [Microsoft Frontier program page](https://learn.microsoft.com/microsoft-365/admin/manage/get-started-frontier) at edit time. Enables documentation of approved and excluded websites. |
