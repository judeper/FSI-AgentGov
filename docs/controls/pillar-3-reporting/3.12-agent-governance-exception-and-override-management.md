...
**Control ID:** 3.12<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** SOX Sections 302/404, FINRA Rule 3110, OCC Bulletin 2011-12, Fed SR 11-7<br>
...
- **SOX Sections 302/404:** Internal controls over financial reporting require documented exception processes with management approval, monitoring, and remediation. Undocumented governance overrides undermine control effectiveness assessments and create audit findings
- **FINRA Rule 3110:** Supervisory procedures require documented exceptions to written supervisory procedures with principal-level approval and periodic review. AI agent governance exceptions must follow the same supervisory framework
- **OCC Bulletin 2011-12:** Model Risk Management guidance requires formal exception processes for model limitations, compensating controls, and risk acceptance decisions. AI agents qualifying as models must have tracked exceptions with time limits and renewal oversight
- **Federal Reserve SR 11-7:** Model governance framework must include processes for temporary policy waivers, compensating controls, and management override. Exception registers demonstrate effective ongoing governance and risk monitoring
...
!!! tip "Automation Available"
    See the Governance Exception Manager solution documented in the Implementation Playbooks section below.
...
|---------|--------------|
| [2.6 - Model Risk Management OCC 2011-12/SR 11-7](../pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md) | Model risk exceptions (limitations, compensating controls) require exception tracking; Control 3.12 provides exception management framework |
...
| [2.12 - Supervision and Oversight FINRA 3110](../pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md) | FINRA supervisory exception processes apply to agent governance exceptions; principal approval required |

---

!!! tip "Automated Solution: Governance Exception Manager"
    ...
    **Deployable Solution:** [governance-exception-manager](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/governance-exception-manager) provides solution package (.zip), installation guide, configuration checklist, and compliance reporting templates.
