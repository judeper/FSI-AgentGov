---
description: "Agent Governance Exception and Override Management: Establish formal processes for requesting, approving, tracking, and monitoring temporary exceptions to…"
---
# Control 3.12: Agent Governance Exception and Override Management

**Control ID:** 3.12<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** SOX 302/404, FINRA 3110, FINRA RN 24-09, OCC Bulletin 2026-13 (formerly OCC 2011-12), Fed SR 26-2 (formerly Fed SR 11-7)<br>
...
|---|---|
| SOX 302/404 | Internal controls over financial reporting require documented exception processes with management approval, monitoring, and... |
| FINRA RN 24-09 / Rule 3110 | Supervisory procedures require documented exceptions to written supervisory procedures with principal-level approval and periodic... |
| OCC Bulletin 2026-13 (formerly OCC 2011-12) | Model Risk Management guidance requires formal exception processes for model limitations, compensating controls, and risk... |
| Fed SR 26-2 (formerly Fed SR 11-7) | Model governance framework must include processes for temporary policy waivers, compensating controls, and management override. |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA RN 24-09 / Rule 3110:** Supervisory procedures require documented exceptions to written supervisory procedures with principal-level approval and periodic review. AI agent governance exceptions must follow the same supervisory framework
    ...
    - **Fed SR 26-2 (formerly Fed SR 11-7):** Model governance framework must include processes for temporary policy waivers, compensating controls, and management override. Exception registers demonstrate effective ongoing governance and risk monitoring
...
| [2.12 - Supervision and Oversight FINRA 3110, FINRA RN 24-09](../pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md) | FINRA supervisory exception processes apply to agent governance exceptions; principal approval required |
