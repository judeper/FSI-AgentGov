...
- **FINRA Rule 3110 (Supervision) and Regulatory Notice 25-07:** Supports supervisory review of generative AI outputs; FINRA's 2025 guidance applies existing supervision rules to AI on a technology-neutral basis and expects firms to monitor for hallucinations, bias, and accuracy issues in agent outputs
