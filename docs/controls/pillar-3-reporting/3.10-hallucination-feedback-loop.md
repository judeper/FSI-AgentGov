...
|----------|-------------|-----------------|
| **Explicit Fallbacks** | Configure "I don't know" responses for low-confidence queries | Prevents fabrication in compliance-sensitive contexts |
