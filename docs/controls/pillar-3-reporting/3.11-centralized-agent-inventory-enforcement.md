...
**Control ID:** 3.11
**Pillar:** Reporting
**Regulatory Reference:** FINRA 4511, SOX 404, OCC 2011-12, Fed SR 11-7
...
### AB-900 Admin Certification

Microsoft's AB-900 certification (Microsoft Certified: AI and Automation Fundamentals) includes governance concepts for agent inventory, lifecycle management, and policy enforcement. Organizations should encourage Power Platform Admins and AI Governance Leads to complete AB-900 training to build governance competency.
...
- [Microsoft Agent 365 Overview](https://learn.microsoft.com/en-us/copilot/microsoft-365/copilot-control-system/overview)
...
- [AB-900: Microsoft AI and Automation Fundamentals](https://learn.microsoft.com/en-us/credentials/certifications/power-platform-fundamentals/)
