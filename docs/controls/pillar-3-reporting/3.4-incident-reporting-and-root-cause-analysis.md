...
**Control ID:** 3.4<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** GLBA Section 501(b), SOX Section 404, FINRA Rule 4511, SEC Rule 17a-4, FFIEC IT Handbook, SEC Regulation S-P<br>
...
- **GLBA Section 501(b):** Requires incident response procedures for security events affecting customer NPI. Notification timelines vary by regulator, incident type, and entity obligations; map applicable requirements during incident workflow.
...
- **SEC Rule 17a-4:** Incident records must be preserved for 6+ years minimum
- **FINRA Rule 4511:** Material operational events must be documented in books and records
- **SOX Section 404:** Control failures require immediate escalation to audit committee
- **FFIEC IT Examination Handbook (Information Security):** Cybersecurity incidents should be assessed against applicable notification requirements to primary regulator
...
- [Microsoft Sentinel Incidents](https://learn.microsoft.com/en-us/azure/sentinel/investigate-cases)
...
- [Microsoft 365 Audit Log Search](https://learn.microsoft.com/en-us/purview/audit-log-search)
