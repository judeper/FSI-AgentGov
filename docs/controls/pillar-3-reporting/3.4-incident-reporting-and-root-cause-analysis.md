...
|---|---|
| NYDFS 23 NYCRR 500.17(a) — 72-hour cybersecurity event notification (covered entities) | As amended November 2023 (compliance phased through November 2025), covered entities must notify the NYDFS Superintendent... |
| NYDFS 23 NYCRR 500.17(c) — 24-hour ransom-payment notification | A separate 24-hour clock applies if the firm makes an extortion payment, with a written explanation due within 30 days. |
| SEC Form 8-K Item 1.05 — 4-business-day material cybersecurity incident disclosure (public-company FSIs) | Effective for most registrants since December 18, 2023 (June 15, 2024 for smaller reporting companies). |
| Federal banking 36-hour computer-security incident notification rule (12 CFR Parts 53 / 225 / 304, eff. April 1, 2022) | Banking organizations must notify their primary federal regulator (OCC, FDIC, or Federal Reserve) as soon as possible and no... |
| SEC Regulation S-P (2024 amendments, compliance December 3, 2025 for larger covered institutions; June 3, 2026 for smaller) | Requires a written incident response program and customer notification "as soon as practicable" but no later than 30 days after... |
| FINRA Rule 4530(a) — 30-day reporting of specified events | Includes certain written customer complaints (theft, misappropriation, forgery), regulatory actions, and findings of certain... |
| FINRA Rule 4530(d) — quarterly written customer complaint statistical report | Written customer complaints received in the prior calendar quarter must be reported by the 15th of the month following... |
| FINRA Notice 21-18 (Cybersecurity) and Regulatory Notice 24-09 (Generative AI / LLM Guidance) | Industry guidance reinforcing that AI-agent incidents are reportable when they involve customer NPI, books-and-records integrity,... |
| GLBA Safeguards Rule (FTC 16 CFR 314.4(j), eff. May 13, 2024) | Non-banking financial institutions in FTC jurisdiction must notify the FTC as soon as possible, and no later than 30 days, of a... |
| State breach-notification statutes (illustrative, not exhaustive) | New York GBL § 899-aa (and the SHIELD Act expansions), California CCPA/CPRA breach-notification rules, Massachusetts 201 CMR 17,... |
| CISA Cyber Incident Reporting for Critical Infrastructure Act (CIRCIA) | Final rulemaking pending as of the verification date. |
...
| SOX §§ 302 / 404 | A material AI-agent incident that affects ICFR is a potential material weakness; the audit-committee escalation path must be... |
| SEC Rules 17a-3 / 17a-4 and FINRA Rule 4511 | Incident records, RCAs, regulator correspondence, and customer notifications are records of the business and must be retained on... |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA Notice 21-18 (Cybersecurity) and Regulatory Notice 24-09 (Generative AI / LLM Guidance):** Industry guidance reinforcing that AI-agent incidents are reportable when they involve customer NPI, books-and-records integrity, or supervisory-system failure.
...
!!! tip "Automation Available"
    ...
    - [Compliance Dashboard](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/compliance-dashboard) — aggregated compliance reporting across the framework control catalog with zone-based filtering and exception tracking
...
| **Zone 3** (Enterprise) | Immediate response (15min); full RCA required; record-class retention per [Control 1.7](../pillar-1-security/1.7-comprehensive-audit-logging-and-compliance.md) (3 yr communications / 6 yr financial-governance / 5 yr CFTC; longer where rule requires) | Customer-facing, regulatory examination risk |
...
| [2.6 - Model Risk Management (OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7))](../pillar-2-management/2.6-model-risk-management-sr-26-2.md) | Material model-behavior incidents trigger MRM re-validation |
...
15. Annual incident-program self-assessment is reported to the Audit Committee under SOX 404.
