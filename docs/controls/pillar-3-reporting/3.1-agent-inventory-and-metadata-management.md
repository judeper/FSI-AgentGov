...
**Control ID:** 3.1<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA Rule 4511, SEC Rules 17a-3/17a-4, SOX Section 404, GLBA Section 501(b), NYDFS Part 500 §500.13<br>
...
Maintain a comprehensive inventory of all AI agents across the organization to support regulatory examination readiness and proper oversight, track ownership, and respond to regulatory examinations.

---

## Why This Matters for FSI

- **FINRA Rule 4511:** Requires maintaining books and records of all AI systems used in business operations
- **SEC Rules 17a-3/17a-4:** Mandates documentation of systems processing customer data with retention requirements
- **SOX Section 404:** Inventory of systems in financial reporting is essential for internal controls documentation
- **GLBA Section 501(b):** Tracking systems accessing customer information supports the Safeguards Rule
...
- [Microsoft Learn: Manage agents in Integrated Apps](https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-copilot-agents-integrated-apps)
