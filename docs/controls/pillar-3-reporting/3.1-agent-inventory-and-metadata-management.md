---
description: "Agent Inventory and Metadata Management: Maintain an authoritative inventory of all AI agents across the organization to support examination response, help…"
---
...
|---|---|
| FINRA Rule 4511 + SEC 17a-4(b)(4) | The agent inventory supports the firm’s books-and-records posture by providing a defensible register of AI assets, owners,... |
| FINRA RN 24-09 / Rule 3110 (June 2024) | Firms should be able to enumerate, supervise, and explain their use of generative AI tools; an incomplete inventory weakens that... |
| SOX Sections 302/404 | Any agent that influences finance, controllership, disclosure drafting, reconciliations, or ICFR workflows should appear in the... |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) / Fed SR 26-2 (formerly SR 11-7) | Higher-risk or finance-touching AI capabilities should be present in the model / use-case inventory and subject to ongoing... |
...
| NYDFS Part 500.16 / 500.17 | Covered entities should be able to enumerate relevant cyber assets and document ownership, classification, and response context... |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA RN 24-09 / Rule 3110 (June 2024):** Firms should be able to enumerate, supervise, and explain their use of generative AI tools; an incomplete inventory weakens that supervisory story.
...
!!! info "Power Platform Inventory (GA)"
    ...
    - **Deleted agent reflection** - Deletions propagate on the same automatic refresh cadence rather than a fixed 48-hour retention window. Power Platform inventory documents that created, updated, or **deleted** resources appear within about **15 minutes** ([Power Platform inventory](https://learn.microsoft.com/power-platform/admin/power-platform-inventory)), while Copilot Studio agent-inventory changes typically appear within about **20 minutes** ([Microsoft Copilot Studio Agent inventory](https://learn.microsoft.com/microsoft-copilot-studio/admin-agent-inventory), which Microsoft still labels preview documentation). Allow a short reconciliation lag — and confirm current per-surface behavior against Microsoft Learn — before treating a deleted agent as fully removed from a discovery surface.
