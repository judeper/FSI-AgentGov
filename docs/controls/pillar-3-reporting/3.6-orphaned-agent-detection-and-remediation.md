...
**Control ID:** 3.6<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA Rule 4511, SOX Section 404, GLBA Section 501(b), OCC 2011-12<br>
...
- **FINRA Rule 4511:** Unowned agents may generate records without proper supervision
- **SOX Section 404:** Orphaned agents bypass IT general controls for access and change management
- **GLBA Section 501(b):** Unmanaged agents accessing customer data can increase safeguards risk and should be governed through documented ownership and remediation
...
!!! info "GA (May 1, 2026)"
    The Ownerless Agents governance card on the Agent 365 Overview page is available at GA (May 1, 2026) with Agent 365 or Microsoft 365 E7 per-user licensing. Basic ownerless-agent filtering in the All Agents list is generally available without additional licensing.
...
| Zone | Ownerless Agents Card Review Frequency | Owner Assignment or Decommission SLA |
|---|---|---|
| Zone 1 | Monthly | 30 days to assign owner or initiate decommission |
| Zone 2 | Weekly | 14 days to assign owner or initiate decommission |
| Zone 3 | Daily | 7 days to assign owner or initiate decommission |
...
7. Ownerless Agents governance card is reviewed on the required zone-based cadence and evidence is retained with the review ticket
8. Owner assignment or decommission actions initiated from the governance workflow meet the zone-specific SLA
