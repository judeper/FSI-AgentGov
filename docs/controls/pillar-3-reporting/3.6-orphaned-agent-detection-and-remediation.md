...
!!! info "Frontier Preview"
    The Ownerless Agents governance card on the Agent 365 Overview page requires Frontier enrollment for the full hero-card experience. Basic ownerless-agent filtering in the All Agents list is generally available without Frontier enrollment.
