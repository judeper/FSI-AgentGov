...
- [Power Platform Admin Center Resources](https://learn.microsoft.com/power-platform/admin/admin-documentation)
- [Entra ID User Management](https://learn.microsoft.com/entra/identity/users/users-manage)
