...
**Control ID:** 3.5<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** SOX Section 404, GLBA Section 501(b), OCC 2011-12, FINRA Rule 4511<br>
...
Establish comprehensive cost visibility, allocation, and budget management for AI agent deployments. This control supports cost allocation to business units, budget enforcement, and cost optimization while providing audit evidence for IT expenditure governance.

---

## Why This Matters for FSI

- **SOX Section 404:** IT cost controls require documented allocation methodology and variance tracking
- **GLBA Section 501(b):** Safeguard costs must be allocated to protect customer information
- **OCC 2011-12:** Third-party technology costs require documented oversight and budget controls
- **FINRA Rule 4511:** Technology expenditures must be documented in books and records
...
!!! warning "Pricing Disclaimer"
    Pricing figures below are illustrative only. Verify current pricing at the [Microsoft pricing portal](https://www.microsoft.com/en-us/microsoft-365/business/copilot-for-microsoft-365) and [Power Platform licensing guide](https://learn.microsoft.com/en-us/power-platform/admin/pricing-billing-skus).
...
- [M365 Copilot Billing](https://learn.microsoft.com/en-us/microsoft-365/copilot/microsoft-365-copilot-overview)
