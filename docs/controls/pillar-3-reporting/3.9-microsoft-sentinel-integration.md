...
!!! info "Portal Transition Update (February 2026)"
    Microsoft extended the Sentinel Azure portal deprecation timeline per [Microsoft announcement](https://learn.microsoft.com/en-us/azure/sentinel/whats-new#march-2027-azure-portal-retirement-for-microsoft-sentinel). Sentinel will no longer be supported in the Azure portal after **March 31, 2027** (previously July 2026). Organizations should plan their transition to the Microsoft Defender portal accordingly.
