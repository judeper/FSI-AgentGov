...
**Control ID:** 3.9<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** OCC Heightened Standards, Fed SR 11-7, FINRA Rule 4370, SOX Section 404<br>
...
- **FINRA Rule 4370:** Business continuity requires security incident detection
- **SOX Section 404:** IT controls must include security monitoring
...
| **Defender CloudAppEvents** | SOC Analyst | Runtime threat detections, cloud app activity, alert correlation | Medium |
