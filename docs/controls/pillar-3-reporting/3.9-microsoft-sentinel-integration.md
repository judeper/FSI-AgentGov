---
description: "Microsoft Sentinel Integration: Integrate AI agent monitoring with Microsoft Sentinel SIEM/XDR capabilities for enterprise-grade security visibility…"
---
# Control 3.9: Microsoft Sentinel Integration

**Control ID:** 3.9<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA Rule 4511 (books and records), SEC Rules 17a-3 / 17a-4 (recordkeeping, WORM), NYDFS 23 NYCRR 500.06 (audit trail) / 500.16 (incident response plan) / 500.17 (notification), FFIEC IT Examination Handbook (Audit; Information Security), OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly Fed SR 11-7) (Model Risk Management — monitoring obligations on AI agents), CISA BOD 22-09 (event logging — informative benchmark for private-sector firms), FINRA RN 24-09 + Rule 3110, SOX 404<br>
**Last UI Verified:** June 2026<br>
...
|---|---|
| FINRA Rule 4511 / SEC 17a-3 / 17a-4 | Sentinel ingested data supports reconstruction of supervisory events and access anomalies, but the firm's immutable... |
| NYDFS 23 NYCRR 500.06 (audit trail) / 500.16 (incident response) / 500.17 (notification) | Sentinel analytics, Logic Apps playbooks, and workbook evidence help satisfy audit-trail, incident-response program, and 72-hour... |
| FFIEC IT Examination Handbook (Audit / Information Security) | Examiners expect centralized logging, timely detection, and documented response — Sentinel is a primary pattern for meeting those... |
| OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly Fed SR 11-7) (Model Risk Management) | Continuous monitoring of AI agents (anomalous prompts, data exfiltration, tool-use drift) supports the ongoing-monitoring... |
| FINRA RN 24-09 (Generative AI / LLM Guidance) | Applies existing supervisory and recordkeeping obligations to AI tools on a technology-neutral basis; centralized telemetry in... |
| CISA BOD 22-09 (event logging) | Informative benchmark — the Binding Operational Directive applies to federal civilian agencies, but its EL1–EL3 logging maturity... |
| SOX 404 | IT general controls for financial-reporting systems must include security monitoring with documented evidence of... |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly Fed SR 11-7) (Model Risk Management):** Continuous monitoring of AI agents (anomalous prompts, data exfiltration, tool-use drift) supports the ongoing-monitoring obligations in Fed SR 26-2 (formerly Fed SR 11-7) §VI — monitoring findings should feed MRM re-validation in Control 2.6.
    - **FINRA RN 24-09 (Generative AI / LLM Guidance):** Applies existing supervisory and recordkeeping obligations to AI tools on a technology-neutral basis; centralized telemetry in Sentinel is a primary surface for evidencing supervisory monitoring of AI agents.
...
!!! info "Integration Options (February 2026)"
    The **primary integration pattern** for ingesting agent-related telemetry into Sentinel is **connector-based ingestion into Log Analytics** using Microsoft 365, Entra, Defender, Power Platform, and optional Application Insights / custom telemetry — governed by KQL analytics rules, workbooks, and Logic Apps playbooks. **Sentinel MCP Server** (Preview as of September 2025 — verify current status against [Microsoft Sentinel — What's new](https://learn.microsoft.com/en-us/azure/sentinel/whats-new) at edit time) is an **optional analyst/SOC augmentation path** that enables natural-language queries over Sentinel data; it is not a foundational monitoring architecture and is not required.
    ...
    | **Microsoft Defender XDR** (formerly Microsoft 365 Defender) **/ Defender for Cloud Apps** (primary) | XDR alerts, AI-SPM detections, cloud app activity | `AlertInfo`, `DeviceEvents`, `CloudAppEvents` |
...
| **Defender XDR** | Microsoft Defender XDR | `DeviceEvents`, `AlertInfo` | XDR alerts including AI-SPM detections |
...
| Role | Responsibility |
|------|----------------|
| Microsoft Sentinel Contributor | Workspace deployment, connector configuration, analytics rule authoring, workbook deployment |
...
| Purview Compliance Admin / Purview Compliance Admin | Ensure Sentinel alerts and evidence align with Purview retention and eDiscovery holds; preserve books-and-records separately under 4511/17a-4 |
...
| CISO | Approve Zone 3 detection posture, retention schedule |
...
| [2.6 - Model Risk Management](../pillar-2-management/2.6-model-risk-management-sr-26-2.md) | Fed SR 26-2 (formerly Fed SR 11-7) ongoing monitoring — Sentinel findings feed MRM re-validation |
...
9. Quarterly evidence package signed by Microsoft Sentinel Contributor + AI Governance Lead + Compliance Officer
