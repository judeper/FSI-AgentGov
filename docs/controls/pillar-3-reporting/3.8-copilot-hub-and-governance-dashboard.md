---
description: "Copilot Hub and Governance Dashboard: Establish centralized governance of Microsoft 365 Copilot and Microsoft Copilot Studio agents through the unified…"
---
# Control 3.8: Copilot Hub and Governance Dashboard

**Control ID:** 3.8<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA 4511, FINRA RN 24-09, FINRA 3110, SEC 17a-3/4, GLBA 501(b), SOX 404<br>
...
!!! info "Feature Status (March 2026)"
    ...
    **Feature Status Tracking:**
    ...
    | Agent overview page / Agent analytics | Public preview | May 1, 2026 | Hero metrics and governance cards available with Agent 365 or M365 E7 per-user licensing |
    | Enhanced admin controls (environment or environment group) | Public preview | Jun 2026 | Adds policy validation and sharing/authentication governance signals |
...
|---|---|
| FINRA 4511 / FINRA RN 24-09 | Usage records support books and records requirements |
...
!!! tip "Automation Available"
    ...
    - [Agent Access Governance Monitor](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-access-monitor) — automated detection of overly permissive agent access configurations per governance zone
    - [Inactivity Timeout Enforcement](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/inactivity-timeout-enforcement) — daily compliance detection of inactivity timeout settings across Power Platform environments
    - [Unrestricted Agent Sharing Detector](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/unrestricted-agent-sharing-detector) — continuous detection of overly permissive agent sharing configurations with remediation and exception management
...
| Agent Access Control | All agents allowed | Organizational + Microsoft verified | Organizational only, approved list | FINRA 4511, FINRA RN 24-09: approved tools and systems only |
...
- Enable transcript logging with minimum 6-year retention for FINRA/SEC compliance (FINRA 4511 / SEC 17a-4 floor; firms may configure longer per internal records schedule)
...
|-----------|------------------|-------|---------------------------|
| FINRA 4511, FINRA RN 24-09 | **6 years minimum** (3 years readily accessible; firms may retain longer per internal records schedule) | All agent conversations involving customer interactions or recommendations | Export transcripts to immutable storage (e.g., Compliance Recording) |
| SEC 17a-3/4 | **6 years minimum** (varies by record class; 3 years readily accessible) | Communications related to securities transactions or advisory services | Transcript exports with tamper-evident audit trail |
| CFTC 1.31 | 5 years | Commodity futures/derivatives communications | Transcript retention with regulatory retrieval capability |
| SOX 404 | Align with IT records policy (typically 6–7 years per firm records schedule) | Agent configurations and system change records | Transcript metadata (who accessed, when, configuration state) |
...
- **Configure retention period:** Set minimum **6-year** retention for FSI environments to meet FINRA 4511 / SEC 17a-4 minimums; firms may configure longer per internal records schedule (consult qualified counsel for record-class-specific requirements)
...
|-------------|-------------------|-----------|-------------------------|
| **Transcript Accessed** | User ID, timestamp, transcript ID, access duration | 6 years minimum | SEC 17a-4: audit trail of record access (3 years readily accessible) |
| **Transcript Exported** | User ID, timestamp, export scope, destination | 6 years minimum | FINRA 4511, FINRA RN 24-09: evidence of records production (3 years readily accessible) |
...
2. Verify audit retention policy configured to meet regulatory minimum (6 years minimum for FINRA 4511 / SEC 17a-4; verify record-class-specific requirements with counsel and extend per internal records schedule if needed)
...
18. Transcript retention policy configured to meet regulatory minimum (6 years minimum for FINRA 4511 / SEC 17a-4; extend per internal records schedule)
19. Transcripts exported to immutable storage with tamper-evident audit trail
20. Purview Audit logging captures all transcript access events configured for regulatory minimum retention (6 years minimum)
