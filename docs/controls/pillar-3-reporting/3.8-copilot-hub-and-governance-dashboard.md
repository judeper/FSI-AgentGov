...
**Control ID:** 3.8<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA Rule 4511, SEC Rules 17a-3/17a-4, GLBA Section 501(b), SOX Section 404<br>
...
- **FINRA Rule 4511:** Usage records support books and records requirements
- **SEC Rules 17a-3/17a-4:** Agent activity documentation must be preserved
- **GLBA Section 501(b):** Access control for customer data requires centralized oversight
- **SOX Section 404:** IT controls for AI systems require documented governance
...
- **Block agent publishing connectors via DLP policies:** Apply Data Loss Prevention policies at the environment level to block connectors such as "Copilot Studio for Microsoft Teams" and "M365 Copilot channel" in environments where agent publishing should be restricted. This helps reduce the risk of unauthorized deployment of AI agents through unapproved channels. See [Control 1.5](../pillar-1-security/1.5-data-loss-prevention-dlp-and-sensitivity-labels.md) for DLP policy configuration details
