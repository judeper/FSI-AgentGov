...
|-----------|------------------|-------|---------------------------|
| FINRA 4511, FINRA RN 24-09 | 7 years (3 years readily accessible) | All agent conversations involving customer interactions or recommendations | Export transcripts to immutable storage (e.g., Compliance Recording) |
...
| **Transcript Exported** | User ID, timestamp, export scope, destination | 7 years | FINRA 4511, FINRA RN 24-09: evidence of records production |
