...
!!! info "Feature Status (March 2026)"
    ...
    **Feature Status Tracking:**
    ...
    | Agent overview page / Agent analytics | **Frontier preview** | May 1, 2026 | Hero metrics and governance cards currently require Frontier preview enrollment |
...
23. If Agent overview is enabled via Frontier preview, hero metric coverage gaps are documented for unsupported agent types
