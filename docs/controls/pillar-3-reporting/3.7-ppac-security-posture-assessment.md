...
| **Content Moderation** | Level set to High for Zone 2/3 agents | Copilot Studio > Agent > Settings > Generative AI | [1.8](../pillar-1-security/1.8-runtime-protection-and-external-threat-detection.md) | Weekly |
...
| [1.8 - Runtime Protection](../pillar-1-security/1.8-runtime-protection-and-external-threat-detection.md) | Content moderation posture |
