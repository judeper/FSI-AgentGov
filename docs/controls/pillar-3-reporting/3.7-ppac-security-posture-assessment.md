...
| **Session Expiration** | Custom session timeout enabled and set to ≤ 1440 minutes (Zone 3: ≤ 720 minutes) | PPAC > Environment > Settings > Privacy + Security | [2.22](../../controls/pillar-2-management/2.22-inactivity-timeout-enforcement.md), [3.7](#) | Monthly |
