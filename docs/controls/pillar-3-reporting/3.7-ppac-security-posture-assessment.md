...
| **Connected Agents** | Inter-agent connectivity disabled unless approved | Copilot Studio > Agent > Settings > Agents (verify Preview vs. GA tag at apply-time; some tenants surface this as 'Connected Agents' in the menu) | [1.18](../pillar-1-security/1.18-application-level-authorization-and-role-based-access-control-rbac.md) | Monthly |
