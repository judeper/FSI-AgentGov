...
The following conditions automatically generate security recommendations (based on [PPAC security recommendations documentation](https://learn.microsoft.com/en-us/power-platform/admin/security/overview)):
