...
- Enable Content Security Policy (CSP) enforcement for model-driven apps to prevent XSS attacks
...
| **Inactivity Timeout** | Inactivity timeout enabled and set to ≤ 120 minutes (Zone 3: ≤ 60 minutes) | PPAC > Environment > Settings > Privacy + Security | [2.22](../../controls/pillar-2-management/2.22-inactivity-timeout-enforcement.md), [3.7](#) | Monthly |
| **Session Expiration** | Custom session timeout enabled and set to ≤ 1440 minutes | PPAC > Environment > Settings > Privacy + Security | [3.7](#) | Monthly |
...
11. High-risk MIME types blocked per environment to prevent code injection attacks
