...
- **FINRA Rule 4511:** Requires books and records documentation for all agent activities and governance decisions
- **SEC Rules 17a-3/17a-4:** Customer interaction records must be preserved in accessible, retrievable format
- **SOX Sections 302/404:** Management certifications and internal control documentation require quarterly attestation
- **GLBA Section 501(b):** Safeguard effectiveness must be documented and reviewed annually
- **OCC Bulletin 2011-12:** Third-party oversight and vendor compliance requires documented reporting
