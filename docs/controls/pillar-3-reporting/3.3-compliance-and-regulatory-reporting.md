...
!!! tip "Automation Available"
    See [Compliance Dashboard](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/compliance-dashboard) in FSI-AgentGov-Solutions for aggregated compliance reporting across all 71 framework controls with zone-based filtering, trend analysis, and exception tracking.
