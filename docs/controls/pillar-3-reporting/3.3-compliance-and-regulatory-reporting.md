---
description: "Compliance and Regulatory Reporting: Establish a comprehensive framework for generating, distributing, and archiving compliance reports that demonstrate AI…"
search:
  boost: 2
---
...
**Control ID:** 3.3<br>
**Pillar:** Reporting<br>
**Regulatory Reference:** FINRA Rule 4511, FINRA RN 24-09 + Rule 3110, SEC 17a-3/4, SEC Regulation S-P (amended), SOX 302/404, GLBA 501(b), OCC Bulletin 2026-13 (formerly OCC 2011-12)<br>
...
|---|---|
| FINRA Rule 4511 | Books and records preservation requirements apply to AI agent activity logs and governance decisions; helps support records... |
| FINRA RN 24-09 / Rule 3110 | Establishes supervisory and recordkeeping expectations for AI-generated communications and outputs; firms should align... |
| SEC 17a-3/4 | Customer interaction records, including AI-generated communications, must be preserved in non-rewriteable, non-erasable (WORM)... |
| SEC Regulation S-P (amended May 2024) | Requires written incident response policies and customer notification within 30 days of unauthorized access; staggered compliance... |
| SOX 302/404 | Quarterly management certifications and annual internal control attestations require contemporaneous evidence of IT general... |
| GLBA 501(b) | Safeguard effectiveness must be documented and reviewed at least annually |
| OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7) | Model risk management programs require documented validation, monitoring, and reporting for AI/ML models used in regulated... |
...
??? note "Full regulatory context"
    ...
    - **FINRA RN 24-09 / Rule 3110:** Establishes supervisory and recordkeeping expectations for AI-generated communications and outputs; firms should align recordkeeping capability with these published expectations
...
Microsoft Compliance Manager includes **360+ regulatory framework templates** ([Microsoft Learn](https://learn.microsoft.com/purview/compliance-manager-regulations)) with four premium templates specifically for AI governance:
...
| **Transaction Processing** | Does the agent process or authorize financial transactions? | FINRA 4511, FINRA RN 24-09, SEC 17a-4, CFTC 1.31 |
...
[ ] Recordkeeping (FINRA 4511, FINRA RN 24-09, SEC 17a-4)
