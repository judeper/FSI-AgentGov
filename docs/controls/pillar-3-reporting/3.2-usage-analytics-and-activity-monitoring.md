...
### Agent 365 Observability (Preview)

> **Note:** The following resources are preview documentation and may change.

Agent 365 SDK introduces OpenTelemetry-based observability for Blueprint-registered agents:

- Structured telemetry for agent interactions
