...
!!! tip "Automation Available"
    ...
    - [Compliance Dashboard](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/compliance-dashboard) — aggregated compliance reporting across the framework control catalog with zone-based filtering
    - [Copilot Studio Analytics](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/copilot-studio-analytics) — business impact analytics covering session outcomes, CSAT, Agent Assisted Hours, and ROI tracking
...
| Purview Compliance Admin | Configure audit log retention policies (Standard / Premium), validate Copilot/PowerApps RecordType ingestion, and grant Purview Audit Reader access for evidence collection. |
