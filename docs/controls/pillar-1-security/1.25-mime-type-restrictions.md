...
- [Microsoft Learn: Copilot Studio — Allow file input from users](https://learn.microsoft.com/en-us/microsoft-copilot-studio/knowledge-file-input) — per-agent file input limits (PDF <40 pages, TXT/CSV <180 KB, images ≤15 MB)
...
- [Microsoft Learn: Defender for Cloud Apps — File policies](https://learn.microsoft.com/en-us/defender-cloud-apps/file-policy) — magic-byte / true MIME inspection for cloud-app uploads
