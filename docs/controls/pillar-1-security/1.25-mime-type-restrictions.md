...
**Control ID:** 1.25<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 4511, FINRA Rule 3110, SEC Rule 17a-4, GLBA Section 501(b), OCC 2011-12<br>
...
!!! tip "Automation Available"
    Companion automation is available via the [MIME Type Restrictions](../../reference/solutions-index.md#mime-type-restrictions) solution (v1.0.1) in FSI-AgentGov-Solutions, providing zone-based MIME type configuration with server-side validation.
