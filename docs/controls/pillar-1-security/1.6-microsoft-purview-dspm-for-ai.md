...
- **FINRA Rule 3110 / 25-07:** AI supervision and monitoring — Activity explorer tracks all agent interactions; FINRA 25-07 extends supervisory obligations to AI systems, requiring real-time output monitoring and audit trails
- **SEC Reg S-P (2024 amendments):** Incident response for AI-surfaced data exposure — DSPM sensitive interaction alerts support 30-day notification obligations under amended safeguard rules
...
- **OCC 2023-17:** Third-party AI risk management — DSPM extended insights monitoring of ChatGPT Enterprise, Gemini, and Entra-registered AI apps supports vendor oversight lifecycle requirements
...
| Unified DSPM Experience | Preview (May 2026 GA expected) | Consolidation of DSPM and DSPM for AI into single experience (see Enhanced DSPM AI Observability subsection below) | Check Message Center for latest rollout status |

!!! warning "Preview — GA Expected May 2026"
...
- Export Activity Explorer data to compliance archive for long-term retention and production readiness (native Activity Explorer supports ~30 days; use Audit Premium for extended retention up to 10 years)
- Maintain quarterly evidence packages for regulatory examinations: Activity Explorer exports, oversharing assessment summaries with remediation status, policy configuration screenshots, and agent inventory cross-referenced with DSPM monitoring scope
...
| AI Administrator | View DSPM for AI reports and AI-related compliance data (view-only role) |
