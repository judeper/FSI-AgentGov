...
!!! warning "Sovereign Cloud Availability (May 2026)"
    DSPM for AI sovereign cloud availability should be verified on the Microsoft 365 roadmap and the [Microsoft Purview DSPM for AI considerations](https://learn.microsoft.com/en-us/purview/dspm-for-ai-considerations) page per cloud (Commercial / GCC / GCC High / DoD / 21Vianet); do not commit to GA dates without a first-party Microsoft URL. The **new unified DSPM** reached GA in May 2026 for Commercial and GCC, while sovereign-cloud rollout timing remains a cloud-by-cloud verification item. Partner solutions for non-Microsoft data sources and the Data Security Posture Agent remain in preview, and **Insider Risk Management** dependencies (Adaptive Protection, the IRM-backed one-click templates) are not available in US Government clouds at parity — verify against your tenant's cloud before relying on those capabilities.
...
| Unified DSPM Experience | GA (May 2026, Commercial / GCC) | Consolidation of DSPM and DSPM for AI — see Enhanced DSPM AI Observability subsection below | Verify rollout against your tenant; partner solutions for non-Microsoft data sources remain in preview |

!!! info "Generally Available — May 2026"
    The new unified DSPM experience consolidates DSPM and DSPM for AI into a single Purview experience and reached general availability in May 2026 (Commercial / GCC) per MC1191257. Partner solutions for non-Microsoft data sources and the Data Security Posture Agent remain in preview. Sovereign-cloud availability has not been announced.
...
!!! info "Generally Available — May 2026 (Commercial / GCC)"
    The new unified DSPM experience consolidating DSPM and DSPM for AI reached general availability in May 2026 (Commercial / GCC) per MC1191257. Partner solutions for non-Microsoft data sources and the Data Security Posture Agent remain in preview; sovereign-cloud parity has not been announced. Verify current capabilities against Microsoft Learn (`data-security-posture-management-learn-about`) before adding to your evidence binder.
...
1. DSPM for AI is accessible at `https://purview.microsoft.com` (or `purview.microsoft.us` for GCC High/DoD) and the four Get Started steps show **completed** with the appropriate role group recorded for each step
