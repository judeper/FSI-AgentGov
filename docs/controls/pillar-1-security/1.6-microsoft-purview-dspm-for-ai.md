...
**Control ID:** 1.6<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 3110, SEC Examination Priorities (AI/ML), GLBA 501(b), SOX Section 302, OCC Bulletin 2011-12<br>
...
- **SEC Examination Priorities (AI/ML):** Transparency in AI-assisted decisions — Reports show sensitive interactions
- **GLBA 501(b):** Protection of customer information — Oversharing assessments identify exposure
- **SOX Section 302:** Internal controls over AI systems — Policy enforcement and audit trail
- **OCC Bulletin 2011-12:** Model risk management — Data risk assessments for AI data exposure
...
| Purview Data Security AI Admin | DSPM for AI policy configuration, data security settings, and AI risk management |
| Entra Security Admin | View reports and policies; Defender XDR integration with DSPM for AI observability data |
| Purview Insider Risk Management Admin | IRM integration and risk monitoring |
...
- [Microsoft Learn: Agent Deployment Checklist (Preview)](https://learn.microsoft.com/en-us/microsoft-365/copilot/agent-essentials/m365-agents-checklist) - Category 7 data security requirements align with DSPM policies
