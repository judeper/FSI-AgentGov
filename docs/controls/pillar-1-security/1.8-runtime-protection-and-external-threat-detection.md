...
!!! info "Prompt Injection Detection Locations"
    UPIA (User Prompt Injection Attack) and Cross-Prompt Injection Attack (XPIA) detections are available in **both** locations *(Microsoft Learn also refers to XPIA as a cross-domain prompt injection attack.)*:
