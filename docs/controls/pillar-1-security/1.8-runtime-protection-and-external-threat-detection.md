...
!!! success "Generally Available - February 2026"
    Native Microsoft Defender integration for Copilot Studio agents provides comprehensive security capabilities through Defender for Cloud Apps, including agent discovery, activity logging, and real-time runtime protection.
...
4. **SLA Requirements** - Webhook must respond within 5 seconds to avoid timeout
...
- [Microsoft Learn: Additional Threat Detection Configuration](https://learn.microsoft.com/en-us/power-platform/admin/threat-detection-additional)
- [Microsoft Learn: Defender for Cloud Apps - Copilot Studio AI Agents](https://learn.microsoft.com/en-us/defender-cloud-apps/protect-copilot-studio)
