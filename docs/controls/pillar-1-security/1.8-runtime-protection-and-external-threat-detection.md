...
**Control ID:** 1.8<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 3110, SEC Regulation SCI, GLBA 501(b), OCC 2011-12<br>
...
- **SEC Regulation SCI:** Apply system integrity and security controls where AI-driven services support regulated operations
...
- **FFIEC Information Security Booklet:** Apply layered cybersecurity monitoring and incident response controls to AI-enabled services
...
| **NYDFS 23 NYCRR 500** | Threat detection capabilities for AI-enabled attack patterns |
...
### AI-Enabled Threat Patterns (NYDFS 23 NYCRR 500)
...
| SOC Analyst | Monitor alerts and investigate threats |
