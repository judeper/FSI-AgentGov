---
description: "Restrict Agent Publishing by Authorization: Restrict who can publish AI agents to production environments by implementing security group-based authorization…"
---
...
??? note "Regulatory mapping — click to expand"
    ...
    - **OCC Bulletin 2026-13 (formerly OCC 2011-12) and Fed SR 26-2 (formerly SR 11-7) — Model Risk Management:** These instruments **expressly exclude generative and agentic AI** from scope ("not within the scope of this guidance"). Controlled deployment, validation, and inventory of genAI agents reflect **analogous sound risk-management principles** rather than direct SR 26-2 / OCC obligations. See the [OCC Bulletin 2026-13 / Fed SR 26-2 scope caveat in Regulatory Mappings](../../reference/regulatory-mappings.md#occ-bulletin-2026-13-fed-sr-26-2-model-risk-management).
...
!!! tip "Automation Available"
    ...
    - [Cross-Tenant External Sharing Governance](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/cross-tenant-external-sharing-governance) — automated detection, validation, and remediation of cross-tenant access for Power Platform AI agents
    - [Unrestricted Agent Sharing Detector](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/unrestricted-agent-sharing-detector) — continuous detection of overly permissive agent sharing configurations with automated remediation and exception management
...
!!! warning "Prerequisites & Licensing"
    ...
    | **Microsoft Purview Audit (Premium)** + **custom retention policy** | Required for >180-day retention. Premium alone gives 1 year by default; retention beyond 1 year requires an explicit Audit Retention Policy | Purview portal > Audit > Audit retention policies |
    | **AI Administrator** role (added Mar 2025, MC1041454) | Preferred least-privilege role for agent governance — use instead of Entra Global Admin | Entra > Roles & administrators |
