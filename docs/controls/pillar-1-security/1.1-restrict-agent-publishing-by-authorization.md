...
**Control ID:** 1.1<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 4511, SEC Rule 17a-4, GLBA 501(b), SOX 302<br>
...
- **FINRA Rule 4511:** Requires records of authorized activities — only authorized makers should publish, with all publishing logged
- **SEC Rule 17a-4:** Publishing events must be captured in audit logs for examination
- **GLBA 501(b):** Restricting who can create agents helps protect customer data by limiting access to authorized personnel
- **SOX 302:** Publishing restrictions support segregation of duties requirements

---

!!! info "Companion Solution Status"
    No dedicated solution package is available in FSI-AgentGov-Solutions for this control. However, governance scripts and advanced implementations listed in the Implementation Playbooks section below provide automation coverage. See the [Solutions Index](../../framework/solutions-integration.md) for the full solution catalog.
...
- **Restrict agent sharing scope:** In Copilot Studio, configure agent sharing via the top menu bar **"…" > Share** to restrict access to designated Copilot Readers or Security Groups. Do not allow unrestricted access ("Anyone" or "Any multi-tenant") for agents handling non-public data
...
- [Microsoft Learn: Agent Deployment Checklist (Preview)](https://learn.microsoft.com/en-us/microsoft-365/copilot/agent-essentials/m365-agents-checklist) - Microsoft's 8-category deployment readiness checklist including access and availability policies
- [Microsoft Learn: Agent Visual Governance Guide (Preview)](https://learn.microsoft.com/en-us/microsoft-365/copilot/agent-essentials/m365-agents-visual-map) - Visual map of agent governance decision points
