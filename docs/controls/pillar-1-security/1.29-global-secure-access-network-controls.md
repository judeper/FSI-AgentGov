...
**Control ID:** 1.29<br>
**Pillar:** Security<br>
**Regulatory Reference:** GLBA Section 501(b), FINRA Rule 4511, OCC 2011-12, SOX Sections 302/404<br>
...
- **Malicious infrastructure access**: Agents connecting to known command-and-control (C2) infrastructure through misconfigured connectors or malicious MCP servers can be weaponized as internal beachheads. Threat intelligence filtering helps mitigate this vector.
...
- [ ] Microsoft Entra admin center access (Entra Global Admin or Entra Security Admin role)
...
*Updated: March 2026 | Version: v1.3 | UI Verification Status: Needs Review*
