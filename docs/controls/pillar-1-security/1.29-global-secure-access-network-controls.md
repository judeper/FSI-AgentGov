...
**Control ID:** 1.29
**Pillar:** Security
**Regulatory Reference:** GLBA 501(b) (safeguards rule — secure systems), FINRA 4511 (books and records — system security), OCC 2011-12 (technology risk management), SOX 302/404 (internal controls over financial reporting)
...
- [ ] Microsoft Entra admin center access (Global Administrator or Security Administrator role)
...
|---|---|
| **Power Platform Administrator** | Enable GSA forwarding toggle per environment in Power Platform admin center; coordinate environment classification with Security team; document GSA configuration state per change management procedure |
| **Security Administrator (Entra)** | Create and maintain web content filtering policies, threat intelligence policy, and network file filtering policy in Entra admin center; link policies to GSA baseline profile; own policy content and category selections |
...
- [Microsoft Learn: Global Secure Access for agents in Copilot Studio (Preview)](https://learn.microsoft.com/en-us/microsoft-copilot-studio/security-global-secure-access)
...
- [Microsoft Learn: Network file filtering in Global Secure Access](https://learn.microsoft.com/en-us/entra/global-secure-access/how-to-configure-network-file-filtering)
- [Microsoft Learn: Global Secure Access traffic logs](https://learn.microsoft.com/en-us/entra/global-secure-access/concept-traffic-logs)
- [GLBA Safeguards Rule — FTC 16 CFR Part 314](https://www.ftc.gov/legal-library/browse/rules/safeguards-rule)
- [FINRA Rule 4511 — General Requirements](https://www.finra.org/rules-guidance/rulebook/finra-rules/4511)
...
*Updated: March 2026 | Version: v1.3 | UI Verification Status: Partial*
