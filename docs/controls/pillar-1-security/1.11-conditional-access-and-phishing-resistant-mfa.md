...
**Control ID:** 1.11<br>
**Pillar:** Security<br>
**Regulatory Reference:** GLBA 501(b) and FTC Safeguards Rule 16 CFR §314.4(c)(5) (MFA mandate, in force June 2023), SEC Regulation S-P (May 2024 amendments — incident response & customer notification), FINRA 4511, FINRA 25-07, SEC 17a-3/4, SOX 302, NYDFS 23 NYCRR 500 §500.12 (Second Amendment; universal MFA fully effective Nov 1, 2025), NIST SP 800-63B AAL3, FFIEC Authentication and Access to Financial Institution Services and Systems (Aug 2021), CISA Zero Trust Maturity Model v2.0 (Identity pillar)<br>
...
- **FINRA 4511 / 25-07:** Access control and audit trails for records; FINRA Regulatory Notice 25-07 (March 2025) extends supervisory obligations to AI workflows. FINRA retired SMS/voice MFA for Gateway access (July 2025), signaling direction on acceptable MFA methods for member firms.
...
| **Authentication Policy Administrator** | Tenant Authentication Methods policy (which authenticators are enabled and for whom); FIDO2 / passkey / CBA tenant configuration |
...
6. Token Protection pilot CA policy is in `Report-only` for Zone 3 maker / admin populations, with coverage gaps tracked.
...
10. **Workload Identities Premium** licensing covers every service principal, managed identity, and agent identity in scope; CA WID policies are enforcing (not just authored) — confirmed via a synthetic SP sign-in.
