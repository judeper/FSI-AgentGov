...
- **FINRA 4511 / 25-07 / Notice 21-18:** Access control and audit trails for records; FINRA Regulatory Notice 21-18 reinforces that member firms should consider MFA, access management, and continuous monitoring as part of reasonable cybersecurity controls; FINRA RN 25-07 (March 2025) is a workplace modernization RFC that touches on AI workflows and is cited here as contextual industry consultation only. FINRA retired SMS/voice MFA for Gateway access (July 2025), signaling direction on acceptable MFA methods for member firms.
