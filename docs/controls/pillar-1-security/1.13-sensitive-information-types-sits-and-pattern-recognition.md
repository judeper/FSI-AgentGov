...
**Control ID:** 1.13<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 4511, SEC Reg S-P, GLBA 501(b), SOX Section 404, PCI-DSS<br>
...
- **FINRA Rule 4511:** Classifies records containing customer information for retention
- **PCI-DSS:** Detects credit card numbers in scope systems
- **SOX Section 404:** Identifies financial reporting data for integrity controls
...
- [Microsoft Learn: Exact Data Match](https://learn.microsoft.com/en-us/purview/sit-create-edm-sit-unified-ux-schema-rule-package)
