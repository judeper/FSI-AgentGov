...
**Control ID:** 1.27<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 3110, FINRA Regulatory Notice 25-07, SEC Rules 17a-3/17a-4, GLBA Section 501(b)<br>
...
- **FINRA Rule 3110 / Regulatory Notice 25-07:** Content moderation helps meet supervisory obligations by filtering harmful outputs and inappropriate communications that could create regulatory exposure or customer harm
- **SEC Rules 17a-3/17a-4:** Retaining moderation settings, approvals, and review evidence helps support books-and-records obligations for AI-enabled communications
- **GLBA Section 501(b):** Content moderation aids in meeting information safeguards requirements by blocking outputs that could inadvertently expose customer data or violate privacy protections
...
| SOC Analyst | Monitor moderation alerts and trends; investigate anomalous moderation bypass attempts; triage and escalate confirmed incidents involving harmful outputs |
