...
**Control ID:** 1.26<br>
**Pillar:** Security<br>
**Regulatory Reference:** GLBA 501(b), FINRA 4511/3110, FINRA 25-07, OCC 2011-12, SEC 17a-4(f), Fed SR 11-7, CFTC 1.31, NIST AI RMF (GOVERN/MAP/MEASURE/MANAGE)<br>
...
- **OCC 2011-12 / Fed SR 11-7:** Per-agent file upload governance supports model risk management by helping ensure that data ingested by AI models is bounded, attributable, and reviewable; uncontrolled file ingestion can introduce unvetted training/grounding data that bypasses model validation
...
- [Federal Reserve SR 11-7: Guidance on Model Risk Management](https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm)
