...
**Control ID:** 1.2<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 4511, SEC Rules 17a-3/17a-4, OCC 2011-12, Fed SR 11-7<br>
...
- **FINRA Rule 4511(a):** Requires books and records for all electronic systems including AI agents
- **SEC Rules 17a-3/17a-4:** Record-keeping requirements for broker-dealers extend to AI systems
...
!!! warning "Preview Cmdlets"
    The following cmdlets are part of the Agent 365 Admin PowerShell module (preview). Verify availability and cmdlet names before use in production environments.
...
!!! note "Researcher and Analyst governance exception"
    Microsoft 365 Copilot's **Researcher** and **Analyst** first-party agents are classified as **Microsoft agents** in the registry. They are part of the core Copilot Chat experience and are **not** governed by the standard agent-related settings in the admin center. They cannot be blocked, removed, or managed through ordinary agent governance controls. Governance of these agents is handled through the Copilot control system. Document this exception in the agent inventory for examiner awareness. See **Control 2.24** for the feature-governance exception and **Control 2.25** for Researcher with Computer Use administration.
...
**Shadow agents** are agents discovered in the tenant inventory that do **not** have a Microsoft Entra Agent ID. Because they lack a registered Entra identity, shadow agents bypass identity-based governance controls including Conditional Access policies, Identity Protection monitoring, and lifecycle management workflows.
...
|---------|--------------|
| [1.1 - Restrict Agent Publishing](1.1-restrict-agent-publishing-by-authorization.md) | Publishing restrictions support registry compliance |
