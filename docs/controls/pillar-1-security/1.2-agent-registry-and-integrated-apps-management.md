...
**Control ID:** 1.2<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA 4511, FINRA 3110, SEC 17a-3/4, OCC 2011-12, Fed SR 11-7<br>
...
- **FINRA 3110 / 25-07:** Agent registry provides the foundational inventory required for supervisory systems to be reasonably designed to oversee AI agent activities; FINRA 25-07 extends supervisory obligations to AI agent workflows
- **FINRA 24-09:** Confirms existing books-and-records and supervisory obligations apply to all AI and generative AI systems without carve-outs; firms must inventory and govern AI tools
- **SEC 17a-3/4 (as amended 2023):** Record-keeping requirements for broker-dealers extend to AI systems; 2023 amendments allow audit-trail alternative to WORM format and require electronic records to be searchable and promptly producible to regulators
- **OCC 2011-12:** Model inventory mandate for AI/ML systems in banks
- **OCC 2023-17:** Requires banks to maintain inventories of all third-party relationships, including AI agent vendors, with lifecycle risk management from planning through termination
- **Fed SR 11-7:** Comprehensive inventory of models with risk ratings
- **NIST SP 800-53 CM-8 / NIST AI RMF GOVERN:** Information system component inventory with automated discovery and detection of unauthorized components; AI governance structures require maintaining up-to-date AI system inventories
...
!!! info "Generally Available (May 2026)"
    Agent 365 unified registry is generally available as of May 1, 2026. Agent 365 is licensed per user ($15/user/month standalone, or included in Microsoft 365 E7). Agents acting on behalf of licensed users are fully covered. Fully autonomous agent identities (non-OBO flows) remain in preview.

The current implementation of Control 1.2 uses a combination of platform-specific inventories (Power Platform environments, Copilot Studio, SharePoint) and custom SharePoint lists for centralized tracking. **Agent 365 unified registry** consolidates all agent types into a single governance view:
...
| **Zone 3** (Enterprise) | Real-time inventory; full audit trail; AI Governance Committee approval; 7–10 year retention (exceeds SEC 17a-4(a) six-year minimum); registry records incorporated into e-discovery and litigation hold framework | Customer-facing, regulatory examination risk |
...
| [2.25 - Agent 365 Governance Console](../pillar-2-management/2.25-agent-365-admin-center-governance-console.md) | Admin center governance workflows for agent lifecycle; operational interface for the registry data documented in this control |
| [3.13 - Agent 365 Analytics and Reporting](../pillar-3-reporting/3.13-agent-365-admin-center-analytics.md) | Analytics and trend reporting built on agent registry export data; reporting layer for the inventory data produced by this control |
...
### Agent Identity & Blueprint Registration

!!! info "GA Notice"
    Microsoft Agent 365 reached general availability on May 1, 2026. Blueprint registration via the a365 CLI is part of the GA release. Some advanced SDK capabilities may still evolve — verify feature availability in current documentation before implementing production controls.

- [Microsoft Learn: Agent 365 Blueprint Registration](https://learn.microsoft.com/en-us/microsoft-agent-365/developer/registration) - Formal agent registration process for enterprise governance
