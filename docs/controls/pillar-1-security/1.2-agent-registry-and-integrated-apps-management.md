...
- [Microsoft Copilot Agent Kit (formerly Copilot Studio Kit) — aka.ms/copilotstudiokit](https://aka.ms/copilotstudiokit) — Power CAT-maintained toolkit with Agent Inventory, Compliance Hub, Agent Review, analytics, testing, and maker-productivity components. It supplements built-in Copilot Studio, Power Platform admin center, and Agent 365 surfaces; it is not an Agent 365 component or an in-product compliance control. Verify component supportability before treating Kit output as primary governance evidence.
