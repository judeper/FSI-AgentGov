...
- [Microsoft Copilot Studio Kit — aka.ms/copilotstudiokit](https://aka.ms/copilotstudiokit) — community-maintained accelerator (PCF, governance dashboards, Compliance Hub, Agent Inventory, Agent Review tooling) that supplements built-in Copilot Studio admin surfaces. Treat as a supporting toolkit, not an in-product compliance feature; verify supportability before treating Kit dashboards as primary evidence.
