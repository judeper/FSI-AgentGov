---
description: "Agent Registry and Integrated Apps Management: Establish a governed registration and ownership model for AI agents, integrated apps, service principals…"
---
# Control 1.2: Agent Registry and Integrated Apps Management

**Control ID:** 1.2<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 4511, FINRA RN 24-09 + Rule 3110, SEC Rule 17a-4(b)(4) / 17a-4(g), SOX Sections 302 / 404, GLBA 501(b), NYDFS 23 NYCRR 500.07 / 500.16 / 500.17, OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12), Fed SR 26-2 (formerly SR 11-7), NIST AI RMF 1.0 GOVERN 1.4 / 1.6, FTC Safeguards Rule 16 CFR §314.4(c)<br>
...
!!! tip "Agent 365 Architecture Update"
    **Microsoft Agent 365 / Agent 365 admin surfaces remain rollout- and preview-dependent as of May 2026.** Use them as an additional governance surface where available, but continue to reconcile Entra app objects, Integrated Apps, Microsoft Copilot Studio, and the authoritative inventory in [Control 3.1](../pillar-3-reporting/3.1-agent-inventory-and-metadata-management.md) until tenant parity is verified.
...
|---|---|
| FINRA Rule 4511 + SEC Rule 17a-4(b)(4) / 17a-4(g) | A governed agent/app registry supports compliance with books-and-records obligations by preserving approval, ownership, consent,... |
| FINRA RN 24-09 / Rule 3110 | As firms modernize workplace tooling and retain AI-generated business records, they should be able to identify the registered app... |
| SOX Sections 302 / 404 | Finance-touching agents should have named ownership, controlled permissions, and documented approval evidence to support... |
| GLBA 501(b) + FTC Safeguards Rule 16 CFR §314.4(c) | App inventory, least-privilege consent, and sponsor accountability help protect customer information and support periodic risk... |
| NYDFS 23 NYCRR 500.07 / 500.16 / 500.17 | Controlled registration aids privilege management, incident investigation, and breach-response readiness for AI-connected... |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) + Fed SR 26-2 (formerly SR 11-7) + NIST AI RMF GOVERN 1.4 / 1.6 | Higher-risk AI capabilities should be cataloged, attributable, reviewable, and subject to ongoing governance. |
...
??? note "Regulatory mapping — click to expand"
    ...
    - **FINRA RN 24-09 / Rule 3110:** As firms modernize workplace tooling and retain AI-generated business records, they should be able to identify the registered app or agent, its sponsor, and its approval trail.
...
!!! tip "Automation Available"
    ...
    - [Agent Intake](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-intake) — **Preview.** Pre-build intake workflow that captures the business case, classifies risk, and routes sponsor approval ahead of registration
    - [Agent Registry Automation](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/agent-registry-automation) — automated discovery, registration, approval, and lifecycle governance of AI agents across Power Platform
    - [Model Risk Management Automation](https://github.com/judeper/FSI-AgentGov-Solutions/tree/main/model-risk-management-automation) — model inventory submission, risk scoring, and independent validation workflows for registered agents
...
!!! warning "Preview / rollout note (May 2026)"
...
| **Zone 3** (Enterprise) | Capture the full Zone 2 set **plus** appId / objectId / servicePrincipalId, auth mode (managed identity / certificate / secret), credential expiry, Conditional Access or compensating-control reference, sign-in audit evidence, DfCA discovery status, and sponsor attestation history. Review daily or via automation. | Customer-, finance-, or regulator-facing agents require examiner-ready traceability and rapid investigation support. |
...
!!! note "May 2026 validation reminder"
...
- [Microsoft Learn: Manage Integrated Apps in Microsoft 365 admin center](https://learn.microsoft.com/en-us/microsoft-365/admin/manage/manage-addins-in-the-admin-center?view=o365-worldwide)
- [Microsoft Learn: Copilot Studio administration overview](https://learn.microsoft.com/en-us/microsoft-copilot-studio/environments-first-run-experience)
- [Microsoft Learn: Microsoft Graph application resource type](https://learn.microsoft.com/en-us/graph/api/resources/application?view=graph-rest-1.0)
- [Microsoft Copilot Agent Kit (formerly Copilot Studio Kit) — aka.ms/copilotstudiokit](https://aka.ms/copilotstudiokit) — Power CAT-maintained toolkit with Agent Inventory, Compliance Hub, Agent Review, analytics, testing, and maker-productivity components. It is separate from Agent 365 and can complement governance processes that also use built-in Copilot Studio and Power Platform admin center surfaces; it is not an in-product compliance control. Microsoft Support covers the underlying platform capabilities, while accelerator-specific issues are handled through the Kit's GitHub repository. Treat Kit output as supporting, not primary, governance evidence.
