...
- **BlueprintRegistration** - Agent registered via Blueprint process
- **BlueprintPromotion** - Agent promoted between lifecycle phases
- **AgentIdentityCreated** - New Agent ID created in Entra
