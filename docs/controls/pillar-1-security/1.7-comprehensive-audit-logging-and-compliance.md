...
**Control ID:** 1.7<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA 4511, FINRA 3110, FINRA 25-07, SEC 17a-3/4, SOX 302/404, GLBA 501(b), OCC 2011-12, CFTC 1.31<br>
...
- **CFTC 1.31:** Requires 5-year retention of regulatory records (including AI-generated communications) for FCMs, swap dealers, and CPOs in tamper-evident format with complete metadata
...
| `ModelTransparencyDetails` | Model information (name, version, provider) | Model risk management (OCC 2011-12 / Fed SR 11-7) |
