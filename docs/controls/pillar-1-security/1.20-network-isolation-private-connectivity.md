...
**Control ID:** 1.20<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA Rule 3110, SEC Rule 17a-4, GLBA Section 501(b), OCC 2011-12<br>
...
Implement network-level access controls for Copilot Studio environments including IP firewall restrictions, Virtual Network (VNet) support, and Private Endpoints to help ensure agent-to-data-source communication remains within trusted network boundaries.

---

## Why This Matters for FSI

- **FINRA Rule 3110:** Network isolation restricts agents from reaching unapproved systems, supporting supervision
- **SEC Rule 17a-4:** Private networks help prevent unauthorized external access to agent data and logs
- **GLBA Section 501(b):** Network boundaries provide defense-in-depth for customer information protection
...
!!! info "Step-by-Step Implementation"
    ...
    - [PowerShell Setup](../../playbooks/control-implementations/1.20/powershell-setup.md) — Automation scripts
