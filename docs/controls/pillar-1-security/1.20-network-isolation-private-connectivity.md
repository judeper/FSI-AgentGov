...
**Control ID:** 1.20<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA 3110, FINRA 25-07, SEC 17a-4, GLBA 501(b), OCC 2011-12, NIST SP 800-53 SC-7<br>
...
- **FINRA 3110 / 25-07:** Network isolation restricts agents from reaching unapproved systems, enabling supervision; FINRA 25-07 mandates AI-specific cybersecurity controls and prevents unauthorized lateral movement by AI agents
...
- **NIST SP 800-53 SC-7:** Network isolation implements boundary protection with IP firewall, VNet segmentation, and private endpoints controlling all data flows at system boundaries
