...
| [1.23 - Step-Up Authentication](1.23-step-up-authentication-for-agent-operations.md) | Conditional Access policies targeting Entra Agent ID identities are generally available as of April 2026 ([Entra Agent ID — What's new](https://learn.microsoft.com/en-us/entra/agent-id/whats-new-agent-id)) — enables CA policies scoped to agent identities for agent-specific RBAC enforcement |
...
> **Note:** Entra Agent ID reached general availability in April 2026. Conditional Access policies targeting Entra Agent ID identities are also generally available as of April 2026 ([Entra Agent ID — What's new](https://learn.microsoft.com/en-us/entra/agent-id/whats-new-agent-id)). Verify per-tenant rollout before relying on specific Agent ID features.
