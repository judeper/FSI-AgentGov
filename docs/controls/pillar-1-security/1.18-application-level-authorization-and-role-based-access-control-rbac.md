...
- **Restrict inter-agent connectivity:** In Copilot Studio > Agent > Settings, under Agents (verify Preview vs. GA tag at apply-time; some tenants surface this as 'Connected Agents' in the menu), disable "Let other agents connect to and use this one" by default. Enable only with documented approval and business justification
