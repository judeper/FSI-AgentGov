...
**Control ID:** 1.21<br>
**Pillar:** Security<br>
**Regulatory Reference:** NIST CSF 2.0 DE.CM/DE.AE, GLBA 501(b), FINRA 4511, FINRA 25-07, OCC 2011-12, NIST SP 800-53 SI-4/AU-6<br>
...
- **NIST CSF 2.0 DE.CM/DE.AE:** AI-specific threat detection under continuous monitoring and adverse event analysis (replaces retired FFIEC CAT, sunset August 2025)
- **GLBA 501(b):** Administrative safeguards through security event detection and logging
- **FINRA 4511 / 25-07:** Preserves evidence of attack attempts in books and records; FINRA 25-07 requires real-time monitoring of AI agent outputs and comprehensive audit trails for adversarial events
- **OCC 2011-12 / Fed SR 11-7:** Addresses manipulation attempts on AI models for model risk management
- **NIST SP 800-53 SI-4/AU-6:** System monitoring and audit review, analysis, and reporting for adversarial input detection
- **NIST AI RMF 600-1:** Requires continuous adversarial monitoring, tamper-resistant logging, and regular red-teaming of generative AI systems
...
| [1.24 - Defender for AI Services](1.24-defender-ai-security-posture-management.md) | GA threat protection for AI workloads — detects adversarial prompt attacks, credential theft, and data exfiltration targeting Azure OpenAI and other AI services |
