...
**Control ID:** 1.21<br>
**Pillar:** Security<br>
**Regulatory Reference:** FFIEC CAT, GLBA Section 501(b), FINRA Rule 4511, OCC 2011-12<br>
...
- **FFIEC CAT:** Provides AI-specific threat detection for cybersecurity assessment
- **GLBA Section 501(b):** Administrative safeguards through security event detection and logging
- **FINRA Rule 4511:** Supports preservation of attack evidence in books and records
...
| SOC Analyst | Respond to alerts, investigate detected attacks |
...
| [1.24 - Defender AI Security Posture Management](1.24-defender-ai-security-posture-management.md) | GA threat protection for AI workloads — detects adversarial prompt attacks, credential theft, and data exfiltration targeting Azure OpenAI and other AI services |
