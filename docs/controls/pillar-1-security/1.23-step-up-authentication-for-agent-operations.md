...
**Control ID:** 1.23<br>
**Pillar:** Security<br>
**Regulatory Reference:** GLBA 501(b), FINRA 4511, FINRA 4530, FINRA 25-07, SOX 302/404, NIST SP 800-63B, NIST SP 800-53 IA-2, NYDFS 23 NYCRR 500.12<br>
...
| [1.18 - RBAC](1.18-application-level-authorization-and-role-based-access-control-rbac.md) | Entra Agent ID (Public Preview) enables Conditional Access for agent identities with agent-specific risk signals; role-based access complements step-up |
