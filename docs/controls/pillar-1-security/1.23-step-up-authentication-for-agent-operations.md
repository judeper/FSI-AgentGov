...
| [2.22 - Inactivity Timeout Enforcement](../pillar-2-management/2.22-inactivity-timeout-enforcement.md) | Governs inactivity timeout duration (BAP Admin API); complementary to step-up authentication session controls |
