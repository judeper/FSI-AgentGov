...
**Control ID:** 1.23<br>
**Pillar:** Security<br>
**Regulatory Reference:** GLBA Section 501(b), FINRA Rule 4511, SOX Section 302/404, NIST SP 800-63B<br>
...
- **GLBA Section 501(b):** Supports verification of user identity before sensitive data access
- **FINRA Rule 4511:** Supports authorized access to financial records at transaction time
- **SOX Section 302/404:** Supports transaction-level authentication controls for internal control
- **NIST SP 800-63B:** Supports AAL2/AAL3 authentication strength for sensitive operations
...
| **DSPM Policy Changes** | Activate Purview Data Security AI Admin | c4 (Config Change) | PIM + 15-min fresh auth |
