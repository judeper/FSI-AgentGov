...
**Control ID:** 1.28
**Pillar:** Security
**Regulatory Reference:** SOX 302/404, FINRA 3110, OCC 2011-12, Fed SR 11-7
...
- **SOX 302/404:** Publishing restrictions help meet internal control requirements by enforcing documented change management and preventing unauthorized deployment of agents that could impact financial reporting or disclosure controls
...
Policy-based agent publishing restrictions provide a multi-layered enforcement model that prevents Copilot Studio agents from being published when governance, security, or compliance conditions are not met. This control operates at three enforcement layers that escalate by governance zone:
...
|------|-------------|-----------|
| **Zone 1** (Personal) | DLP policies enforced; security scan warnings displayed; publishing allowed after acknowledgment; quarterly publishing review | Personal productivity agents present lower compliance risk; DLP enforcement prevents data exfiltration while allowing experimentation |
...
!!! tip "Complement with Environment Strategy"
    Publishing restrictions are most effective when paired with a robust environment separation strategy. Implement **Control 2.2 (Environment Groups and Tier Classification)** to establish dev/test/prod environments, then use this control to enforce approval gates between tiers. This layered approach ensures agents undergo testing, security review, and approval before reaching production users.
