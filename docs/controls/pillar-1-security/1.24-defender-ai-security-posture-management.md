...
!!! danger "Hard prerequisite from July 1, 2026 — Microsoft Agent 365 required for agent security in Defender"
    Effective **July 1, 2026**, agent-level discovery, security posture, and threat detection for **Microsoft Copilot Studio and Microsoft Foundry agents** in Microsoft Defender **require a Microsoft Agent 365 license**. These capabilities are no longer covered by Defender for Cloud Apps or the Defender CSPM / Defender for AI Services plans. Defender CSPM continues to discover Microsoft Foundry accounts and projects, but **agent-level** posture and threat detection move under Agent 365. Tenants without an Agent 365-eligible license lose these agent-security capabilities at the July 1, 2026 cutover. Treat Microsoft Agent 365 as a **hard prerequisite** for the agent-discovery and agent-threat-detection elements of this control — not a post-GA "verify later" dependency. Source: [Transition Copilot Studio and Foundry agent security to Microsoft Agent 365](https://learn.microsoft.com/defender-xdr/security-for-ai/transition-agent-security-to-agent-365).
