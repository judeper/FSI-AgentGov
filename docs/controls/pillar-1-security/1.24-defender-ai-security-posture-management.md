...
|-------------|---------|-------------|
| **GCP Vertex AI Support** | Public Preview (April 2025) | Defender for Cloud AI-SPM coverage for Google Cloud Vertex AI workloads. Released as Public Preview on April 29, 2025 and remains in Public Preview as of May 2026 (no Microsoft Learn or Defender for Cloud release-notes entry has announced GA since). Verify against the [Defender for Cloud AI-SPM overview](https://learn.microsoft.com/en-us/azure/defender-for-cloud/ai-security-posture) and the [Defender for Cloud release notes archive](https://learn.microsoft.com/en-us/azure/defender-for-cloud/release-notes-archive) before relying on this as a sole Zone 3 control. |
...
- Configure multi-cloud connectors for AWS Bedrock and GCP Vertex AI where applicable (GCP Vertex AI support is **Public Preview** as of April 29, 2025 and remains in Public Preview as of May 2026 — see [Defender for Cloud AI-SPM overview](https://learn.microsoft.com/en-us/azure/defender-for-cloud/ai-security-posture) and the [Defender for Cloud release notes archive](https://learn.microsoft.com/en-us/azure/defender-for-cloud/release-notes-archive); validate behavior in a non-production environment before relying on it as a sole control)
