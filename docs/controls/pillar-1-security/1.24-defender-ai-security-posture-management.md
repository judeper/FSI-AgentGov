...
**Control ID:** 1.24<br>
**Pillar:** Security<br>
**Regulatory Reference:** OCC 2011-12, Fed SR 11-7, FINRA 25-07, GLBA 501(b), NIST AI RMF<br>
...
- **FINRA 25-07:** Requires comprehensive AI inventory, risk-based supervisory controls, and third-party AI vendor oversight; AI-SPM discovery and AI BOM directly support these requirements
...
- **NIST AI RMF:** MAP→agent discovery/AI BOM, MEASURE→attack path analysis, MANAGE→security recommendations, GOVERN→posture dashboards
