...
|-------------|---------|-------------|
| **GCP Vertex AI Support** | GA (November 2025) | Defender for Cloud AI-SPM coverage for Google Cloud Vertex AI workloads, confirmed generally available per [Defender for Cloud release notes, November 2025](https://learn.microsoft.com/en-us/azure/defender-for-cloud/release-notes). |
