...
**Control ID:** 1.10<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA 4511, FINRA 3110, FINRA 25-07, SEC Rules 17a-3/17a-4, GLBA 501(b)<br>
...
- **FINRA 4511/3110:** Supervision of AI-assisted communications; firms must retain and review AI agent interactions
- **FINRA 25-07:** Extends Rule 3110 supervisory obligations to AI-generated communications and workflows; real-time or near-real-time monitoring required for client-facing AI outputs
- **SEC 17a-3/17a-4:** Retention and review of customer communications; 2022 amendments allow audit-trail alternative to WORM for electronic records
...
- Use the built-in **"Detect Microsoft Copilot interactions"** policy template as the starting point for AI monitoring; this auto-configures Prompt Shields and Protected Material classifiers
- Create additional policies for inappropriate content, regulatory violations, and customer data protection
...
- Configure coverage for **Entra-connected AI apps** to extend monitoring beyond native M365 Copilot to enterprise AI applications registered in Entra ID
- Enable **Data Map connector** integration to extend Communication Compliance coverage to connected AI applications cataloged in Purview Data Map
- **Configure Policy Match Preservation** to 7 years for Zone 3 (regulated) to align with SEC 17a-4 retention requirements; the default 1-year retention is insufficient for most FSI obligations
- Note: Communication Compliance policies cannot be created or managed via PowerShell; use the Purview portal for policy CRUD operations
