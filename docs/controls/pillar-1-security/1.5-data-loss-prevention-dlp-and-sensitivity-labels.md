...
**Control ID:** 1.5<br>
**Pillar:** Security<br>
**Regulatory Reference:** FINRA 3110, FINRA 4511, FINRA 25-07, SEC Reg S-P, GLBA 501(b), SOX 404<br>
...
- **SEC Reg S-P (as amended 2024):** Privacy protection — sensitivity labels on customer data control AI access; 2024 amendments require written incident response programs and 30-day breach notification for unauthorized access to customer information
...
| **Sovereign cloud parity** | Adaptive Protection is **not at parity in US Government clouds** as of this revision — see Sovereign Cloud Availability below |
...
| Insider Risk Management + Adaptive Protection | GA | GA (verify) | **Not at parity** | **Not at parity** |
...
- [Microsoft Learn: New-DlpCompliancePolicy cmdlet](https://learn.microsoft.com/en-us/powershell/module/exchange/new-dlpcompliancepolicy)
