...
- **Block SITs in Copilot prompts (Preview):** DLP policies can detect and block sensitive information types entered directly into Copilot prompts, preventing users from pasting account numbers, SSNs, or other regulated data into AI interactions
...
| AI Administrator | Manage AI-specific DLP policy scoping and Copilot data protection settings (new role) |
