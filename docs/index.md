...
1. **Read:** [Control Catalog](controls/index.md) — All 62 controls
...
| **[Control Catalog](controls/index.md)** | Compliance Officers, Architects | 62 control requirements |
...
**62 controls** across four governance pillars:

| Pillar | Controls | Focus |
|--------|----------|-------|
| [Pillar 1: Security](controls/pillar-1-security/index.md) | 24 | DLP, audit, encryption, MFA, eDiscovery |
