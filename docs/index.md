...
1. **Read:** [Control Catalog](controls/index.md) — All 63 controls
...
| **[Control Catalog](controls/index.md)** | Compliance Officers, Architects | 63 control requirements |
...
**63 controls** across four governance pillars:
