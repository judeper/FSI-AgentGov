...
| Control | Integration |
|---------|-------------|
| [2.12 Supervision](../../reference/pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md) | Supervisory review procedures |
| [2.17 Orchestration](../../reference/pillar-2-management/2.17-multi-agent-orchestration-limits.md) | Multi-agent HITL checkpoints |
| [3.4 Incident Reporting](../../reference/pillar-3-reporting/3.4-incident-reporting-and-root-cause-analysis.md) | HITL rejections as incidents |
| [2.6 Model Risk](../../reference/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md) | MRM oversight requirements |
