...
|--------------|-----------------|---------|
| Get-CopilotRestrictionAudit | [4.6 Grounding Scope](../../reference/pillar-4-sharepoint/4.6-grounding-scope-governance.md) | Site inventory |
| Get-HighRiskIndexedContent | [4.6 Grounding Scope](../../reference/pillar-4-sharepoint/4.6-grounding-scope-governance.md) | Risk identification |
| Get-CopilotRestrictionChanges | [1.7 Audit Logging](../../reference/pillar-1-security/1.7-comprehensive-audit-logging-and-compliance.md) | Change monitoring |
| Citation Analysis (KQL) | [2.16 RAG Source Integrity](../../reference/pillar-2-management/2.16-rag-source-integrity-validation.md) | Source tracking |
