...
| **L300 — Defined** | Zone-classified [Managed Environments](../controls/pillar-2-management/2.1-managed-environments.md) with [Environment Groups](../controls/pillar-2-management/2.2-environment-groups-and-tier-classification.md); [comprehensive audit logging](../controls/pillar-1-security/1.7-comprehensive-audit-logging-and-compliance.md) at the FINRA 4511 / SEC 17a-4 retention threshold; [supervision under FINRA Rule 3110](../controls/pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md) with named principals; [model risk tiering](../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) per OCC 2011-12. |
...
- [2.6 Model Risk Management (OCC 2011-12 / SR 26-2)](../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md)
- [2.12 Supervision and Oversight (FINRA Rule 3110)](../controls/pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md)
