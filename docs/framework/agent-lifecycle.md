...
| **Build** | Development phase (configuration, knowledge sources, connectors) | Enable | Microsoft Copilot Studio Agent Author + Power Platform Admin | [2.1](../controls/pillar-2-management/2.1-managed-environments.md), [2.16](../controls/pillar-2-management/2.16-rag-source-integrity-validation.md) |
