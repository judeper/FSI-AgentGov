...
Get-CrmRolePrivilege -RoleName "ELM Admin" |
    Where-Object { $_.EntityName -eq "pl_provisioninglog" } |
    Select-Object PrivilegeName, Depth
# Expected: Only prvCreatepl_provisioninglog with depth
```
