...
- **Automated evidence** — Generated by `Invoke-HardeningBaselineCheck.ps1` for items 7–9 (audit logging), 14–17 (environment provisioning), and 28–32 (environment security settings). The script produces a timestamped JSON report with pass/fail status per item.
