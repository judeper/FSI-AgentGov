...
**IMPORTANT:** This module is **optional and conditional**. Only implement if your organization:
- Operates in Colorado
- Serves Colorado residents
- Uses AI systems that make consequential decisions (housing, lending, employment, education, healthcare)
...
Use the **[Colorado AI Impact Assessment](colorado-ai-impact-assessment.md)** template to document your compliance approach for each high-risk AI system.
...
- **[Control 2.11: Bias Testing and Fairness](../../controls/pillar-2-management/2.11-bias-testing-and-fairness-assessment-finra-notice-25-07-sr-11-7-alignment.md)** - Discrimination monitoring
