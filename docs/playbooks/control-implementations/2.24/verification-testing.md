...
- **Model fitness** for any individual capability — see [Control 2.6](../../../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md). VC-3 evidences only that a generative capability appears on the firm's documented allow-list, not that the model behind it has been validated.
...
| [2.6 — Model Risk Management](../../../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md) | MRM cascade for capability changes that affect model output |
