...
| [2.6](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) | Model Risk Management Alignment (OCC 2011-12 / SR 11-7) | Catalog rows with `RiskRating in {High, Critical}` require an MRM Review ID |
