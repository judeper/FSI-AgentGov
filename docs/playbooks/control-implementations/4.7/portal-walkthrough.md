...
- **Why:** Fed SR 26-2 (formerly SR 11-7) model risk management requires user training proportionate to the model's intended use. FINRA Notice 24-09 and FINRA Rule 3110 specifically reference workforce competence with AI tools as a supervisory expectation.
