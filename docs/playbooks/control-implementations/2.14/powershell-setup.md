...
param(
    ...
    [string]$SenderEmail = "aigovernance@example.com",  # Replace with your organization's sender email
    [string]$TrainingUrl = "https://learning.example.com/ai-governance"  # Replace with your organization's training URL
)
