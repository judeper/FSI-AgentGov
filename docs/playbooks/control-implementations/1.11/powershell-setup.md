...
**What this pack is NOT.** The pack is the **operator''s technical record** of a deterministic helper run. It is **not** a supervisory record under FINRA Rule 3110 (see [Control 2.12](../../../controls/pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md)) and **not** a model-risk validation record under OCC 2011-12 / SR 11-7 (see [Control 2.6](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md)). Those records are separate and are produced by named human reviewers.
...
| [2.6 Model Risk Management (OCC 2011-12 / SR 11-7)](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) | Material changes to the auth boundary are MRM-relevant; re-validate before Enforce. |
