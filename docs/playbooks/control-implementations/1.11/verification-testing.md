...
- [**Control 2.6 — Model Risk Management Alignment with OCC 2011-12 / SR 11-7**](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) — the MRM effectiveness layer. 1.11 enforces identity controls on model-serving endpoints; 2.6 validates the model itself.
