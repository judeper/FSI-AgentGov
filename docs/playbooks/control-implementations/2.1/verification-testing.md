...
!!! danger "Non-Substitution — Managed Environments are not a substitute for human supervision"
    ...
    - The **independent model validation** required by OCC Bulletin 2011-12 and Federal Reserve SR 11-7. A Managed Environment toggle does not validate a model. See [Control 2.6](../../../controls/pillar-2-management/2.6-model-risk-management-alignment-with-occ-2011-12-sr-11-7.md).
