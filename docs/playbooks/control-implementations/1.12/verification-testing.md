...
!!! warning "Non-Substitution"
    ...
    - It does **not replace** the registered-principal supervisory review obligation under FINRA Rule 3110, nor the supervisory designation expectations stated in FINRA RN 24-09 and FINRA Rule 3110 for AI-generated communications and AI-assisted supervisory tooling.
    ...
    - It does **not constitute** legal advice on state employee-monitoring statutes — see TC-16.
...
| TC-11 IRM role groups + SoD | Quarterly + on-change | Purview Compliance Admin | Internal Audit, GC | 7 years | FINRA 3110, SOX 404, NYDFS 500.07 |
| TC-14 Indicator baseline attestation | Quarterly | Purview Compliance Admin | AI Governance Lead, CCO | 7 years | FINRA 3110, OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-15 Risky Agents default policy | Monthly | Purview Compliance Admin | AI Governance Lead | 7 years | FINRA RN 24-09, OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-16 Risky AI usage + Intune extension | Monthly | Purview Compliance Admin + Intune Admin | AI Governance Lead | 7 years | FINRA RN 24-09, GLBA 501(b) |
| TC-17 Departing-user data theft | Monthly | Purview Compliance Admin + HR liaison | CCO | 7 years | FINRA 3110, Reg S-P (2024) |
| TC-18 Priority-user data leaks | Monthly | Purview Compliance Admin | CCO, GC | 7 years | FINRA 3110, GLBA 501(b), Reg S-P |
| TC-19 Security policy violations (MDE) | Monthly | Purview Compliance Admin + MDE Admin | CISO | 7 years | FFIEC, NYDFS 500.06 |
| TC-20 Risky browser usage | Monthly | Purview Compliance Admin | AI Governance Lead | 7 years | FINRA 3110, GLBA 501(b) |
| TC-11 Defender for Cloud Apps correlation | Quarterly | Defender for Cloud Apps Admin | CISO | 7 years | FINRA 4511, GLBA 501(b) |
| TC-14 Entra ID Protection signal correlation | Quarterly | Entra Security Reader + IRM Analyst | CISO | 7 years | NYDFS 500.06, FFIEC |
| TC-15 Forensic Evidence dual-auth | Quarterly + per-capture | IRM Investigator + IRM Approver | Privacy Officer, GC | Per legal hold (else records-scope ≥7y) | SEC 17a-4(b), FINRA 4511 |
| TC-16 State monitoring-law check | Annually + on enablement | Privacy Officer + GC | CCO | 7 years | State law (CT/DE/NY); GLBA 501(b) |
| TC-17 Triage Agent readiness | Quarterly + 90-day refresh | AI Governance Lead + CISO | CCO | 7 years | OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7), FINRA RN 24-09 |
...
| TC-18 Communication Compliance correlation | Quarterly | Purview Compliance Admin | CCO | 7 years | FINRA 3110, [Control 1.10](../../../controls/pillar-1-security/1.10-communication-compliance-monitoring.md), [Control 2.12](../../../controls/pillar-2-management/2.12-supervision-and-oversight-finra-rule-3110.md) |
| TC-19 Escalation chain | Quarterly + per-high-severity | IRM Analyst + CCO | CISO, GC | 7 years | FINRA 3110, NYDFS 500.17 (72h), Reg S-P (72h) |
| TC-20 Pseudonymization → unmask gate | Quarterly | Privacy Officer + IRM Auditor | GC, CCO | 7 years | GLBA 501(b), Reg S-P, state monitoring law |
| TC-11 Sentinel UEBA correlation | Quarterly | SOC Analyst (Sentinel) + IRM Analyst | CISO | 7 years | NYDFS 500.06, [Control 2.26](../../../controls/pillar-2-management/2.26-entra-agent-id-identity-governance.md), [Control 3.9](../../../controls/pillar-3-reporting/3.9-microsoft-sentinel-integration.md) |
| TC-15 SOX 404 IRM self-assessment | Annually | CCO + Internal Audit | CISO, GC, Audit Committee | 7 years | SOX §§302/404, OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-16 Examination evidence-pack pull-test | Annually + on-examiner-request | CCO | Internal Audit, GC | 7 years | FINRA 4511, SEC 17a-4(f), Reg S-P |
...
| Entra Global Admin | `Global Administrator` (break-glass only) | TC-11 (read-only enumeration) |
| Purview Compliance Admin | `Compliance Administrator` + IRM role-group `Insider Risk Management Admins` | TC-1 → TC-11 |
| AI Administrator | `AI Administrator` (Entra) | TC-15, TC-16, TC-20, TC-17 |
| AI Governance Lead | Custom RBAC (read on Purview, AI Admin Center, AgentDLP) | TC-14, TC-15, TC-16, TC-17, TC-15 |
| Compliance Officer / CCO | `Compliance Administrator` (read) + IRM `Insider Risk Management Auditors` | TC-11, TC-14, TC-15, TC-16 |
| Privacy Officer | IRM `Insider Risk Management Auditors` + Purview Audit Reader | TC-15, TC-16, TC-20 |
| General Counsel (GC) | IRM `Insider Risk Management Auditors` + eDiscovery Reviewer | TC-15, TC-16, TC-19, TC-15 |
| IRM Admin | `Insider Risk Management Admins` | TC-1 → TC-14, TC-15, TC-18 |
| IRM Analyst | `Insider Risk Management Analysts` | TC-14, TC-15, TC-16, TC-17, TC-18, TC-20, TC-11, TC-14, TC-19, TC-11 |
| IRM Investigator | `Insider Risk Management Investigators` | TC-15, TC-20 |
| IRM Approver | `Insider Risk Management Approvers` | TC-15, TC-20 (must NOT overlap Investigator membership — SoD gate) |
| IRM Auditor | `Insider Risk Management Auditors` | TC-1, TC-15, TC-16, TC-20, TC-15, TC-16 |
| Conditional Access Admin | `Conditional Access Administrator` | TC-15 |
| Defender for Cloud Apps Admin | `Defender for Cloud Apps Administrator` (or `Cloud App Security Admin` legacy) | TC-11 |
| MDE Admin | `Security Administrator` (Defender XDR) | TC-19 |
| Intune Admin | `Intune Administrator` | TC-16, TC-20 |
| SOC Analyst (Sentinel) | `Microsoft Sentinel Reader` (+ `Responder` for incident actions) | TC-11, TC-20 |
| Internal Audit | Read-only across IRM + Audit + Sentinel; no `Insider Risk Management` (the catch-all role group is **prohibited** in regulated FSI tenants) | TC-11, TC-15, TC-16 |

> **SoD gate.** The catch-all `Insider Risk Management` role group bundles all permissions and is **forbidden** in FSI tenants per [Control 1.5 §RBAC](../../../controls/pillar-1-security/1.5-data-loss-prevention-dlp-and-sensitivity-labels.md). TC-11 fails any environment in which it is populated.
...
| PRE-3 | `(Get-MgContext).Environment` returns `Global`. Tagged in every evidence record. | Purview Compliance Admin | Halt cycle if `Unknown`. |
...
| PRE-6 | Pseudonymization is **enabled** in IRM settings (default: on). | Privacy Officer | Halt cycle; record incident under TC-20. |
...
- `tc01-ual-state.json` — `{ RunId,UnifiedAuditLogIngestionEnabled, OperationsObserved[] }` + `.sha256`.
...
### TC-11 · IRM role groups + Separation-of-Duties
...
### TC-14 · Indicator baseline attestation
...
3. Diff the export against `baseline.yaml`. Categories of interest:
   ...
   - Risky Agents indicators (default-applied — see TC-15).
...
### TC-15 · Risky Agents default policy verification
...
FINRA RN 24-09 + Rule 2210 (AI-generated communications) · GLBA 501(b) (data-leak channel) · [Control 1.6](../../../controls/pillar-1-security/1.6-microsoft-purview-dspm-for-ai.md) · [Control 1.13](../../../controls/pillar-1-security/1.13-sensitive-information-types-sits-and-pattern-recognition.md).

---

### TC-17 · Departing-user data-theft policy
...
### TC-18 · Priority-user data-leaks policy (FSI roles)
...
### TC-19 · Security policy violations (Defender for Endpoint integration)
...
### TC-20 · Risky browser usage (Edge / Chrome extension)
**Frequency:** Monthly · **Owner:** Purview Compliance Admin · **Counter-signer:** AI Governance Lead

#### Setup

- Same extension prerequisites as TC-16 (Windows-only).
...
2. Re-validate extension force-install coverage (may share evidence with TC-16).
...
### TC-11 · Defender for Cloud Apps signal correlation (June 2025 dynamic threat detection)
...
### TC-14 · Entra ID Protection signal correlation
...
### TC-15 · Forensic Evidence dual-authorization
...
- Two distinct individuals occupying `Insider Risk Management Investigators` and `Insider Risk Management Approvers` (TC-11 SoD gate must hold).
- State-law check (TC-16) completed for every jurisdiction in scope.
...
- SoD: zero overlap between Investigator and Approver memberships (re-asserts TC-11).
...
- No capture proceeds in a jurisdiction lacking a current TC-16 attestation.
...
- SoD overlap → halt all in-flight captures; demote per TC-11 remediation; re-attest within 24h; treat any in-flight captures as unverified pending GC review.
- Missed 100-day decision → record as a finding; document any clip aged-out; report to CCO; review process design.
- Capture initiated without TC-16 attestation → halt immediately; notify Privacy Officer and GC; trigger incident-response per [Control 1.10](../../../controls/pillar-1-security/1.10-communication-compliance-monitoring.md) and the firm's privacy-incident playbook.
...
### TC-16 · State employee-monitoring law check
...
!!! danger "State employee-monitoring laws"
    ...
    **This playbook does not constitute legal advice.** No Forensic Evidence capture, Risky AI / Risky browser walkthrough on a real user, or pseudonymization-unmask action shall proceed in any jurisdiction unless the Privacy Officer and General Counsel have signed the current TC-16 attestation for that jurisdiction. The Privacy Officer maintains the canonical jurisdiction × in-scope-feature matrix; GC owns the legal interpretation.
...
- TC-15 captures honor TC-16 jurisdiction status (no capture in a jurisdiction without current attestation).
...
### TC-17 · Triage Agent (Security Copilot) readiness
...
3. Pull a 30-day sample of agent-triaged alerts; confirm each agent-recommendation has a corresponding analyst review-and-disposition record (the agent is **decision-support**, not the supervisory decision-maker — see FINRA RN 24-09 and FINRA Rule 3110).
...
- Fidelity drift → escalate to AI Governance Lead; potentially retune indicator weights (TC-14) under model-risk RFC.

#### Regulatory tie-in

OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7) (model risk; Triage Agent is a decision-support model surface) · FINRA RN 24-09 + Rule 3110 · [Control 2.6](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md).


---


### TC-18 · Communication Compliance correlation (supervisory tie-in)
...
### TC-19 · Escalation chain (72-hour regulatory clocks)
...
### TC-20 · Pseudonymization → unmask gate
...
4. Confirm jurisdictional pre-conditions (TC-16) for each unmask target.
...
### TC-11 · Sentinel UEBA correlation (KQL)
...
```kql
// TC-11.A — IRM operations volume by day (last 30d)
OfficeActivity
...
```kql
// TC-11.B — Forensic Evidence dual-auth chain (request → approval/denial)
OfficeActivity
...
```kql
// TC-11.C — IRM ↔ Entra ID Protection user-risk join
let highRisk =
    SigninLogs
    | where TimeGenerated > ago(30d)
...
```kql
// TC-11.D — Entra Agent ID activity not yet correlated to an IRM alert (90d)
let agentSignals =
...
```kql
// TC-11.E — Pseudonymization unmask audit-rate
OfficeActivity
| where TimeGenerated > ago(90d)
...
- TC-11.B returns SoD `true` for every Forensic Evidence case.
- TC-11.D returns an empty set OR a documented exception.
...
- TC-11.B SoD `false` → halt all Forensic Evidence captures; investigate role-group integrity.
...
### TC-15 · SOX 404 IRM self-assessment
...
1. Compile the year's TC-1 through TC-18 evidence packages.
...
### TC-16 · Examination evidence-pack pull-test
...
2. For each window, assemble the canonical evidence pack:
   ...
   - TC-11 quarterly role-SoD attestation.
   - TC-14 quarterly indicator-baseline attestation.
   - TC-15–TC-14 monthly / quarterly attestations as applicable.
   - TC-15 per-capture records for any Forensic Evidence captures in window.
   - TC-16 jurisdiction matrix in effect during window.
   - TC-19 escalation-sample CSV.
   - TC-20 unmask-audit CSV.
   - TC-11 Sentinel KQL outputs.
...
| TC-11 | `tc02-roles.json`, `tc02-sod.json` | WORM | 7 years | FINRA 3110 · SOX 404 · NYDFS 500.07 |
| TC-14 | `tc03-indicators-export.csv`, `tc03-indicators-diff.json`, `tc03-attestation.pdf` | WORM | 7 years | FINRA 3110 · OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-15 | `tc04-risky-agents-policy.json`, `tc04-agent-reconciliation.csv` | WORM | 7 years | FINRA RN 24-09 · OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-16 | `tc05-policy.json`, `tc05-extension-coverage.csv`, `tc05-walkthrough-alert.json` | WORM | 7 years | FINRA RN 24-09 · GLBA 501(b) |
| TC-17 | `tc06-hr-connector.json`, `tc06-hr-vs-irm-drift.csv` | WORM | 7 years | FINRA 3110 · Reg S-P 2024 · GLBA 501(b) |
| TC-18 | `tc07-priority-groups.json`, `tc07-priority-policy.json` | WORM | 7 years | FINRA 3110 · GLBA 501(b) · Reg S-P |
| TC-19 | `tc08-mde-connector.json` (+ coverage + correlation CSVs) | WORM | 7 years | FFIEC · NYDFS 500.06 |
| TC-20 | `tc09-policy.json`, `tc09-walkthrough.json` | WORM | 7 years | FINRA 3110 · GLBA 501(b) · Reg S-P |
| TC-11 | `tc10-mda-irm-correlation.csv`, `tc10-model-state.json` | WORM | 7 years | FINRA 4511 · GLBA 501(b) |
| TC-14 | `tc11-risky-users.json`, `tc11-correlation.csv` | WORM | 7 years | NYDFS 500.06 / 500.12 |
| TC-15 | `tc12-fe-quarterly.json`, `tc12-fe-per-capture-{caseId}.json`, `tc12-fe-decision-{caseId}.json` | WORM (+ legal-hold preservation where applicable) | Per legal hold; else 7 years for **decision metadata** | SEC 17a-4(b) · FINRA 4511 · GLBA 501(b) · State monitoring statutes |
| TC-16 | `tc13-jurisdiction-matrix.yaml`, `tc13-attestation-{year}.pdf` | WORM | 7 years | State monitoring statutes · GLBA 501(b) |
| TC-17 | `tc14-triage-state.json`, `tc14-fidelity-sample.csv`, `tc14-attestation.pdf` | WORM | 7 years | OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7) · FINRA RN 24-09 |
| TC-18 | `tc16-cc-irm-correlation.csv`, `tc16-supervisory-tieout.csv` | WORM | 7 years | FINRA 3110 · FINRA 4511 |
| TC-19 | `tc17-escalation-sample.csv`, `tc17-tabletop-{quarter}.pdf` | WORM | 7 years | NYDFS 500.17(a) · Reg S-P 2024 · FINRA 3110 |
| TC-20 | `tc18-unmask-audit.csv` (hashed target IDs) | WORM | 7 years | GLBA 501(b) · Reg S-P · State statutes |
| TC-11 | `tc19-{query}.csv` per KQL query | WORM | 7 years | NYDFS 500.06 / 500.16 · FFIEC |
...
| TC-15 | `tc21-soa-{year}.pdf`, `tc21-tabletop-{year}-{scenario}.pdf` | WORM | 7 years | SOX §§302 / 404 · OCC Bulletin 2026-13 (formerly OCC 2011-12) |
| TC-16 | `tc22-pulltest-{window}.json`, `tc22-attestation-{year}.pdf` | WORM | 7 years | FINRA 4511 · SEC 17a-4(f) · Reg S-P |
...
| Chief Information Security Officer (CISO) | Technical control state across TC-1 → TC-18; Sentinel correlation health (TC-11). |
| Privacy Officer | Pseudonymization integrity (TC-20); state-law jurisdiction matrix (TC-16); employee-notice mechanism operating. |
| General Counsel (GC) | Legal interpretation of state monitoring statutes; Forensic Evidence dual-auth chain (TC-15); legal-hold preservation paths. |
| AI Governance Lead | Risky Agents / Risky AI usage policy posture (TC-15 / TC-16); Triage Agent fidelity (TC-17); model-risk alignment with OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7). |
| Internal Audit | Independent verification of evidence integrity and SoD; pull-test results (TC-16); SOX 404 self-assessment (TC-15). |
| Audit Committee Chair | Acceptance of self-assessment memo and remediation plan (TC-15). |
...
6. Hash + WORM-storage reference to the assembled TC-16 sub-pack supporting the incident.

### §4.3 Cycle close

- Run identifier `IRM112-yyyyMMdd-HHmmss-<8charGuid>` archived.
- All TC artefacts hash-verified and resolved from WORM.
--exception register reviewed and updated against Microsoft Learn.
- Indicator baseline diff (TC-14) reviewed; any approved drift incorporated into `governance/irm-indicators/baseline.yaml` under change control.
- Next-cycle calendar items scheduled (weekly TC-1, monthly TC-15 → TC-20, quarterly TC-11 / TC-14 / TC-11 → TC-11 / TC-20, annual TC-15 / TC-16).
...
- `Result` ∈ {`Pass`, `Fail`, `NotApplicable`, `Skipped`}; `NotApplicable` and `Skipped` MUST include a `Reason` field.
- `Operator.PrincipalUpnHash` is SHA-256 over the lower-cased UPN to support pseudonymization at the evidence layer.
- `Artefacts[].Sha256` MUST match the `.sha256` sidecar contents (verified at TC-16 pull-test).
...
Describe 'Control 1.12 · Verification (read-only)' {
    ...
    Context 'PRE gates' {
        ...
        It 'PRE-3tag known'  { $script:Sov.Cloud | Should -Not -Be 'Unknown' }
    ...
    Context 'TC-15 Forensic Evidence audit chain' {
...
| FINRA Rule 3110 (Supervision) | TC-11, TC-14, TC-17, TC-18, TC-20, TC-18, TC-19 |
| FINRA Rule 4511 (Books and Records) | TC-1, TC-11, TC-15, TC-18, TC-20, TC-16 |
| FINRA Regulatory Notice 21-18 | TC-1, TC-15, TC-16 (cloud-hosted records stewardship context) |
| FINRA RN 24-09 / Rule 3110 | TC-15, TC-16, TC-17, TC-18 (Gen AI supervision; technology-neutral application of existing supervisory and recordkeeping rules) |
| SEC Rule 17a-3 / 17a-4 | TC-1, TC-15, TC-16 |
| SEC Reg S-P (2024 amendments) | TC-17, TC-18, TC-20, TC-19, TC-20, TC-16 |
| GLBA §501(b) (Safeguards Rule) | TC-16, TC-17, TC-18, TC-20, TC-11, TC-16, TC-15, TC-20 |
| SOX §§302 / 404 | TC-11, TC-15 |
| OCC Bulletin 2026-13 (formerly OCC Bulletin 2011-12) / Federal Reserve SR 26-2 (formerly SR 11-7) | TC-14, TC-15, TC-17, TC-15, TC-20, TC-15 |
| CFTC Regulation 1.31 | TC-1, TC-15, TC-16 (records preservation context) |
| NYDFS 23 NYCRR 500.06 | TC-1, TC-19, TC-11, TC-14, TC-16, TC-11, TC-15, TC-16 |
| NYDFS 23 NYCRR 500.16 | TC-11 |
| NYDFS 23 NYCRR 500.17(a) (72-hour) | TC-19 |
| FFIEC IT Examination Handbook | TC-19, TC-14, TC-11 |
| State employee-monitoring statutes (CT §31-48d, DE Title 19 §705, NY Civil Rights Law §52-bis) | TC-15 (gating), TC-16 (primary), TC-20 (operational) |

### §5.6 Appendix F — Glossary (subset)

| Term | Meaning |

| Adaptive Protection | IRM capability that links risk levels to dynamic enforcement in DLP / Conditional Access / DLM. Available in the Microsoft commercial cloud. |
...
1. **Where are policies authored and who approved them?** → TC-14 baseline + RFC trail.
2. **How do you know IRM is producing a defensible audit trail?** → TC-1 weekly attestation + WORM 7-year retention.
3. **How do you prevent abuse of the IRM tool itself?** → TC-11 SoD + TC-20 unmask gate.
4. **How do you handle Forensic Evidence under state law?** → TC-15 dual-auth + TC-16 jurisdiction matrix.
5. **How do you tie IRM to your supervisory program?** → TC-18 CC correlation + TC-19 escalation chain (72-hour clocks).
6. **How is your AI / agent surface governed?** → TC-15 / TC-16 / TC-17 + Control 2.6 (model-risk) + Control 2.26 (agent identity).
...
- **Communication Compliance authoring** is implemented under [Control 1.10](../../../controls/pillar-1-security/1.10-communication-compliance-monitoring.md). TC-18 is the IRM-to-CC correlation, not a CC authoring procedure.
...
- **Sentinel workspace authoring and detection-rule lifecycle** are implemented under [Control 3.9](../../../controls/pillar-3-reporting/3.9-microsoft-sentinel-integration.md). The KQL in TC-11 is read-only verification, not detection-rule authoring.
...
6. Re-run of TC-16 pull-test against the updated catalogue with archived evidence to confirm assembly continues to meet SLA.

---

### §5.10 Appendix J — Extended KQL hunting library

The queries below extend TC-11 with additional hunting patterns the SOC may schedule independently. They are **hunting-tier** (not detection rules) and are referenced by the TC-11 evidence record where the SOC Analyst includes them in the cycle.
...
```kql
// J.3 — Forensic Evidence captures approved without a recent TC-16 jurisdiction reference (90d)
...
> **Hunting-tier note.** Operation names in the above queries reflect commercial-cloud OfficeActivity emissions as observed in the April 2026 cycle.cloud emission names may differ; verify against your tenant's Sentinel ingestion before scheduling.
...
| New IRM policy created or modified | TC-14, TC-15, TC-16, TC-17, TC-18, TC-20 (any affected) | Same business day |
| IRM role-group membership change | TC-11, TC-15 (re-assert SoD) | Within 24h |
| Forensic Evidence enabled in a new jurisdiction | TC-16, TC-15 | Before first capture |
|-exception register updated | TC-20 (affected exception only) | Within 7 days |
| Microsoft Learn change to a referenced capability (Adaptive Protection, Risky Agents, Forensic Evidence, Triage Agent) | TC-14 (indicator implications), TC-15 / TC-16 / TC-20 / TC-15 / TC-17 / TC-15 / TC-20 (as applicable) | Within 30 days of Microsoft change |
| Indicator baseline change (RFC approved) | TC-14 | Same business day |
| Intune extension force-install policy change | TC-16, TC-20 | Within 7 days |
| HR connector schema change (added / removed field) | TC-17 | Same business day |
| Defender for Cloud Apps model update | TC-11 | Within 14 days |
| Conditional Access policy bound to Adaptive Protection changed | TC-15 | Within 7 days |
| Communication Compliance policy scope change | TC-18 | Within 7 days |
| Sentinel connector health change | TC-11 | Within 24h |
| State employee-monitoring statute change (legislative or regulatory) | TC-16 | Within 30 days; suspend affected captures pending GC review |
...
| TC-16 pull-test assembly | 48 hours | CCO + records-management custodian |
|-exception compensating-control exercise | 90 days | Per exception owner |
...
| Catch-all role group repopulated | TC-11 | Empty membership; quarantine in-flight cases | Add Sentinel detection rule on role-group membership changes |
| Investigator ↔ Approver overlap | TC-11, TC-15 | Halt all FE captures; demote per SoD | Make role-group changes PIM-eligible only; require dual-approver |
| Pseudonymization disabled | PRE-6, TC-20 | Re-enable; halt evidence cycle | Add Sentinel detection rule on `PseudonymizationEnabled = false` |
| Risky Agents policy missing or scope-incomplete | TC-15 | Recreate policy; reconcile inventory | Wire Control 3.1 inventory to a scheduled Risky Agents reconciliation job |
| Risky AI extension coverage gap | TC-16 | Push Intune assignment | Add coverage SLO to operational dashboard |
| HR connector stale > 24h | TC-17 | Manual sync; investigate field mapping | Add health-monitor alert on connector last-sync age |
| MDA dynamic threat detection disabled or unhealthy | TC-11 | Re-enable; SOC sample review | Add connector-health detection rule |
| Sentinel KQL hits but no IRM artefact | TC-11 | Analyst follow-up; document benign rationale | Tune detection rule or IRM policy as appropriate |
| Forensic Evidence clip auto-delete imminent (≤ 20 days) without 100-day decision | TC-15 (per-capture) | Investigator decides extend / hold / auto-delete | Add automated reminder at 80-day mark |
| State statute change | TC-16 | Suspend captures in jurisdiction; GC review | Subscribe to legislative-tracking service |
| Triage Agent saved-auth expiring | TC-17 | Refresh under change ticket | Add 14-day pre-expiry alert |
| Adaptive Protection binding drift (commercial) | TC-15 | Re-bind under change ticket | Add binding-state detection rule |
| 72-hour clock breach | TC-19 | RCA within 7 business days | Process-engineering review; tabletop reset |
| TC-16 artefact missing or sidecar mismatch | TC-16 | Records-management incident | Audit Committee escalation |

### §5.15 Appendix O — Microsoft Learn watch-list each cycle)
