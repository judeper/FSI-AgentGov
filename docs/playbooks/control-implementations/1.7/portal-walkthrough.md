...
!!! danger "READ FIRST — Scope and Sibling Routing"
    ...
    **This walkthrough is NOT (route to the linked sibling):**
    ...
    | Records-management retention/disposition labels distinct from audit retention | [Control 2.6 — Model Risk Management (OCC 2011-12 / SR 11-7)](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) and the Records Management retention label set documented in your firm's records schedule |
...
| [2.6 — Model Risk Management (OCC 2011-12 / SR 11-7)](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) | Model-card store referenced by `ModelTransparencyDetails.ModelProviderName` in audit; supplements the audit log where `ModelName` / `ModelVersion` are not populated for M365 Copilot |
