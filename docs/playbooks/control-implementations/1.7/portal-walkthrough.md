...
!!! danger "READ FIRST — Scope and Sibling Routing"
    ...
    **This walkthrough is NOT (route to the linked sibling):**
    ...
    | Records-management retention/disposition labels distinct from audit retention | [Control 1.9 — Data Retention and Deletion Policies](../../../controls/pillar-1-security/1.9-data-retention-and-deletion-policies.md) and the Records Management retention label set documented in your firm's records schedule |
