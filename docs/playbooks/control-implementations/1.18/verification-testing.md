...
| SSPM-1.18-02 | Connected agents | Disabled or restricted to approved list | Copilot Studio > Agent > Settings > Connected Agents (verify Preview vs. GA tag at apply-time) | Per-agent screenshot |
