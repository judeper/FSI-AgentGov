...
!!! danger "READ FIRST — Scope and Sibling Routing"
    ...
    **This walkthrough is NOT for:**
    ...
    | Model risk management (validation, challenger models, inventory under OCC 2011-12 / SR 11-7) | [Control 2.6 — Model Risk Management Alignment with OCC 2011-12 / SR 11-7](../../../controls/pillar-2-management/2.6-model-risk-management-sr-26-2.md) |
