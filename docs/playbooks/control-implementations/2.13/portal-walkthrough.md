...
### Step 4: Configure WORM Storage (Zone 3)
...
3. Configure Purview to use immutable storage for SEC 17a-4 compliance
...
Retention:
  Default: 6 years
  SEC 17a-4 content: 7 years with WORM
...
- [ ] WORM storage configured (Zone 3)
