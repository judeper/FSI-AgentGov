...
|----------|--------|-----------------|-----------------|
| `01-purview-dspm-dashboard.png` | Purview | DSPM for AI → Dashboard | Main DSPM for AI overview |
| `02-purview-dspm-discovery.png` | Purview | DSPM for AI → Discovery | AI app discovery results |
| `03-purview-dspm-policies.png` | Purview | DSPM for AI → Policies | Data security policies for AI |
