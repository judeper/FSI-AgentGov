...
|----------|--------|-----------------|-----------------|
| `01-spac-sites-list.png` | SPAC | Sites → Active sites | Site inventory |
| `02-spac-site-settings.png` | SPAC | Site → Settings | Site configuration panel |
| `03-spac-restrict-content.png` | SPAC | Site → Restrict content from Copilot | Restriction toggle |
| `04-spac-advanced-management.png` | SPAC | Advanced management | Advanced management overview |
| `05-spac-data-governance.png` | SPAC | Reports → Data access governance | Governance reports |
