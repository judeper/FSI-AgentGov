...
Usage::
    ...
    python scripts/create_uasd_environment_variables.py --dry-run
    python scripts/create_uasd_environment_variables.py --verbose
"""
...
def create_environment_variables(
    ...
    """
    print("=" * 60)
    print("UASD Environment Variables Deployment")
    print("=" * 60)
