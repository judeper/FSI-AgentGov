...
Usage::
    ...
    python scripts/create_uasd_connection_references.py --dry-run
    python scripts/create_uasd_connection_references.py --verbose
"""
...
def create_connection_references(
    ...
    """
    print("=" * 60)
    print("UASD Connection References Deployment")
    print("=" * 60)
