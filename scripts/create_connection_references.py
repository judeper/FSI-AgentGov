"""Deploy connection references for Conditional Access Automation.

Creates 4 connection references with the ``fsi_cr_*`` naming convention
...
Usage::
    ...
    python scripts/create_connection_references.py --dry-run
    python scripts/create_connection_references.py --verbose
"""
...
def create_connection_references(
    ...
    """Create all 4 connection references.
    ...
    """
    print("=" * 60)
    print("CAA Connection References Deployment")
    print("=" * 60)
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Deploy CAA connection references (4 fsi_cr_* definitions)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
