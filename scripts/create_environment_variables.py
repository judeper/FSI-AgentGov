"""Deploy environment variables for Conditional Access Automation.

Creates 7 environment variables with the ``fsi_CAA_*`` prefix in the
...
Usage::
    ...
    python scripts/create_environment_variables.py --dry-run
    python scripts/create_environment_variables.py --verbose
"""
...
ENVIRONMENT_VARIABLES: List[Dict[str, Any]] = [
    {
        "schema_name": "fsi_CAA_GracePeriodHours",
        "display_name": "CAA - Grace Period (Hours)",
        "type": 100000001,  # Decimal
        "default_value": "48",
        "description": (
            "Hours before newly deployed policies are included in validation"
        ),
    },
    {
        "schema_name": "fsi_CAA_ScanFrequencyHours",
        "display_name": "CAA - Scan Frequency (Hours)",
        "type": 100000001,  # Decimal
        "default_value": "24",
        "description": (
            "Automated compliance scan interval for Phase 3 flow"
        ),
    },
    {
        "schema_name": "fsi_CAA_BaselineMaxAgeDays",
        "display_name": "CAA - Maximum Baseline Age (Days)",
        "type": 100000001,  # Decimal
        "default_value": "30",
        "description": (
    ...
    {
        "schema_name": "fsi_CAA_DriftSeverityEscalation",
        "display_name": "CAA - Drift Severity Escalation",
    ...
    {
        "schema_name": "fsi_CAA_IncludeReportOnlyPolicies",
        "display_name": "CAA - Include Report-Only Policies",
        "type": 100000000,  # String
        "default_value": "true",
        "description": (
            "Whether report-only CA policies are included in validation scans"
        ),
    },
    {
        "schema_name": "fsi_CAA_TeamsGroupId",
        "display_name": "CAA - Teams Alert Group ID",
        "type": 100000000,  # String
        "default_value": "",
        "description": (
    ...
    {
        "schema_name": "fsi_CAA_TeamsChannelId",
        "display_name": "CAA - Teams Alert Channel ID",
        "type": 100000000,  # String
        "default_value": "",
        "description": (
...
def create_environment_variables(
    ...
    """Create all 7 environment variables.
    ...
    """
    print("=" * 60)
    print("CAA Environment Variables Deployment")
    print("=" * 60)
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Deploy CAA environment variables (7 fsi_CAA_* definitions)"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
