...
<task type="auto">
  ...
  <files>
    C:/dev/FSI-AgentGov-Solutions/agent-observability-foundation/power-bi/docs/viva-insights-scope.md
  </files>
  <action>
...
<task type="auto">
  ...
  <files>
    C:/dev/FSI-AgentGov-Solutions/agent-observability-foundation/power-bi/docs/viva-insights-reconciliation.md
  </files>
  <action>
