...
| `/Users/admin/dev/FSI-AgentGov-Solutions/audit-configuration-validator/docs/FLOW_SETUP.md` | Step-by-step flow deployment guide | ✓ VERIFIED | EXISTS (589 lines), SUBSTANTIVE (comprehensive guide with Azure Automation setup, flow creation steps, alert configuration, testing, troubleshooting), REFERENCES AUTO requirements (L16-19) |
