...
**Run Date:** 2026-08-06
**Run Time:** 2026-08-06T08:37:17.838038+00:00
...
| 19 | ...ensitive-information-type-learn-about | HIGH | 1.13 | Review and update |
| 20 | endpoint-dlp-learn-about | HIGH | 1.17 | Review and update |
| 21 | use-powerapps-checker | HIGH | None | Review and update |
| 22 | microsoft-purview-service-description | HIGH | None | Update portal-walkthrough |
| 23 | requirements-licensing-subscriptions | MEDIUM | None | Review optional |
...
**Content-Hash:** sha256:ac3cc8103fef750fa23506540b0700f37788359b8b177f54682a161959922021
...
**Classification:** HIGH (Compliance features)
**Content-Hash:** sha256:e020fb23a69f7a20108f1233e5857c3585f04379bcd82a36bf19a9fdd777281a
...
+Add to Plans
 ...
 Copy Markdown
 Print
@@ -278,6 +278,17 @@ While creating a regex using a double byte hyphen or a double byte period, make sure to escape both the characters like you would escape a hyphen or period in a regex. Here's a sample regex for reference:
 (?<!\d)([4][0-9]{3}[\-?\-\t]*[0-9]{4}
 We recommend using string match instead of word match in a keyword list.
+Detection differences across workloads
+The same sensitive information type can produce different results depending on where content is evaluatedâfor example, email in transit (Exchange), files at rest (SharePoint and OneDrive), and files on managed devices (Endpoint DLP). Endpoint DLP classifies files against
+all
+sensitive information types available in the tenant, and using a bundled SIT in an endpoint DLP policy requires
+Advanced classification scanning and protection
+.
+Before you rely on a custom SIT in production,
+test it
+and validate detection in each workload where you intend to use itâfor example, a mail flow rule, a SharePoint or OneDrive policy, and an endpoint policy. Detection can also be affected by content-extraction limits such as maximum file size and the number of characters scanned; see
...
**Section:** Microsoft Purview
**Classification:** HIGH (Compliance features)
**Content-Hash:** sha256:3372e9864618e11266e4ab58fccd53f7e1b7d42bb425a0a06712bdc73cb73134
