...
**Run Date:** 2026-04-07
**Run Time:** 2026-04-07T07:20:49.261742+00:00
...
| 5 | alerts | HIGH | None | Review and update |
| 6 | activity-logs-power-platform-admin | CRITICAL | None | Monitor |
| 7 | capacity-storage | HIGH | 3.5 | Review and update |
| 8 | ...ilot-security-enhanced-admin-controls | MEDIUM | 2.8, 2.3, 1.18 | Review optional |
| 9 | security-and-governance | HIGH | 1.8, 1.28, 1.1, 1.4, 1.5 | Review and update |
| 10 | analytics-overview | HIGH | 2.6, 2.9, 3.10, 3.2 | Review and update |
| 11 | advanced-connectors | MEDIUM | None | Review optional |
| 12 | knowledge-copilot-studio | HIGH | 2.16, 4.8 | Review and update |
| 13 | nlu-gpt-overview | MEDIUM | 2.12 | Review optional |
| 14 | whats-new | HIGH | 2.10 | Review and update |
| 15 | planned-features | MEDIUM | 2.25 | Review optional |
| 16 | ...gent-external-data-custom-mcp-servers | HIGH | 2.17, 1.4, 1.5, 3.8 | Review and update |
| 17 | microsoft-365-copilot-usage | HIGH | 3.8 | Review and update |
| 18 | human-in-the-loop | HIGH | 2.12, 2.17 | Review and update |
| 19 | dlp-policy-reference | HIGH | None | Review and update |
| 20 | sensitivity-labels | HIGH | 1.26, 1.3, 1.5, 4.9 | Review and update |
| 21 | sensitivity-labels-teams-groups-sites | HIGH | 1.3 | Review and update |
| 22 | dspm-for-ai-considerations | MEDIUM | None | Review optional |
| 23 | ...ensitive-information-type-learn-about | MEDIUM | 1.13 | Review optional |
| 24 | data-classification-activity-explorer | HIGH | 1.6 | Review and update |
| 25 | ...o-conditional-access-session-lifetime | CRITICAL | 1.23 | Monitor |
| 26 | overview-authentication | HIGH | 1.11 | Review and update |
| 27 | access-reviews-overview | HIGH | 1.3 | Review and update |
| 28 | create-access-review | HIGH | 2.8, 4.2 | Review and update |
| 29 | ...n.microsoft.com/en-us/entra/agent-id/ | HIGH | 1.11, 1.2, 1.18 | Review and update |
| 30 | ...-entra-agent-identities-for-ai-agents | HIGH | 1.11, 1.18 | Review and update |
| 31 | advanced-management | HIGH | 1.3, 4.2, 4.5, 4.6, 4.1 | Review and update |
| 32 | data-access-governance-reports | HIGH | 4.4, 4.2, 4.5, 4.6, 4.1 | Review and update |
| 33 | information-barriers-sharepoint | MEDIUM | None | Review optional |
| 34 | message-center | HIGH | 2.10 | Review and update |
| 35 | application | MEDIUM | 1.2 | Review optional |
| 36 | whats-new | HIGH | None | Review and update |
| 37 | microsoft-purview-service-description | HIGH | None | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -24,10 +24,9 @@ Access to this page requires authorization. You can try
...
**What Changed:**
```diff
--- +++ @@ -54,6 +54,10 @@ area uses Copilot to generate an AI summary of key analytics insights about your agent. Select
 View More
 to see the full summarized list of insights.
+It helps you quickly understand common themes and metrics and identify areas for improvement for your agent by summarizing them in a bulleted list for the selected reporting period. This can include engagement metrics, customer sentiment and feedback, and trends since the last reporting period.
+The
+customer comments summary
+(preview) helps you understand high-level customer sentiment about the agent, such as feedback and comments. Insights are prioritized based on both the volume of related comments and their overall significance. Low-value or irrelevant comments are filtered out and related feedbacks are grouped together.
...
**What Changed:**
```diff
--- +++ @@ -37,13 +37,50 @@ Released versions of Microsoft Copilot Studio
 .
 Note
...
+tools to connect Microsoft 365 Copilot and your agents to the Work IQ service. By using this connection, you can access real-time work insights and context from Microsoft 365 files, emails, meetings, chats, and more.
+View and filter detailed lists of
+user questions and reactions
+from your agent's conversations. Use this data to identify gaps, create evaluation test sets, and export data for further analysis.
+For users with Bot transcript viewer privileges,
+downloaded session transcripts
+from Copilot Studio now include session-level customer satisfaction (CSAT) values.
+For users with Bot transcript viewer privileges, after you filter your list of questions or reactions, you can
+download the filtered questions or reactions to a .csv file
+.
+Use the
+Prompt assistant
+in Prompt builder to draft prompts faster with GPT modelâpowered suggestions. This feature reduces the time needed to craft effective prompts.
+Add
+Bing Custom Search
+as a knowledge source to ground your agent's responses in a curated, scoped web index by using a Custom Configuration ID.
+Configure
+post-call action topics
+for voice-enabled agents to trigger backend actions automatically after a call ends, based on how the conversation concluded.
+Configure
+reprompt messages
+in Question nodes with randomization support to improve conversation recovery for retry promp
```

---

### 8. Custom MCP Servers [Preview]
...
### 13. Sensitivity Labels for Sites
...
### 21. Data Access Governance Reports
...
**What Changed:**
```diff
--- +++ @@ -42,12 +42,33 @@ for data governance solutions.
 Roadmap
...
@@ -67,13 +88,48 @@ : New support for the Data Security Posture Agent in Microsoft Purview. The
