...
**Run Date:** 2026-04-24
**Run Time:** 2026-04-24T08:06:49.141890+00:00
...
| 95 | dlp-learn-about-dlp | MEDIUM | 1.26, 1.5, 1.25, 1.3 | Update portal-walkthrough |
...
+Reading mode
 ...
 Read in English
 Add
@@ -27,30 +27,31 @@ Connector classification
 Feedback
 Summarize this article for me
...
+or
+Blocked
+based on your preference. You manage the connectors in a data group when you create or modify the properties of a data policy from the admi
```
...
@@ -186,6 +186,10 @@ ) at the top of the test panel, thenâ¯select
 Manage connections
 .
+Important
+The
...
+Reading mode
 ...
 Read in English
 Add
@@ -33,7 +33,7 @@ Apply sensitivity labels to your files
 .
...
+To get their work done, people in your organization collaborate with others both inside and outside the organization. This collaboration means that content no longer stays behind a firewallâit can roam everywhere, across devices, apps, and services. When content roams, you want it to do so in a secure, protected way that meets your organization's business and compliance policies.
 ...
 sensitivity bar
@@ -85,15 +85,15 @@ Microsoft 365 roadmap
 .
...
+Reading mode
 ...
 Read in English
 Add
@@ -24,20 +24,28 @@ Access to this page requires authorization. You can try
...
@@ -45,10 +53,10 @@ Microsoft Defender portal
...
@@ -479,6 +460,8 @@ By: BuildingMinds
 BulkSMS
 By: BulkSMS.com
+Bureau of Economic Analysis (Independent Publisher)
+By: krautrocker
...
+Reading mode
 ...
 Read in English
 Add
@@ -27,9 +27,9 @@ View Power Platform admin logs in Microsoft Purview
 Feedback
 Summarize this article for me
...
@@ -40,22 +40,25 @@ Office 365 Management Activity API schema
...
+Note
+Power Platform admin activity collection is enabled by default
+on all tenants in Microsoft Purview and you can't disable the activity collection.
...
+Reading mode
 ...
 Read in English
 Add
@@ -253,13 +253,13 @@ Details of the AI model used in the interaction.
 -
 ModelProviderName
...
@@ -449,8 +449,8 @@ Similar to the M365AdminCenter scenario, this indicated a Copilot scenario in the Teams Admin Portal. An admin might use Copilot to configure Teams settings or generate reports.
...
@@ -193,7 +193,7 @@ Search name
 ...
 Users
-: Select this field and choose the names one 
```
...
+Reading mode
 ...
 Read in English
 Add
@@ -305,6 +305,8 @@ copy and paste are allowed
 Note
...
+Reading mode
 ...
 Read in English
 Add
@@ -423,13 +423,13 @@ Word, PowerPoint, and Excel permissions
...
+The displayed dialog box is updated in the latest versions of Microsoft 365 for Windows apps, but the support for organization-wide custom permissions remains when a domain name is entered. Information about this support is included in the popup information box.
 For examp
```
...
+Reading mode
 ...
 Read in English
 Add
@@ -27,186 +27,116 @@ What is SharePoint Advanced Management?
 Feedback
 Summarize this article for me
...
+: If you enable IB policies, users can't join channel meetings if they're not a member of the team. The root cause is that IB checks rely on whether users can be added to a meeting chat roster, and only when they can be added to the roster are they allowed to join the meeting. The chat thread in a channel meeting is available to Team/Channel members only, and non-members can't see or access the chat thread. If you enable IB for the organization and a non-team member attempts to join a channel meeting, that user isn't allowed to join the meeting. However, if you don't enable IB for the organization and a nonteam member attempts to join a channel meet
```
...
@@ -698,6 +705,7 @@  "isFallbackPublicClient": false,
...
### 80. Create DLP Policies
**URL:** https://learn.microsoft.com/en-us/purview/dlp-create-deploy-policy
**Classification:** MEDIUM (General content update)

---

### 81. Sensitivity Labels for Sites
**URL:** https://learn.microsoft.com/en-us/purview/sensitivity-labels-teams-groups-sites
**Classification:** MEDIUM (General content update)
...
### 86. Investigate Alerts
**URL:** https://learn.microsoft.com/en-us/purview/communication-compliance-investigate-remediate
**Classification:** MEDIUM (General content update)

---

### 87. Insider Risk Management
**URL:** https://learn.microsoft.com/en-us/purview/insider-risk-management
**Classification:** MEDIUM (General content update)

---

### 88. Create Insider Risk Policies
**URL:** https://learn.microsoft.com/en-us/purview/insider-risk-management-policies
**Classification:** MEDIUM (General content update)

---

### 89. Insider Risk Indicators
**URL:** https://learn.microsoft.com/en-us/purview/insider-risk-management-settings-policy-indicators
**Classification:** MEDIUM (General content update)

---

### 90. Investigate Alerts
**URL:** https://learn.microsoft.com/en-us/purview/insider-risk-management-activities
**Classification:** MEDIUM (General content update)

---

### 91. Sensitive Information Types
**URL:** https://learn.microsoft.com/en-us/purview/sit-sensitive-information-type-learn-about
**Classification:** MEDIUM (General content update)
...
### 101. SEC 17a-4 / Preservation Lock
**URL:** https://learn.microsoft.com/en-us/purview/retention-regulatory-requirements
**Classification:** MEDIUM (General content update)
...
### 124. Agent Identities for AI Agents
**URL:** https://learn.microsoft.com/en-us/entra/agent-id/identity-professional/microsoft-entra-agent-identities-for-ai-agents
**Classification:** MEDIUM (General content update)

---

### 125. SharePoint Admin Center
**URL:** https://learn.microsoft.com/en-us/sharepoint/sharepoint-admin-role
**Classification:** MEDIUM (General content update)

---

### 126. Sharing Permissions
**URL:** https://learn.microsoft.com/en-us/sharepoint/modern-experience-sharing-permissions
**Classification:** MEDIUM (General content update)

---

### 127. External Sharing
**URL:** https://learn.microsoft.com/en-us/sharepoint/external-sharing-overview
**Classification:** MEDIUM (General content update)

---

### 128. Manage Sharing Settings
**URL:** https://learn.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off
**Classification:** MEDIUM (General content update)

---

### 129. Restricted Access Control
**URL:** https://learn.microsoft.com/en-us/sharepoint/restricted-access-control
**Classification:** MEDIUM (General content update)

---

### 130. Restricted Content Discovery
**URL:** https://learn.microsoft.com/en-us/sharepoint/restricted-content-discovery
**Classification:** MEDIUM (General content update)

---

### 131. Restricted SharePoint Search
**URL:** https://learn.microsoft.com/en-us/sharepoint/restricted-sharepoint-search
**Classification:** MEDIUM (General content update)

---

### 132. Data Access Governance Reports
**URL:** https://learn.microsoft.com/en-us/sharepoint/data-access-governance-reports
**Classification:** MEDIUM (General content update)

---

### 133. Site Lifecycle Management
**URL:** https://learn.microsoft.com/en-us/sharepoint/site-lifecycle-management
**Classification:** MEDIUM (General content update)

---

### 134. Site Attestation
