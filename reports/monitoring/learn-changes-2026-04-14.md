...
**Run Date:** 2026-04-14
**Run Time:** 2026-04-14T07:49:23.295451+00:00
...
| 15 | how-to-authentication-passkeys-fido2 | HIGH | None | Review and update |
| 16 | information-barriers-sharepoint | HIGH | None | Review and update |
| 17 | private-link-service | HIGH | 1.20 | Review and update |
| 18 | information-barriers-teams | HIGH | None | Review and update |
| 19 | whats-new | HIGH | None | Review and update |
...
### 13. Key Vault Private Endpoints
...
+for scoping detection to items with specific sensitivity labels applied. This condition is supported with browser and network cloud apps detection.
 ...
 : Now rolling out, the
@@ -68,11 +73,31 @@ : Preview content while
 triaging alerts
...
+New
+: Rolling out, users can now apply
+sensitivity labels configured for user-defined permissions
+while using Office for the web. A prerequisite for 
```
