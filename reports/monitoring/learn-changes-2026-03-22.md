...
**Run Date:** 2026-03-22
**Run Time:** 2026-03-22T06:55:09.906863+00:00
...
| 6 | security-and-governance | MEDIUM | 1.8, 1.28, 1.1 | Review optional |
| 7 | ...ication-fundamentals-publish-channels | HIGH | None | Review and update |
| 8 | analytics-overview | MEDIUM | 3.2, 3.10, 2.6, 2.9 | Review optional |
| 9 | analytics-improve-agent-effectiveness | HIGH | None | Review and update |
| 10 | nlu-gpt-overview | HIGH | 2.12 | Review and update |
| 11 | admin-network-isolation-vnet | HIGH | 1.20 | Review and update |
| 12 | microsoft-365-copilot-overview | MEDIUM | 3.8, 3.5 | Review optional |
| 13 | microsoft-365-copilot-privacy | MEDIUM | 4.6, 4.7, 2.23 | Review and update |
| 14 | manage-copilot-agents-integrated-apps | HIGH | 3.8, 3.11, 3.6, 3.1 | Review and update |
| 15 | microsoft-365-copilot-usage | CRITICAL | 3.8 | Monitor |
| 16 | m365-agents-visual-map | MEDIUM | 3.8, 1.1 | Review optional |
| 17 | m365-agents-checklist | HIGH | 3.8, 3.5, 3.1, 1.11, 1.1, 1.6, 1.5 | Review and update |
| 18 | m365-agents-blueprint | HIGH | 2.1, 2.3, 1.11 | Review and update |
| 19 | dlp-policy-reference | HIGH | None | Review and update |
| 20 | dspm-for-ai-considerations | HIGH | None | Review and update |
| 21 | insider-risk-management-policies | HIGH | 1.12 | Review and update |
| 22 | ...management-settings-policy-indicators | HIGH | 1.12 | Review and update |
| 23 | import-hr-data | HIGH | 1.12 | Review and update |
| 24 | ediscovery-create-holds | MEDIUM | 1.9, 1.19 | Review optional |
| 25 | endpoint-dlp-learn-about | MEDIUM | 1.17 | Review optional |
| 26 | information-barriers | MEDIUM | 1.22 | Review optional |
| 27 | data-classification-activity-explorer | MEDIUM | 1.6 | Review optional |
| 28 | overview-authentication | CRITICAL | 1.11 | Monitor |
| 29 | how-to-enable-passkey-fido2 | CRITICAL | None | Monitor |
| 30 | permissions-reference | HIGH | None | Review and update |
| 31 | access-reviews-overview | HIGH | 1.3 | Review and update |
| 32 | create-access-review | HIGH | 4.2, 2.8 | Review and update |
| 33 | pim-configure | HIGH | 2.8, 1.18 | Review and update |
| 34 | restricted-access-control | MEDIUM | 4.1 | Review optional |
| 35 | restricted-content-discovery | HIGH | 4.6, 4.1, 4.7 | Review and update |
| 36 | request-site-attestations | MEDIUM | 4.2 | Review optional |
| 37 | service-health-overview | CRITICAL | 2.10 | Monitor |
| 38 | application | MEDIUM | 1.2 | Review optional |
| 39 | new-dlpcompliancepolicy | NOISE | 1.5 | Monitor |
| 40 | whats-new | HIGH | None | Review and update |
| 41 | microsoft-purview-service-description | HIGH | None | Review and update |
...
### 14. Create Insider Risk Policies
...
+Can read all tenant governance data.
+e0a4caa6-fe82-443f-b92f-d87341d17b2e
+Tenant Governance Relationship Administrator
+Can initiate governance relationships and terminate them.
+b8e31d83-1534-480f-9b10-0338ded51b7e
...
@@ -506,10 +521,14 @@ Permanently delete agent identity blueprints, which can no longer be restored
...
+Create Microsoft 365 groups, excluding role-assignable groups. Creator is added as the first owner.
 ...
 Read hidden members of Security groups and
```
...
@@ -64,13 +66,13 @@ For organizations without a Copilot license, you can use SharePoint Advanced Management features
...
+You can enable Restricted Content Discovery from the
```

---

### 22. Purview What's New
