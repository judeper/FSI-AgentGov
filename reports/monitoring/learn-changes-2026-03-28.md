...
**Run Date:** 2026-03-28
**Run Time:** 2026-03-28T07:01:18.904773+00:00
...
| 6 | security-and-governance | MEDIUM | 1.8, 1.28, 1.1, 1.4, 1.5 | Review optional |
| 7 | ...ication-fundamentals-publish-channels | HIGH | None | Review and update |
| 8 | admin-share-bots | CRITICAL | None | Monitor |
| 9 | analytics-overview | MEDIUM | 2.6, 2.9, 3.10, 3.2 | Review optional |
...
| 13 | microsoft-365-copilot-overview | MEDIUM | 3.5, 3.8 | Review optional |
| 14 | microsoft-365-copilot-privacy | MEDIUM | 2.23, 4.7, 4.6 | Review and update |
| 15 | manage-copilot-agents-integrated-apps | HIGH | 2.25, 3.11, 3.1, 3.6, 3.8 | Review and update |
| 16 | microsoft-365-copilot-usage | CRITICAL | 3.8 | Monitor |
| 17 | m365-agents-visual-map | MEDIUM | 1.1 | Review optional |
| 18 | m365-agents-checklist | HIGH | 1.11, 1.1, 1.6, 1.5, 3.5, 3.1 | Review and update |
| 19 | m365-agents-blueprint | HIGH | 2.3, 2.1, 1.11 | Review and update |
...
| 39 | create-access-review | HIGH | 2.8, 4.2 | Review and update |
| 40 | pim-configure | HIGH | 2.8, 1.18 | Review and update |
| 41 | ...n.microsoft.com/en-us/entra/agent-id/ | MEDIUM | 1.11, 1.2, 1.18 | Review optional |
| 42 | ...-entra-agent-identities-for-ai-agents | MEDIUM | 1.11, 1.18 | Review optional |
| 43 | restricted-access-control | HIGH | 4.1 | Review and update |
| 44 | restricted-content-discovery | HIGH | 4.7, 4.6, 4.1 | Review and update |
| 45 | data-access-governance-reports | HIGH | 4.4, 4.2, 4.5, 4.6, 4.1 | Review and update |
| 46 | site-lifecycle-management | HIGH | 4.2, 4.3 | Review and update |
| 47 | request-site-attestations | HIGH | 4.2 | Review and update |
| 48 | insights-on-sharepoint-agents | HIGH | 4.5 | Review and update |
| 49 | manage-addins-in-the-admin-center | HIGH | 1.2 | Review and update |
| 50 | monitor-your-data | HIGH | None | Review and update |
| 51 | private-link-service | MEDIUM | 1.20 | Review optional |
| 52 | service-health-overview | CRITICAL | 2.10 | Monitor |
| 53 | application | MEDIUM | 1.2 | Review optional |
| 54 | new-dlpcompliancepolicy | NOISE | 1.5 | Monitor |
| 55 | whats-new | HIGH | None | Review and update |
| 56 | ...ecurity-compliance-licensing-guidance | HIGH | None | Review and update |
| 57 | microsoft-purview-service-description | HIGH | None | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -121,12 +121,21 @@ Allow users to discover and install approved add-ins themselves.
...
+setting in the Microsoft 365 admin center controls all users' ability to acquire the following add-ins from Microsoft Marketplace:
...
+To enable or disable access to the Microsoft Marketplace and downloading of add-ins via the
+Let users access the Office Store
+setting, follow these steps:
 Sign in to the
 Microsoft 365 admin center
 .
@@ -161,13 +170,6 @@ after you choose the desired setting. If the setting is already in the desired state, select the
 X
 in the top-right corner to cancel.
-The
-Let users access the Office Store
-setting controls all users' ability to acquire the following add-ins from Microsoft Marketplace:
-Add-ins for non-subscription Word, Excel, and PowerPoint on Windows and Mac
-Add-ins for subscription Microsoft 365
-When you disable access to the Microsoft Marketplace, a user who tries to access it sees the following message:
-Office store not available. Unfortunately, your organization has disabled access to the Office Store. Please contact your administ
```
...
**What Changed:**
```diff
--- +++ @@ -39,11 +39,32 @@ Microsoft Defender
 For more information, seeâ¯the
...
@@ -51,11 +72,39 @@ Microsoft Priva
 For more information, see the
 Microsoft Priva service description
-.
+which includes the following services:
...
**What Changed:**
```diff
--- +++ @@ -176,6 +176,30 @@ Learn more about theâ¯
...
+Manage Customer Key
 Microsoft Purview Customer Lockbo
```
