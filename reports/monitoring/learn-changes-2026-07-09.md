...
**Run Date:** 2026-07-09
**Run Time:** 2026-07-09T09:41:16.945207+00:00
...
| 5 | admin-share-bots | HIGH | 3.2, 3.10, 2.5, 2.9, 2.6 | Update portal-walkthrough |
| 6 | knowledge-copilot-studio | MEDIUM | 2.16, 4.8, 1.14 | Update portal-walkthrough |
| 7 | authoring-test-bot | HIGH | 2.5 | Update portal-walkthrough |
| 8 | whats-new | HIGH | 2.25, 2.5, 2.10 | Review and update |
| 9 | planned-features | CRITICAL | 3.8, 2.25, 2.17, 1.4 | Review and update |
| 10 | ...ring-detecting-credential-oversharing | CRITICAL | 3.8, 2.8, 2.3, 1.18 | Monitor |
| 11 | ...suggestions-based-work-copilot-studio | CRITICAL | None | Monitor |
| 12 | whats-new | HIGH | None | Review and update |
| 13 | overview | HIGH | 3.13, 3.1, 2.25, 2.12, 2.6 | Update portal-walkthrough |
| 14 | audit-solutions-overview | HIGH | 2.13, 4.5, 1.7, 1.28, 1.27 | Review and update |
| 15 | insider-risk-management-activities | CRITICAL | 1.12 | Update portal-walkthrough |
| 16 | compliance-manager-assessments | HIGH | 3.3, 2.13 | Review and update |
| 17 | permissions-reference | CRITICAL | 2.23 | Monitor |
| 18 | turn-external-sharing-on-or-off | HIGH | 4.4, 1.3 | Review and update |
| 19 | restricted-access-control | MEDIUM | 4.1, 1.3 | Review optional |
| 20 | restricted-content-discovery | HIGH | 4.7, 4.1, 4.6, 1.3, 1.14 | Review and update |
| 21 | restricted-sharepoint-search | HIGH | 4.7, 4.1, 4.6, 1.3, 1.14 | Review and update |
| 22 | advanced-management | MEDIUM | 4.5, 4.2, 4.1, 4.6, 1.3 | Review and update |
| 23 | site-lifecycle-management | CRITICAL | 4.2, 4.3 | Review and update |
| 24 | request-site-attestations | HIGH | 4.2 | Review and update |
| 25 | ...cident-handling-with-automation-rules | HIGH | 3.9 | Review and update |
| 26 | alerts-overview | HIGH | 2.9 | Review and update |
| 27 | ai-agent-inventory | HIGH | 3.7, 1.8 | Update portal-walkthrough |
| 28 | whats-new | CRITICAL | None | Monitor |
...
**Content-Hash:** sha256:a602c823895095f26966f8621a6932cedec08bd29233ed43e16d930ba69dbdea
...
**Content-Hash:** sha256:426e71c6ee5a88aaa9da90f33397fb52fb42b80856ba7b81f9d54ab6e34a2141
...
+icon at the top of the
 Test bot
 panel to clear the previous conversation. Clearing previous conver
```

---

### 5. Agent 365 Overview
...
### 7. Defender for Cloud Apps - AI Inventory
...
**Section:** Copilot Studio
**Classification:** HIGH (Feature availability)
**Content-Hash:** sha256:3412d5fdbb9881c46998f2bd1d52cbfd13a1790e35ea5fd96de1452aecb40afc
...
@@ -58,7 +71,7 @@ asynchronous responses
 for agent flows to let long-running processes exceed the t
```
...
**Section:** Copilot Studio
**Classification:** CRITICAL (Deprecation notice)
**Content-Hash:** sha256:4b315946c50e39d6fb8d36cc940e90cdb58d86cab5c6787786e33232ad4f60de
...
**Section:** Microsoft Purview
**Classification:** HIGH (Compliance features)
**Content-Hash:** sha256:fa22ab056b85a797b5fa41132653c71c79fe12f9b61a88ff3c3fd58409fa8592
...
### 9. Restricted Content Discovery
...
### 10. Restricted SharePoint Search
...
**Section:** Azure Services
**Classification:** HIGH (Feature availability)
**Content-Hash:** sha256:126d1e62640be246e92ea8cf530871ec5c08850440c952e6e496bd1ba272ddc5
...
+Simple log search alerts
+evaluate each row individually for faster, near real-time alerting at scale. To set one up, see
 Create a simple log search al
```
...
**Classification:** MEDIUM (General content update)
**Content-Hash:** sha256:bd94309aeb9814236a207a799d5ffd7fba7263d2987906441b45a3772f08d0c8
...
### 3. Safe Sharing / Credential Oversharing [Preview]
...
### 4. Agent Suggestions from M365 Copilot [Preview]
