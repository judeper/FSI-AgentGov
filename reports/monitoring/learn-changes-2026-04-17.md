...
**Run Date:** 2026-04-17
**Run Time:** 2026-04-17T07:50:05.348265+00:00
...
| 6 | database-security | HIGH | 1.1, 2.8 | Review and update |
| 7 | analytics-improve-agent-effectiveness | HIGH | None | Review and update |
| 8 | planned-features | HIGH | 1.4, 1.5, 3.8, 2.25, 2.17 | Review and update |
| 9 | microsoft-365-copilot-overview | HIGH | 3.5, 3.8 | Review and update |
| 10 | dlp-policy-reference | HIGH | None | Review and update |
| 11 | sensitivity-labels | CRITICAL | 1.26, 1.5, 1.3, 4.9 | Review and update |
| 12 | audit-solutions-overview | HIGH | 1.28, 1.27, 1.7, 1.6, 4.5 | Review and update |
| 13 | audit-copilot | HIGH | None | Review and update |
| 14 | audit-log-retention-policies | HIGH | 1.7, 3.14 | Review and update |
| 15 | audit-search | HIGH | None | Review and update |
| 16 | import-hr-data | HIGH | 1.12 | Review and update |
| 17 | information-barriers | HIGH | 1.22 | Review and update |
| 18 | encryption-sensitivity-labels | HIGH | 1.16 | Review and update |
| 19 | concept-conditional-access-cloud-apps | HIGH | 1.23 | Review and update |
| 20 | how-to-authentication-passkeys-fido2 | HIGH | None | Review and update |
| 21 | information-barriers-sharepoint | HIGH | None | Review and update |
| 22 | message-center | CRITICAL | 2.10 | Monitor |
| 23 | private-link-service | HIGH | 1.20 | Review and update |
| 24 | ai-agent-inventory | HIGH | 1.21, 3.1, 3.7 | Review and update |
| 25 | information-barriers-teams | HIGH | None | Review and update |
| 26 | application | HIGH | 1.2 | Review and update |
| 27 | new-dlpcompliancepolicy | CRITICAL | 1.5 | Monitor |
| 28 | whats-new | HIGH | None | Review and update |
| 29 | microsoft-purview-service-description | MEDIUM | None | Review optional |
| 30 | requirements-licensing-subscriptions | MEDIUM | None | Review optional |
...
-.
 Basic User
-For out-of-the-box entities only, can run an app in the environment and perform common tasks on 
```
...
+Drill down to sessions to view the specific sessions that contributed to a metric and examine the underlying session data. This deeper view helps you understand the
+why
+and
+how
+behind top-level agent metrics and enables you to identify and investigate potential issues.
+Use the sessions list to analyze agent performance and investigate by examining the session-level data that lead to a session outcome (
+resolved
+,
+escalated
+,
...
+, or
+unengaged
+). For example, filter by channel, focus on low CSAT sessions, and then drill into session data to gain insight into why customers in those channels might be having a poor experience.
...
+You can create categories that fit your organization's specific business needs for different levels of sensitive content. For example, yo
```
...
+The displayed dialog box is updated in the latest versions of Microsoft 365 for Windows apps, but the support for organization-wide custom permissions remains when a domain name is entered. Information about this support is included in the popup information box.
 ...
 @contoso.com
 (or
@@ -437,9 +437,12 @@ ) and grants read access. Because Contoso Corporation owns the co
```

---

### 16. Authentication Contexts
...
### 19. Key Vault Private Endpoints
...
### 20. Defender for Cloud Apps - AI Inventory
...
@@ -67,44 +75,6 @@ When Copilot
```

---

### 21. Information Barriers in Teams
