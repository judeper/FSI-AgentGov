...
**Run Date:** 2026-03-24
**Run Time:** 2026-03-24T07:06:49.209516+00:00
...
| 31 | concept-conditional-access-policies | MEDIUM | None | Review optional |
| 32 | concept-conditional-access-cloud-apps | HIGH | 1.23 | Review and update |
| 33 | ...o-conditional-access-session-lifetime | MEDIUM | 1.23 | Review optional |
| 34 | overview-authentication | CRITICAL | 1.11 | Monitor |
| 35 | how-to-enable-passkey-fido2 | CRITICAL | None | Monitor |
| 36 | permissions-reference | HIGH | None | Review and update |
| 37 | access-reviews-overview | HIGH | 1.3 | Review and update |
| 38 | create-access-review | HIGH | 4.2, 2.8 | Review and update |
| 39 | pim-configure | HIGH | 2.8, 1.18 | Review and update |
| 40 | restricted-access-control | MEDIUM | 4.1 | Review optional |
| 41 | restricted-content-discovery | HIGH | 4.6, 4.1, 4.7 | Review and update |
| 42 | request-site-attestations | MEDIUM | 4.2 | Review optional |
| 43 | monitor-your-data | HIGH | None | Review and update |
| 44 | service-health-overview | CRITICAL | 2.10 | Monitor |
| 45 | application | MEDIUM | 1.2 | Review optional |
| 46 | new-dlpcompliancepolicy | NOISE | 1.5 | Monitor |
| 47 | whats-new | HIGH | None | Review and update |
| 48 | microsoft-purview-service-description | HIGH | None | Review and update |
...
**What Changed:**
```diff
--- +++ @@ -56,12 +56,12 @@ include multiple related child apps or services. When new Microsoft cloud applications are created, they appear in the app picker list as soon as the service principal is created in the tenant.
 Office 365
...
+Targeting this group of applications helps to avoid issues that might arise because of inconsistent policies and dependencies. For example: The Exchange Online app is tied to traditional Exchange Online data like mail, calendar, and contact information. Related metadata might be exposed through different resources like search. To ensure that all metadata is protected as intended, admins should assign policies 
```
...
+Can initiate governance relationships and term
```
...
+: The
+agent summary tab
+in the Triage Agent in Insider Risk Management has been enhanced to intelligently distill user activity risk into meaningful risk pattern narrati
```

---

### 27. Purview Licensing
