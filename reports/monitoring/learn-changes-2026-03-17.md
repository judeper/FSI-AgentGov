...
**Run Date:** 2026-03-17
**Run Time:** 2026-03-17T07:06:52.262903+00:00
...
| 14 | dspm-for-ai-considerations | HIGH | None | Review and update |
| 15 | insider-risk-management-policies | HIGH | 1.12 | Review and update |
| 16 | ...management-settings-policy-indicators | HIGH | 1.12 | Review and update |
| 17 | import-hr-data | HIGH | 1.12 | Review and update |
| 18 | ediscovery-create-holds | MEDIUM | 1.9, 1.19 | Review optional |
| 19 | endpoint-dlp-learn-about | MEDIUM | 1.17 | Review optional |
| 20 | information-barriers | MEDIUM | 1.22 | Review optional |
| 21 | permissions-reference | MEDIUM | None | Review optional |
| 22 | access-reviews-overview | HIGH | 1.3 | Review and update |
| 23 | create-access-review | HIGH | 4.2, 2.8 | Review and update |
| 24 | pim-configure | HIGH | 2.8, 1.18 | Review and update |
| 25 | application | MEDIUM | 1.2 | Review optional |
| 26 | new-dlpcompliancepolicy | NOISE | 1.5 | Monitor |
| 27 | whats-new | HIGH | None | Review and update |
...
### 11. Create Insider Risk Policies
...
+: You can now use
+federated credentials
+as a more secure method of authentication to run Fabric data risk assessments. This recommended authenticated method lets Kubernetes workloads authenticate to Azure services without hardâcoding secrets, while ensuring each pod only has the permissions it needs. This change is also available for data risk assessments in Data Security Posture Management for AI (classic). For more information, see
