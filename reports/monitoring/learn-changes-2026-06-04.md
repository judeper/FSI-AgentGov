...
**Run Date:** 2026-06-04
**Run Time:** 2026-06-04T09:57:59.995324+00:00
...
| 16 | overview | HIGH | 2.6, 2.12, 2.25, 3.1, 3.13 | Update portal-walkthrough |
...
| 20 | audit-search | MEDIUM | 1.7, 3.12, 3.2 | Update portal-walkthrough |
| 21 | ai-microsoft-purview | MEDIUM | 4.7, 4.8, 1.6, 1.5, 1.16, 2.6 | Review and update |
| 22 | communication-compliance-policies | CRITICAL | 1.10 | Update portal-walkthrough |
| 23 | import-hr-data | HIGH | 1.12 | Update portal-walkthrough |
| 24 | trainable-classifiers-learn-about | HIGH | 1.13 | Review and update |
| 25 | retention | MEDIUM | 4.3, 1.19, 1.9, 2.13, 3.5 | Update portal-walkthrough |
| 26 | create-retention-policies | HIGH | 1.9 | Review and update |
| 27 | dlp-configure-endpoint-settings | HIGH | 1.17 | Review and update |
| 28 | concept-conditional-access-cloud-apps | HIGH | None | Review and update |
| 29 | how-to-authentication-passkeys-fido2 | HIGH | None | Review and update |
| 30 | custom-overview | HIGH | None | Review and update |
| 31 | permissions-reference | MEDIUM | 2.23 | Review optional |
| 32 | create-retention-policies | HIGH | None | Review and update |
| 33 | alerts-overview | HIGH | 2.9 | Review and update |
| 34 | information-barriers-teams | HIGH | None | Review and update |
| 35 | whats-new | CRITICAL | None | Monitor |
| 36 | microsoft-365-overview | MEDIUM | None | Review optional |
...
**What Changed:**
```diff
--- +++ @@ -111,6 +111,8 @@ Power BI admin portal
 .
 Get started with search
+Important
+The execution time (search time) of a Search job depends on several factors, including the selected date range, the number of users included, the volume of activities, and overall tenant size. In large tenants with a high number of users, broadly-scoped Search jobs may take up to 48 hours to complete.
...
**What Changed:**
```diff
--- +++ @@ -112,6 +112,7 @@ Teams private channel messages (
 pre-migration
 only)
+Teams call logs
...
**What Changed:**
```diff
--- +++ @@ -412,7 +412,7 @@ Register a passkey in Authenticator
 |
...
### 17. Information Barriers in Teams
