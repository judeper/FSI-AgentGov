...
- **62 controls** across 4 pillars in `docs/controls/`
- **248 playbooks** in `docs/playbooks/control-implementations/`
- **13 solutions** in companion repo FSI-AgentGov-Solutions
