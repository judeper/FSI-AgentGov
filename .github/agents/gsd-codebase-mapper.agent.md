...
- **35 live solution implementations plus 1 preview** (36 companion solutions total) tracked in `docs/reference/solutions-index.md` for companion repo FSI-AgentGov-Solutions
