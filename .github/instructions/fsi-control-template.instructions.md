...
|--------|----------|-----------|
| Pillar 1 — Security | 1.1–1.28 | `docs/controls/pillar-1-security/` |
| Pillar 2 — Management | 2.1–2.24 | `docs/controls/pillar-2-management/` |
| Pillar 3 — Reporting | 3.1–3.12 | `docs/controls/pillar-3-reporting/` |
