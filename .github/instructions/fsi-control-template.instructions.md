...
|--------|----------|-----------|
| Pillar 1 — Security | 1.1–1.24 | `docs/controls/pillar-1-security/` |
| Pillar 2 — Management | 2.1–2.21 | `docs/controls/pillar-2-management/` |
| Pillar 3 — Reporting | 3.1–3.10 | `docs/controls/pillar-3-reporting/` |
| Pillar 4 — SharePoint | 4.1–4.7 | `docs/controls/pillar-4-sharepoint/` |
