...
CONTROLS = [
    ...
    ("2.6","2.6-model-risk-management-sr-26-2.md",2,"manual",[],"Has a model risk management review (aligned to OCC Bulletin 2026-13 (formerly OCC 2011-12) / Fed SR 26-2 (formerly SR 11-7)) been completed for any agents serving regulated functions?"),
